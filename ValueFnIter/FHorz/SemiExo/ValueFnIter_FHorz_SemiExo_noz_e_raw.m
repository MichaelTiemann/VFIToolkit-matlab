function [V,Policy3]=ValueFnIter_FHorz_SemiExo_noz_e_raw(n_d1,n_d2,n_a,n_semiz,n_e, N_j, d1_gridvals, d2_gridvals, a_grid, semiz_gridvals_J, e_gridvals_J, pi_semiz_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
special_n_d=[n_d1,ones(1,length(n_d2),vfoptions.precision)];
        ...
        for d2_c=1:N_d2
            ...
            for semiz_c=1:N_semiz
                ...
                for e_c=1:N_e
                    ...
                    entireRHS=ReturnMatrix_d2semize+DiscountFactorParamsVec*entireEV_d2semiz;
