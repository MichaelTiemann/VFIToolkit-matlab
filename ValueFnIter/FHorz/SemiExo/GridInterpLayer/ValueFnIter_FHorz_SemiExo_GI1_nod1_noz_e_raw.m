function [V,Policy]=ValueFnIter_FHorz_SemiExo_GI1_nod1_noz_e_raw(n_d2,n_a,n_semiz,n_e, N_j, d2_gridvals, a_grid, semiz_gridvals_J, e_gridvals_J, pi_semiz_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d2_c=1:N_d2
            ...
            entireRHS_d2=ReturnMatrix_d2+DiscountFactorParamsVec*EV_d2; %repmat(entireEV,1,N_a,1);
            % Treat standard problem as just being the first layer
        ...
        for d2_c=1:N_d2
            ...
            for semiz_c=1:N_semiz
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_d2semize=ReturnMatrix_d2semize+DiscountFactorParamsVec*EV_d2semiz;
                    % Treat standard problem as just being the first layer
                    ...
                    entireRHS_ii=ReturnMatrix_d2semizeii+DiscountFactorParamsVec*reshape(EVinterp_d2semiz(aprimez),[n2long,N_a]);
                    [Vtemp,maxindex]=max(entireRHS_ii,[],1);
