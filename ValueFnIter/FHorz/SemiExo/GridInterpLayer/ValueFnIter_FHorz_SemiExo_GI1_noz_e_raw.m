        ...
        for d2_c=1:N_d2
            ...
            for semiz_c=1:N_semiz
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_d2semize=ReturnMatrix_d2semize+DiscountFactorParamsVec*shiftdim(EV_d2semiz,-1);
                    % Treat standard problem as just being the first layer
                    ...
                    entireRHS_ii=ReturnMatrix_d2semizeii+DiscountFactorParamsVec*reshape(EVinterp(aprimeindexes),[N_d1*n2long,N_a]);
                    [Vtemp,maxindex]=max(entireRHS_ii,[],1);
