function [V,Policy]=ValueFnIter_FHorz_SemiExo_DC1_GI1_nod1_noz_raw(n_d2,n_a,n_semiz,N_j, d2_gridvals, a_grid, semiz_gridvals_J, pi_semiz_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
    ...
    elseif vfoptions.lowmemory==1 % loop semiz
        ...
        for d2_c=1:N_d2
            ...
            for semiz_c=1:N_semiz
                ...
                entireRHS_ii=ReturnMatrix_d2ii+DiscountFactorParamsVec*reshape(EVinterp_d2(aprimeindexes),[n2long,N_a]);
                [Vtemp,maxindex]=max(entireRHS_ii,[],1);
