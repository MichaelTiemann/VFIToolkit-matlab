...
V=zeros(N_a,N_z,N_j,vfoptions.precision);
Policy=zeros(N_a,N_z,N_j,indexT); %first dim indexes the optimal choice for d and aprime rest of dimensions a,z
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    ReturnMatrix=CreateReturnFnMatrix_Disc_CPU(ReturnFn, n_d, n_a, n_z, d_grid, a_grid, z_grid, ReturnFnParamsVec,0);
