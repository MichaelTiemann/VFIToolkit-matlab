function [V, Policy]=ValueFnIter_FHorz_DC1_GI1_nod_noz_e_raw(n_a,n_e,N_j, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
adjust=cast2precision(Policy(2,:,:,:)<1+n2short+1); % if second layer is choosing below midpoint
