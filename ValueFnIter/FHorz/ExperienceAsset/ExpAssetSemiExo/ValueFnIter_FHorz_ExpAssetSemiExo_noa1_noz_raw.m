function [V,Policy3]=ValueFnIter_FHorz_ExpAssetSemiExo_noa1_noz_raw(n_d1,n_d2,n_d3,n_a2,n_semiz,N_j, d12_gridvals, d2_gridvals, d3_grid, a2_grid, semiz_gridvals_J, pi_semiz_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            for z_c=1:N_semiz
                ...
                entireRHS_z=ReturnMatrix_d3z+DiscountFactorParamsVec*repelem(entireEV_z,N_d1,1);
