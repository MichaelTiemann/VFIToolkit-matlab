...
Policy=zeros(5,N_a,N_semiz*N_z,N_e,N_j,vfoptions.indexT,'gpuArray');
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policy(4,:,:,:,N_j)=reshape(Policy4_ford3_jj(3+temp),[1,N_a,N_bothz,N_e]); % a1prime midpoint
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            entireRHS_ii_d3=ReturnMatrix_ii_d3+reshape(DiscountedEVinterp(d12a1primea2semiz(:)),[N_d12*n2long,N_a1*N_a2,N_bothz,N_e]);
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_d3=ReturnMatrix_d3+DiscountedEV_z; % autofill a1 dim
...
for reverse_j=1:N_j-1
    ...
    Policy(4,:,:,:,jj)=reshape(Policy4_ford3_jj(3+temp),[1,N_a,N_bothz,N_e]); % a1prime midpoint
