function [V,Policy]=ValueFnIter_FHorz_ExpAsset_DC2A_raw(n_d1, n_d2, n_a1, n_a2, n_a3, n_z, N_j, d_gridvals, d2_gridvals, a1_grid, a2_gridvals, a3_grid, z_gridvals_J, pi_z_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
Policy=zeros(3,N_a,N_z,N_j,vfoptions.indexT,'gpuArray'); % channels: 1=d (joint), 2=a1prime, 3=a2prime
