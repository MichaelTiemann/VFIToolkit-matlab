function [V,Policy]=ValueFnIter_FHorz_ExpAsset_DC2A_nod1_noz_raw(n_d2, n_a1, n_a2, n_a3, N_j, d2_gridvals, a1_grid, a2_gridvals, a3_grid, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
Policy=zeros(3,N_a,N_j,vfoptions.indexT,'gpuArray'); % channels: 1=d2, 2=a1prime, 3=a2prime
