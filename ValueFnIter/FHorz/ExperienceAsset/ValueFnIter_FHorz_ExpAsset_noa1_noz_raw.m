...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    ReturnMatrix=CreateReturnFnMatrix_Case2_Disc_noz(ReturnFn,[n_d1,n_d2], n_a2, d_gridvals, a2_gridvals, ReturnFnParamsVec); % with only the experience asset, can just use Case2 command
