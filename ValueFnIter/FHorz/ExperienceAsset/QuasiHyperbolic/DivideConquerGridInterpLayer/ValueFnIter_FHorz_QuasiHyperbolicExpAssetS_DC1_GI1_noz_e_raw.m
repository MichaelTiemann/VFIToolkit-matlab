function [Vhat,Policy,Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetS_DC1_GI1_noz_e_raw(n_d1, n_d2,n_a1,n_a2,n_e,N_j, d_gridvals, d2_gridvals, a1_gridvals, a2_grid,e_gridvals_J, pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
% Sophisticated quasi-hyperbolic discounting + ExperienceAsset, Divide-and-Conquer (DC1 over a1prime) with grid interpolation layer (GI1) on a1.
...
for reverse_j=1:N_j-1
    ...
    EV=sum(pi_e_J(:,jj+1)'.*Vunderbar(:,:,jj+1),2);    % Expectations over e
