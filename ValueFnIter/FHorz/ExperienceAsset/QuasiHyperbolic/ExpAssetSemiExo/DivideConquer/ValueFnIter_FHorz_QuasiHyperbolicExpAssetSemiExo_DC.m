...
%% DC2A path: multi-dim n_a1 is not yet implemented for quasi-hyperbolic ExpAssetSemiExo
if length(n_a1)>1
    error('QuasiHyperbolic ExpAssetSemiExo: the DC2A tier (multi-dim n_a1) is not yet implemented')
end
