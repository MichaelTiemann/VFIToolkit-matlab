function [Vhat,Policy3,Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetSemiExoS_DC1_nod1_raw(n_d2,n_d3,n_a1,n_a2,n_z,n_semiz,N_j, d2_gridvals, d3_grid, a1_gridvals, a2_grid, z_gridvals_J, semiz_gridvals_J, pi_z_J, pi_semiz_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            DiscountedEV_hat=beta0beta*reshape(entireEV,[N_d2,N_a1,1,N_a2,N_bothz]); % (d2,a1prime,1,a2,zprime)   % QH-perceived
    ...
    elseif vfoptions.lowmemory==1
        ...
        for d3_c=1:N_d3
            ...
            % Apply the aprimeProbs
            entireEV=EV1.*aprimeProbs_full_d3+EV2.*(1-aprimeProbs_full_d3); % probability of lower grid point+ probability of upper grid point
            entireEV(aprimeProbs_full_d3==0)=EV2(aprimeProbs_full_d3==0); % includes the skipinterp positions; a zero weight against an infinite node gives 0*(-Inf)=NaN
            entireEV(aprimeProbs_full_d3==1)=EV1(aprimeProbs_full_d3==1);
    ...
    elseif vfoptions.lowmemory==2
        for d3_c=1:N_d3
            ...
            for z_c=1:N_bothz
                ...
                DiscountedEV_z_hat=beta0beta*reshape(entireEV_z,[N_d2,N_a1,1,N_a2]); % (d,a1prime,1,a2)   % QH-perceived
