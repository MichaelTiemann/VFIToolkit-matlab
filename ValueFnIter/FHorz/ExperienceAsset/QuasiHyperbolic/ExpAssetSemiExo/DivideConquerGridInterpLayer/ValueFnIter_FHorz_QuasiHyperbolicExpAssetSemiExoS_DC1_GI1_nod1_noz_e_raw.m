...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    PolicyL2flag(1,:,:,:,N_j)=reshape(flag_ford3_hat((1:1:N_a*N_semiz*N_e)'+(N_a*N_semiz*N_e)*(maxindex-1)),[1,N_a,N_semiz,N_e]);
...
for reverse_j=1:N_j-1
    ...
    PolicyL2flag(1,:,:,:,jj)=reshape(flag_ford3_hat((1:1:N_a*N_semiz*N_e)'+(N_a*N_semiz*N_e)*(maxindex-1)),[1,N_a,N_semiz,N_e]);
    % Vunderbar at the d3 chosen by the hat max
