...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        ...
        for z_c=1:N_z
            ...
            d_ind=rem(maxindex-1,N_d)+1;
            d12_ind=rem(d_ind-1,N_d12)+1;
            Policy3alt(1,:,zind,N_j)=rem(d12_ind-1,N_d1)+1;
            Policy3alt(2,:,zind,N_j)=ceil(d12_ind/N_d1);
            Policy3alt(3,:,zind,N_j)=ceil(d_ind/N_d12);
            Policy3alt(4,:,zind,N_j)=ceil(maxindex/N_d);
        end
    ...
    elseif vfoptions.lowmemory==1
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                entireRHS_alt=ReturnMatrix_d3z+beta*repelem(entireEV_z,N_d1,N_a1,1);
                [Vtemp_alt,maxindex_alt]=max(entireRHS_alt,[],1);
                V_ford3_alt(:,zind,d3_c)=shiftdim(Vtemp_alt,1);
                Policy_ford3_alt(:,zind,d3_c)=shiftdim(maxindex_alt,1);
                entireRHS_tilde=ReturnMatrix_d3z+beta0beta*repelem(entireEV_z,N_d1,N_a1,1);
                [Vtemp_tilde,maxindex_tilde]=max(entireRHS_tilde,[],1);
