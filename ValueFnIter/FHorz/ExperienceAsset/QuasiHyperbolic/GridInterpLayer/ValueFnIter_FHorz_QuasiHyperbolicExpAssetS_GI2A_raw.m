function [Vhat,Policy,Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetS_GI2A_raw(n_d1, n_d2, n_a1, n_a2, n_a3, n_z, N_j, d_gridvals, d2_gridvals, a1_grid, a2_gridvals, a3_grid, z_gridvals_J, pi_z_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
% Sophisticated quasi-hyperbolic discounting variant of ValueFnIter_FHorz_ExpAsset_GI2A_raw.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        ...
        entireRHS_ii=reshape(ReturnMatrix_ii,[N_d*n2long*N_a2,N_a,N_z])+beta0beta*EVfine;
    ...
    elseif vfoptions.lowmemory==1
        ...
        for z_c=1:N_z
            ...
            entireRHS_ii_z=reshape(ReturnMatrix_ii_z,[N_d*n2long*N_a2,N_a])+beta0beta*EVfine_z;
