function [V, Policy]=ValueFnIter_FHorz_GI1_nod_noz_raw(n_a,N_j, a_grid, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)

N_a=prod(n_a);

V=zeros(N_a,N_j,vfoptions.precision,'gpuArray');
Policy=zeros(2,N_a,N_j,vfoptions.indexT,'gpuArray'); % first dim indexes the optimal choice for aprime and aprime2 (in GI layer)
