    ...
    elseif vfoptions.lowmemory==2
        for d3_c=1:N_d3
            ...
            for z_c=1:N_bothz
                ...
                aprime_slice=aprimeIndex(:,:,z_part,:); % [N_d2*N_a1,N_a2,1,N_e]
                ...
                entireEV_z=EV1.*aprimeProbs_z+EV2.*(1-aprimeProbs_z); % [N_d2*N_a1,N_a2,N_e]
