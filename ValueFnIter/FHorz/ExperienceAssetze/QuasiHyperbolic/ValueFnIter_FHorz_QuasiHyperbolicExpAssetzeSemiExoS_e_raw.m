...
%
% Sophisticated QH over the same argmax axis the exponential SemiExo ze raw maxes over:
...
% Row dimension of the per-d3 ReturnMatrix (d1*d2*a1prime), used for the "gather at argmax"
Nrow=N_d12*N_a1;
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Vhat(:,:,:,N_j)=Vhat_jj;
    Policy4(3,:,:,:,N_j)=shiftdim(d3maxindex,-1); % d3
