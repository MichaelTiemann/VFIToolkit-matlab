...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            entireRHS_hat_flat=reshape(entireRHS_hat_e,[N_d2*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,N_z,1]);
            [Vtempii_hat,maxindex2]=max(entireRHS_hat_flat,[],1);
            entireRHS_under_e=ReturnMatrix_ii_e+DiscountedEV_under_e;
            entireRHS_under_flat=reshape(entireRHS_under_e,[N_d2*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,N_z,1]);
            M=vfoptions.level1n*N_a2*N_a3;
