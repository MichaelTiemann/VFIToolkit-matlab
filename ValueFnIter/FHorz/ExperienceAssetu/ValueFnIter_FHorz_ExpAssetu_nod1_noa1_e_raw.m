function [V,Policy]=ValueFnIter_FHorz_ExpAssetu_nod1_noa1_e_raw(n_d2,n_a2,n_z,n_e,n_u,N_j, d2_gridvals, a2_grid,z_gridvals_J,e_gridvals_J,u_gridvals, pi_z_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        ...
        entireRHS=ReturnMatrix+DiscountFactorParamsVec*EV; % should autofill the e dimension
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                entireRHS=ReturnMatrix_ze+DiscountFactorParamsVec*EV_z;
...
for reverse_j=1:N_j-1
    ...
    EVpre=sum(shiftdim(pi_e_J(:,jj),-2).*reshape(V(:,:,:,jj+1),[N_a,N_z,N_e]),3);
