function [V,Policy]=ValueFnIter_FHorz_ExpAssetu_GI2A_noz_e_raw(n_d1, n_d2, n_a1, n_a2, n_a3, n_e, n_u, N_j, d_gridvals, d2_gridvals, a1_grid, a2_gridvals, a3_grid, e_gridvals_J, u_gridvals, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
% with-d1 noz_e analog of ValueFnIter_FHorz_ExpAsset_GI2A_raw. lowmemory=0 and 1.
