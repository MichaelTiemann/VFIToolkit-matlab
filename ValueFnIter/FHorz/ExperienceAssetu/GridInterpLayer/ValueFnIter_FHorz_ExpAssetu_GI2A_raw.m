function [V,Policy]=ValueFnIter_FHorz_ExpAssetu_GI2A_raw(n_d1, n_d2, n_a1, n_a2, n_a3, n_z, n_u, N_j, d_gridvals, d2_gridvals, a1_grid, a2_gridvals, a3_grid, z_gridvals_J, u_gridvals, pi_z_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
% with-d1 analog of ValueFnIter_FHorz_ExpAsset_GI2A_nod1_raw.
% Policy is 4-channel: 1=d (joint d1+d2 kron), 2=a1prime midpoint, 3=a2prime, 4=a1prime L2. Plus PolicyL2flag appended as channel 5.
