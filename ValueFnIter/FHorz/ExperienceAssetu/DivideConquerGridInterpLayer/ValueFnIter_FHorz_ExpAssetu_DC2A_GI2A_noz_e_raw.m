function [V,Policy]=ValueFnIter_FHorz_ExpAssetu_DC2A_GI2A_noz_e_raw(n_d1, n_d2, n_a1, n_a2, n_a3, n_e, n_u, N_j, d_gridvals, d2_gridvals, a1_grid, a2_gridvals, a3_grid, e_gridvals_J, u_gridvals, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
% with-d1 noz_e analog of ValueFnIter_FHorz_ExpAsset_DC2A_GI2A_raw. lowmemory=0 and 1.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            aprime=d2ind_vec + N_d2*(a1primeindexesfine-1) + N_d2*N_a1fine*shiftdim((0:1:N_a2-1),-1) + N_d2*N_a1fine*N_a2*shiftdim((0:1:N_a3-1),-4);
            entireRHS_ii_e=reshape(ReturnMatrix_ii_e+DiscountedEVinterp(aprime),[N_d*n2long*N_a2,N_a]);
