function [V,Policy3]=ValueFnIter_FHorz_ExpAssetuSemiExo_DC1_nod1_raw(n_d2,n_d3,n_a1,n_a2,n_z,n_semiz,n_u,N_j, d2_gridvals, d3_grid, a1_gridvals, a2_grid, z_gridvals_J, semiz_gridvals_J, u_gridvals, pi_z_J, pi_semiz_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
    ...
    elseif vfoptions.lowmemory==2
        for d3_c=1:N_d3
            ...
            for z_c=1:N_bothz
                ...
                DiscountedEV_z=DiscountFactorParamsVec*reshape(EV_z,[N_d2,N_a1,1,N_a2]); % (d,a1prime,1,a2)
