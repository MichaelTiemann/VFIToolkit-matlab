...
Policy4_ford3_jj=zeros(4,N_a,N_semiz*N_z,N_d3,'gpuArray'); % 1=d1, 2=d2, 3=joint(a1prime midpoint,a2prime), 4=a1primeL2ind
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                Policy4_ford3_jj(3,:,zind,d3_c)=midpoint(allind)+N_a1*(maxindexL2a2-1); % joint(a1prime midpoint,a2prime)
                Policy4_ford3_jj(4,:,zind,d3_c)=maxindexL2a1; % a1primeL2ind
    ...
    Policy4(1,:,:,N_j)=reshape(Policy4_ford3_jj(1+temp),[1,N_a,N_bothz]); % d1
    ...
    elseif vfoptions.lowmemory==1
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                entireRHS_ii_z=reshape(ReturnMatrix_ii_z+DiscountedEVinterp_z(aprime_z),[N_d12*n2long*N_a2,N_a,N_semiz]);
...
for reverse_j=1:N_j-1
    ...
    maxindex=reshape(maxindex,[N_a*N_bothz,1]);
    temp=4*( (1:1:N_a*N_bothz)'+(N_a*N_bothz)*(maxindex-1) -1);
    Policy4(1,:,:,jj)=reshape(Policy4_ford3_jj(1+temp),[1,N_a,N_bothz]); % d1
