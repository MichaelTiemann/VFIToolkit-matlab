function [V,Policy2]=ValueFnIter_FHorz_ExpAssetuSemiExo_nod1_noa1_noz_e_raw(n_d2,n_d3,n_a2,n_semiz,n_e,n_u,N_j, d2_gridvals, d3_grid, a2_grid, semiz_gridvals_J, e_gridvals_J, u_gridvals, pi_semiz_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            for e_c=1:N_e
                ...
                entireRHS_e=ReturnMatrix_d3e+DiscountFactorParamsVec*EV;
