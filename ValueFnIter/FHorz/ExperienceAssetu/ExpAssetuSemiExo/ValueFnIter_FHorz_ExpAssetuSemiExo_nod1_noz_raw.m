function [V,Policy3]=ValueFnIter_FHorz_ExpAssetuSemiExo_nod1_noz_raw(n_d2,n_d3,n_a1,n_a2,n_semiz,n_u,N_j, d2_gridvals, d3_grid, a1_gridvals, a2_grid, semiz_gridvals_J, u_gridvals, pi_semiz_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            for z_c=1:N_semiz
                ...
                entireRHS_d3z=ReturnMatrix_d3z+DiscountFactorParamsVec*repelem(EV_z,1,N_a1,1);
