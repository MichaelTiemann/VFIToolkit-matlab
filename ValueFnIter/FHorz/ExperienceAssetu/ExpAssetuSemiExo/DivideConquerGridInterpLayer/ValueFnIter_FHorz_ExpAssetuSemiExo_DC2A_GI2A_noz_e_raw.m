function [V,Policy]=ValueFnIter_FHorz_ExpAssetuSemiExo_DC2A_GI2A_noz_e_raw(n_d1, n_d2, n_d3, n_a1, n_a2, n_a3, n_semiz, n_e, n_u, N_j, d12_gridvals, d2_gridvals, d3_grid, a1_grid, a2_gridvals, a3_grid, semiz_gridvals_J, e_gridvals_J, u_gridvals, pi_semiz_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
Policy4_ford3_jj=zeros(4,N_a,N_semiz,N_e,N_d3,'gpuArray'); % d1,d2,joint(a1prime,a2prime),a1primeL2ind
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policy(4,:,:,:,N_j)=reshape(Policy4_ford3_jj(3+temp),[1,N_a,N_semiz,N_e]); % joint(a1prime,a2prime)
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            entireRHS_ii=reshape(ReturnMatrix_ii+DiscountedEVinterp(aprimez),[N_d12*n2long*N_a2,N_a,N_semiz,N_e]);
...
for reverse_j=1:N_j-1
    ...
    Policy(4,:,:,:,jj)=reshape(Policy4_ford3_jj(3+temp),[1,N_a,N_semiz,N_e]); % joint(a1prime,a2prime)
