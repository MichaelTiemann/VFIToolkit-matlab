function [Vtilde,Policy,Valt,Policyalt]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuN_nod1_noz_e_raw(n_d2,n_a1,n_a2,n_e,n_u, N_j, d2_gridvals, a1_gridvals, a2_grid, e_gridvals_J, u_gridvals, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            entireRHS_alt=ReturnMatrix_e+beta*repelem(EV,1,N_a1,1);
            [Vtemp_alt,maxindex_alt]=max(entireRHS_alt,[],1);
            Valt(:,e_c,N_j)=shiftdim(Vtemp_alt,1);
            Policyalt(:,e_c,N_j)=shiftdim(maxindex_alt,1);
            entireRHS_tilde=ReturnMatrix_e+beta0beta*repelem(EV,1,N_a1,1);
            [Vtemp_tilde,maxindex_tilde]=max(entireRHS_tilde,[],1);
