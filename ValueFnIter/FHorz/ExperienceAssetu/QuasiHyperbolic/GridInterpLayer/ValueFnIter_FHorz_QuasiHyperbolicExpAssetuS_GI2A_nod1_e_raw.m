...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for z_c=1:N_z
            ...
            entireRHS_ii_z=reshape(ReturnMatrix_ii_z,[N_d2*n2long*N_a2,N_a,1,N_e])+beta0beta*EVfine_z;
