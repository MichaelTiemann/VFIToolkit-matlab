    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                %% Valt (beta) -- capture Policyalt (exponential discounter's choice)
                entireRHSalt=ReturnMatrix+beta*entireEV_z; % autofill 3rd dim to N_a1
