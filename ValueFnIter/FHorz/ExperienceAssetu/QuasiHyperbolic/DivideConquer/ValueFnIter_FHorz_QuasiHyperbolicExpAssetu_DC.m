...
if length(n_a1)>1
    ...
    if N_e==0 % no e variable
        if N_d1==0
            if N_z==0
                if isNaive
                    [V1Kron,PolicyKron,ValtKron,PolicyaltKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuN_DC2A_nod1_noz_raw(n_d2, n_a1DC, n_a1fold, n_a2,n_u, N_j, d2_gridvals, a1DC_grid, a1fold_gridvals, a2_grid,u_gridvals,pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0);
                else
                    [V1Kron,PolicyKron,ValtKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuS_DC2A_nod1_noz_raw(n_d2, n_a1DC, n_a1fold, n_a2,n_u, N_j, d2_gridvals, a1DC_grid, a1fold_gridvals, a2_grid,u_gridvals,pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0);
                end
            ...
            if N_z==0
                if isNaive
                    ...
                    [V1Kron,PolicyKron,ValtKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuS_DC2A_noz_raw(n_d1, n_d2, n_a1DC, n_a1fold, n_a2,n_u, N_j, d_gridvals, d2_gridvals, a1DC_grid, a1fold_gridvals, a2_grid,u_gridvals,pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0);
                end
