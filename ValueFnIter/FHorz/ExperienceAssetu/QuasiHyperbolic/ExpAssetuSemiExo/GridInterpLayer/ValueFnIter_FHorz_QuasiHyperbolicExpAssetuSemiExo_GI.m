...
%% GI2A path: two (or more) standard endogenous states -- grid-interp the first, fold the rest; n_a2 is the experience assetu
if length(n_a1)>1
    n_a1DC=n_a1(1);
    n_a1fold=n_a1(2:end);
    N_a1DC=prod(n_a1DC);
    ...
    if N_e==0 % no e variable
        if N_d1==0
            if N_z==0
                if isNaive
                    [V1Kron,PolicyKron,ValtKron,PolicyaltKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoN_GI2A_nod1_noz_raw(n_d2,n_d3,n_a1DC,n_a1fold,n_a2,n_semiz,n_u, N_j, d2_gridvals,d3_grid, a1DC_grid,a1fold_gridvals,a2_grid, semiz_gridvals_J,u_gridvals, pi_semiz_J,pi_u, ReturnFn,aprimeFn,Parameters,DiscountFactorParamNames,ReturnFnParamNames,aprimeFnParamNames,vfoptions, beta0);
                else
                ...
                if isNaive
                    ...
                    [V1Kron,PolicyKron,ValtKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoS_GI2A_nod1_raw(n_d2,n_d3,n_a1DC,n_a1fold,n_a2,n_z,n_semiz,n_u, N_j, d2_gridvals,d3_grid, a1DC_grid,a1fold_gridvals,a2_grid, z_gridvals_J,semiz_gridvals_J,u_gridvals, pi_z_J,pi_semiz_J,pi_u, ReturnFn,aprimeFn,Parameters,DiscountFactorParamNames,ReturnFnParamNames,aprimeFnParamNames,vfoptions, beta0);
                end
            end
        else % d1 variable
            if N_z==0
                if isNaive
                    [V1Kron,PolicyKron,ValtKron,PolicyaltKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoN_GI2A_noz_raw(n_d1,n_d2,n_d3,n_a1DC,n_a1fold,n_a2,n_semiz,n_u, N_j, d12_gridvals,d2_gridvals,d3_grid, a1DC_grid,a1fold_gridvals,a2_grid, semiz_gridvals_J,u_gridvals, pi_semiz_J,pi_u, ReturnFn,aprimeFn,Parameters,DiscountFactorParamNames,ReturnFnParamNames,aprimeFnParamNames,vfoptions, beta0);
                else
                    [V1Kron,PolicyKron,ValtKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoS_GI2A_noz_raw(n_d1,n_d2,n_d3,n_a1DC,n_a1fold,n_a2,n_semiz,n_u, N_j, d12_gridvals,d2_gridvals,d3_grid, a1DC_grid,a1fold_gridvals,a2_grid, semiz_gridvals_J,u_gridvals, pi_semiz_J,pi_u, ReturnFn,aprimeFn,Parameters,DiscountFactorParamNames,ReturnFnParamNames,aprimeFnParamNames,vfoptions, beta0);
                end
            else
                if isNaive
                    [V1Kron,PolicyKron,ValtKron,PolicyaltKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoN_GI2A_raw(n_d1,n_d2,n_d3,n_a1DC,n_a1fold,n_a2,n_z,n_semiz,n_u, N_j, d12_gridvals,d2_gridvals,d3_grid, a1DC_grid,a1fold_gridvals,a2_grid, z_gridvals_J,semiz_gridvals_J,u_gridvals, pi_z_J,pi_semiz_J,pi_u, ReturnFn,aprimeFn,Parameters,DiscountFactorParamNames,ReturnFnParamNames,aprimeFnParamNames,vfoptions, beta0);
                else
                    [V1Kron,PolicyKron,ValtKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoS_GI2A_raw(n_d1,n_d2,n_d3,n_a1DC,n_a1fold,n_a2,n_z,n_semiz,n_u, N_j, d12_gridvals,d2_gridvals,d3_grid, a1DC_grid,a1fold_gridvals,a2_grid, z_gridvals_J,semiz_gridvals_J,u_gridvals, pi_z_J,pi_semiz_J,pi_u, ReturnFn,aprimeFn,Parameters,DiscountFactorParamNames,ReturnFnParamNames,aprimeFnParamNames,vfoptions, beta0);
                end
            end
        end
    else % N_e
        if N_d1==0
            if N_z==0
                ...
                if isNaive
                    ...
                    [V1Kron,PolicyKron,ValtKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoS_GI2A_nod1_e_raw(n_d2,n_d3,n_a1DC,n_a1fold,n_a2,n_z,n_semiz,vfoptions.n_e,n_u, N_j, d2_gridvals,d3_grid, a1DC_grid,a1fold_gridvals,a2_grid, z_gridvals_J,semiz_gridvals_J,vfoptions.e_gridvals_J,u_gridvals, pi_z_J,pi_semiz_J,vfoptions.pi_e_J,pi_u, ReturnFn,aprimeFn,Parameters,DiscountFactorParamNames,ReturnFnParamNames,aprimeFnParamNames,vfoptions, beta0);
                end
            end
        else % d1 variable
            if N_z==0
                ...
                if isNaive
                    [V1Kron,PolicyKron,ValtKron,PolicyaltKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoN_GI2A_e_raw(n_d1,n_d2,n_d3,n_a1DC,n_a1fold,n_a2,n_z,n_semiz,vfoptions.n_e,n_u, N_j, d12_gridvals,d2_gridvals,d3_grid, a1DC_grid,a1fold_gridvals,a2_grid, z_gridvals_J,semiz_gridvals_J,vfoptions.e_gridvals_J,u_gridvals, pi_z_J,pi_semiz_J,vfoptions.pi_e_J,pi_u, ReturnFn,aprimeFn,Parameters,DiscountFactorParamNames,ReturnFnParamNames,aprimeFnParamNames,vfoptions, beta0);
                else
                    [V1Kron,PolicyKron,ValtKron]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoS_GI2A_e_raw(n_d1,n_d2,n_d3,n_a1DC,n_a1fold,n_a2,n_z,n_semiz,vfoptions.n_e,n_u, N_j, d12_gridvals,d2_gridvals,d3_grid, a1DC_grid,a1fold_gridvals,a2_grid, z_gridvals_J,semiz_gridvals_J,vfoptions.e_gridvals_J,u_gridvals, pi_z_J,pi_semiz_J,vfoptions.pi_e_J,pi_u, ReturnFn,aprimeFn,Parameters,DiscountFactorParamNames,ReturnFnParamNames,aprimeFnParamNames,vfoptions, beta0);
                end
            end
        end
    end
