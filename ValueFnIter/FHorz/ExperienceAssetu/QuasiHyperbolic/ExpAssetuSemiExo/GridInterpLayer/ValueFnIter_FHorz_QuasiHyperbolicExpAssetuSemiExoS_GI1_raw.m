function [Vhat,Policy,Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoS_GI1_raw(n_d1,n_d2,n_d3,n_a1,n_a2,n_z,n_semiz,n_u,N_j, d12_gridvals, d2_gridvals, d3_grid, a1_gridvals, a2_grid, z_gridvals_J, semiz_gridvals_J, u_gridvals, pi_z_J, pi_semiz_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
% Sophisticated quasi-hyperbolic discounting variant of ValueFnIter_FHorz_ExpAssetuSemiExo_GI1_raw.
...
Policy4_ford3_hat=zeros(4,N_a,N_semiz*N_z,N_d3,'gpuArray');
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policy(4,:,:,N_j)=reshape(Policy4_ford3_hat(3+temp),[1,N_a,N_bothz]); % a1prime midpoint
...
for reverse_j=1:N_j-1
    ...
    Policy(4,:,:,jj)=reshape(Policy4_ford3_hat(3+temp),[1,N_a,N_bothz]); % a1prime midpoint
