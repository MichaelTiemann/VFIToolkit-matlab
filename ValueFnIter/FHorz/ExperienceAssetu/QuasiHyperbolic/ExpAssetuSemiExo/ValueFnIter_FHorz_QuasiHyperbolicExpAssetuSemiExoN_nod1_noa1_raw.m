function [Vtilde,Policy2,Valt,Policy2alt]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoN_nod1_noa1_raw(n_d2,n_d3,n_a2,n_z,n_semiz,n_u,N_j, d2_gridvals, d3_grid, a2_grid, z_gridvals_J, semiz_gridvals_J, u_gridvals, pi_z_J, pi_semiz_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        ...
        for z_c=1:N_z
            ...
            d_ind=rem(maxindex-1,N_d23)+1;
            Policy2alt(1,:,zind,N_j)=rem(d_ind-1,N_d2)+1;
            Policy2alt(2,:,zind,N_j)=ceil(d_ind/N_d2);
        end
    ...
    elseif vfoptions.lowmemory==2
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_bothz
                ...
                entireRHS_alt=ReturnMatrix_d3z+beta*EV_z;
                [Vtemp_alt,maxindex_alt]=max(entireRHS_alt,[],1);
                V_ford3_alt(:,z_c,d3_c)=Vtemp_alt;
                Policy_ford3_alt(:,z_c,d3_c)=maxindex_alt;
                entireRHS_tilde=ReturnMatrix_d3z+beta0beta*EV_z;
                [Vtemp_tilde,maxindex_tilde]=max(entireRHS_tilde,[],1);
