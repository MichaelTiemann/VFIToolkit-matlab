function [Vtilde,Policy3,Valt,Policy3alt]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoN_DC2A_nod1_noz_e_raw(n_d2, n_d3, n_a1, n_a2, n_a3, n_semiz, n_e, n_u, N_j, d2_gridvals, d3_grid, a1_grid, a2_gridvals, a3_grid, semiz_gridvals_J, e_gridvals_J, u_gridvals, pi_semiz_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            Policy3alt(3,curraindex,:,e_c,N_j)=ceil(maxindex2/N_d23); % joint(a1prime,a2prime)
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_semiz
            ...
            for e_c=1:N_e
                ...
                Policy3alt(3,curraindex,z_c,e_c,N_j)=ceil(maxindex2/N_d23); % joint(a1prime,a2prime)
