function [Vtilde,Policy2,Valt,Policy2alt]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoN_nod1_noa1_noz_e_raw(n_d2,n_d3,n_a2,n_semiz,n_e,n_u,N_j, d2_gridvals, d3_grid, a2_grid, semiz_gridvals_J, e_gridvals_J, u_gridvals, pi_semiz_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
% noa1 version of ValueFnIter_FHorz_ExpAssetuSemiExo_nod1_noz_e_raw (nod1, noz, e, with u).
...
Policy2alt=zeros(2,N_a,N_semiz,N_e,N_j,'gpuArray');
