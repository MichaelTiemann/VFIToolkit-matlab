function [Vhat,Policy3,Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetuSemiExoS_nod1_e_raw(n_d2,n_d3,n_a1,n_a2,n_z,n_semiz,n_e,n_u,N_j, d2_gridvals, d3_grid, a1_gridvals, a2_grid, z_gridvals_J, semiz_gridvals_J, e_gridvals_J, u_gridvals, pi_z_J, pi_semiz_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    % hat: argmax at beta0*beta; under: the beta-RHS gathered at that argmax
                    entireRHS_hat=ReturnMatrix_d3z+DiscountedEV_z_hat;
                    [Vtemp,maxindex]=max(entireRHS_hat,[],1);
                    entireRHS_under=ReturnMatrix_d3z+DiscountedEV_z_under;
