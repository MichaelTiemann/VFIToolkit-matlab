function [Vtilde,Policy3,Valt,Policy3alt]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetsemizN_nod1_raw(n_d2,n_d3,n_a1,n_a2,n_z,n_semiz,N_j, d2_gridvals, d3_grid, a1_gridvals, a2_grid, z_gridvals_J, semiz_gridvals_J, pi_z_J, pi_semiz_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1 % loop over z (markov), vectorize over semiz
        for z_c=1:N_z
            ...
            d_ind=rem(maxindex-1,N_d23)+1;
            Policy3alt(1,:,semizblock,N_j)=rem(d_ind-1,N_d2)+1;
            Policy3alt(2,:,semizblock,N_j)=ceil(d_ind/N_d2);
            Policy3alt(3,:,semizblock,N_j)=ceil(maxindex/N_d23);
        end
