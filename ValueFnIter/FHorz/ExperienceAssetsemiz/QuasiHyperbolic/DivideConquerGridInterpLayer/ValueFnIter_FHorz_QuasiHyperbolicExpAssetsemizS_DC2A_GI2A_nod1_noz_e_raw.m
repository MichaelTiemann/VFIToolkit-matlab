...
Policy3_ford3_hat=zeros(3,N_a,N_semiz,N_e,N_d3,'gpuArray'); % d2, joint(a1prime-midpoint,a2prime), a1primeL2ind
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            EVfine=reshape(entireEVinterp(aprimez),[N_d2*n2long*N_a2,N_a,N_semiz,N_e]);
            entireRHS_ii_d3=reshape(ReturnMatrix_ii_d3,[N_d2*n2long*N_a2,N_a,N_semiz,N_e])+beta0beta*EVfine;
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            for e_c=1:N_e
                ...
                aprimez=(1:1:N_d2)' + N_d2*(a1primeindexes-1) + N_d2*N_a1fine*shiftdim((0:1:N_a2-1),-1) + N_d2*N_a1fine*N_a2*shiftdim((0:1:N_a3-1),-4) + N_d2*N_a1fine*N_a2*N_a3*shiftdim((0:1:N_semiz-1),-5);
                EVfine=reshape(entireEVinterp(aprimez),[N_d2*n2long*N_a2,N_a,N_semiz]);
    ...
    Policy(4,:,:,:,N_j)=reshape(Policy3_ford3_hat(3+temp),[1,N_a,N_semiz,N_e]); % a1primeL2ind
...
for reverse_j=1:N_j-1
    ...
    Policy(4,:,:,:,jj)=reshape(Policy3_ford3_hat(3+temp),[1,N_a,N_semiz,N_e]); % a1primeL2ind
