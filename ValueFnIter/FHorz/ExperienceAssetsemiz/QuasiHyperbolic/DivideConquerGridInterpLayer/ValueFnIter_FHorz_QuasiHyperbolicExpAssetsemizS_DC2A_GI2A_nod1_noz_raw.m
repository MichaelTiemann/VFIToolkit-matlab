...
d2_ford3_hat=zeros(N_a,N_semiz,N_d3,'gpuArray');
mid_ford3_hat=zeros(N_a,N_semiz,N_d3,'gpuArray');
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            d2_ford3_hat(:,:,d3_c)=shiftdim(d_ind,1);
            mid_ford3_hat(:,:,d3_c)=shiftdim(midpoint(allind)+N_a1*(maxindexL2a2-1),1);
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            for z_c=1:N_semiz
                ...
                d2_ford3_hat(:,z_c,d3_c)=shiftdim(d_ind,1);
                mid_ford3_hat(:,z_c,d3_c)=shiftdim(midpoint(allind)+N_a1*(maxindexL2a2-1),1);
