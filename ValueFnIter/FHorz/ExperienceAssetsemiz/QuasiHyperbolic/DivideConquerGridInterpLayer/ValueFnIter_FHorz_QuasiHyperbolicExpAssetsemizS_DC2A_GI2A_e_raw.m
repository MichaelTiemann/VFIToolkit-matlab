...
V_ford3_under=zeros(N_a,N_bothz,N_e,N_d3,'gpuArray'); % beta-value gathered at the hat argmax, per d3
Policy4_ford3_hat=zeros(4,N_a,N_bothz,N_e,N_d3,'gpuArray'); % d1,d2,joint(a1prime,a2prime),a1primeL2ind
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            for e_c=1:N_e
                ...
                EVfine=reshape(entireEVinterp(aprime),[N_d12*n2long*N_a2,N_a,N_bothz]);
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    EVfine=reshape(entireEVinterp_z(aprime),[N_d12*n2long*N_a2,N_a,N_semiz]);
