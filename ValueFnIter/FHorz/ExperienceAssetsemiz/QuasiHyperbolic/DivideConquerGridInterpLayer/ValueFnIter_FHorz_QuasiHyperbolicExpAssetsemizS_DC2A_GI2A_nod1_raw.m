...
d2_ford3_hat=zeros(N_a,N_bothz,N_d3,'gpuArray');
mid_ford3_hat=zeros(N_a,N_bothz,N_d3,'gpuArray');
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                d2_ford3_hat(:,zind,d3_c)=shiftdim(d_ind,1);
                mid_ford3_hat(:,zind,d3_c)=shiftdim(midpoint(allind)+N_a1*(maxindexL2a2-1),1);
            ...
            for z_c=1:N_z
                ...
                for ii=1:(vfoptions.level1n-1)
                    ...
                    if maxgap(ii)>0
                        ...
                        entireRHS_ii_z=ReturnMatrix_ii_z+beta0beta*entireEV_z(d2aprimez);
