...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            entireRHS_under=ReturnMatrix_d3+beta*repelem(entireEV,N_d1,N_a1,1); % broadcasts over e
    ...
    elseif vfoptions.lowmemory==2 % outer z / inner e, vectorize semiz
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                EVbase_qh_z=repelem(entireEV_z,N_d1,N_a1,1);
                DiscountedEV_z_under=beta*EVbase_qh_z;
                DiscountedEV_z_hat=beta0beta*EVbase_qh_z;
    ...
    elseif vfoptions.lowmemory==3
        for d3_c=1:N_d3
            ...
            for z_c=1:N_bothz
                ...
                entireEV_z=EV1.*aprimeProbs_z+EV2.*(1-aprimeProbs_z);
                EVbase_qh_z=repelem(entireEV_z,N_d1,N_a1);
                DiscountedEV_z_under=beta*EVbase_qh_z;
                DiscountedEV_z_hat=beta0beta*EVbase_qh_z;
