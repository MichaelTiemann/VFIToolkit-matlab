...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            entireRHS_under=ReturnMatrix_d3+beta*repelem(entireEV,1,N_a1,1); % broadcasts over e
