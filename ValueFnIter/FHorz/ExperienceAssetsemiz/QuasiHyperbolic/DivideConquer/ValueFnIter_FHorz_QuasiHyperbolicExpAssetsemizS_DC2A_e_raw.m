...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                Policy4(4,curraindex,zind,e_c,N_j)=ceil(maxindex2/N_d); % joint(a1prime,a2prime)
                ...
                for ii=1:(vfoptions.level1n-1)
                    ...
                    if maxgap(ii)>0
                        ...
                        Policy4(2,curraindex,zind,e_c,N_j)=ceil(d12_ind/N_d1); % d2
                        Policy4(3,curraindex,zind,e_c,N_j)=ceil(dind/N_d12); % d3
                        Policy4(4,curraindex,zind,e_c,N_j)=a1prime_rec+N_a1*(a2pind-1); % joint(a1prime,a2prime)
                    else
                        loweredge=maxindex1(:,1,:,ii,:,:,:,:);
                        ...
                        Policy4(2,curraindex,zind,e_c,N_j)=ceil(d12_ind/N_d1); % d2
                        Policy4(3,curraindex,zind,e_c,N_j)=ceil(dind/N_d12); % d3
                        Policy4(4,curraindex,zind,e_c,N_j)=loweredge(loweredge_idx)+N_a1*(a2pind-1); % joint(a1prime,a2prime)
                    end
                end
            end
        end
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            DiscountedEV_hat=beta0beta*reshape(EV,[N_d2,N_a1,N_a2,1,1,N_a3,N_bothz]);   % QH-perceived
            DiscountedEV_under=beta*reshape(EV,[N_d2,N_a1,N_a2,1,1,N_a3,N_bothz]);   % exponential
            ...
            entireRHS_ii_d3_under=ReturnMatrix_ii_d3+repelem(DiscountedEV_under,N_d1,1,1,1,1,1,1);
            ...
            entireRHS_ii_d3_under_flat=reshape(entireRHS_ii_d3_under,[N_d12*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,N_bothz,N_e]);
            maxindexfull=maxindex2 + N_d12*N_a1*N_a2*(0:vfoptions.level1n*N_a2*N_a3-1) + N_d12*N_a1*N_a2*vfoptions.level1n*N_a2*N_a3*shiftdim((0:N_bothz-1),-1) + N_d12*N_a1*N_a2*vfoptions.level1n*N_a2*N_a3*N_bothz*shiftdim((0:N_e-1),-2);
            ...
            for ii=1:(vfoptions.level1n-1)
                ...
                if maxgap(ii)>0
                    ...
                    entireRHS_ii=reshape(ReturnMatrix_ii_d3+DiscountedEV_hat(d2aprimez),[N_d12*(maxgap(ii)+1)*N_a2,level1iidiff(ii)*N_a2*N_a3,N_bothz,N_e]);
                    entireRHS_ii_under=reshape(ReturnMatrix_ii_d3+DiscountedEV_under(d2aprimez),[N_d12*(maxgap(ii)+1)*N_a2,level1iidiff(ii)*N_a2*N_a3,N_bothz,N_e]);
                    [Vtempii,maxindex]=max(entireRHS_ii,[],1);
                    maxindexfull=maxindex + N_d12*(maxgap(ii)+1)*N_a2*(0:level1iidiff(ii)*N_a2*N_a3-1) + N_d12*(maxgap(ii)+1)*N_a2*level1iidiff(ii)*N_a2*N_a3*shiftdim((0:N_bothz-1),-1) + N_d12*(maxgap(ii)+1)*N_a2*level1iidiff(ii)*N_a2*N_a3*N_bothz*shiftdim((0:N_e-1),-2);
                    ...
                    entireRHS_ii=reshape(ReturnMatrix_ii_d3+DiscountedEV_hat(d2aprimez),[N_d12*1*N_a2,level1iidiff(ii)*N_a2*N_a3,N_bothz,N_e]);
                    entireRHS_ii_under=reshape(ReturnMatrix_ii_d3+DiscountedEV_under(d2aprimez),[N_d12*1*N_a2,level1iidiff(ii)*N_a2*N_a3,N_bothz,N_e]);
                    [Vtempii,maxindex]=max(entireRHS_ii,[],1);
                    maxindexfull=maxindex + N_d12*1*N_a2*(0:level1iidiff(ii)*N_a2*N_a3-1) + N_d12*1*N_a2*level1iidiff(ii)*N_a2*N_a3*shiftdim((0:N_bothz-1),-1) + N_d12*1*N_a2*level1iidiff(ii)*N_a2*N_a3*N_bothz*shiftdim((0:N_e-1),-2);
                    Vtempii_under=entireRHS_ii_under(maxindexfull);
                    V_ford3_hat(curraindex,:,:,d3_c)=shiftdim(Vtempii,1);
                    V_ford3_under(curraindex,:,:,d3_c)=shiftdim(Vtempii_under,1);
                    dind   =rem(maxindex-1,N_d12)+1;
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            for e_c=1:N_e
                ...
                entireRHS_ii_d3_under_flat=reshape(entireRHS_ii_d3_under,[N_d12*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,N_bothz]);
                maxindexfull=maxindex2 + N_d12*N_a1*N_a2*(0:vfoptions.level1n*N_a2*N_a3-1) + N_d12*N_a1*N_a2*vfoptions.level1n*N_a2*N_a3*shiftdim((0:N_bothz-1),-1);
                Vtempii_under=entireRHS_ii_d3_under_flat(maxindexfull);
                curraindex=repmat(level1ii',N_a2*N_a3,1) +N_a1*repmat(repelem(a2ind,vfoptions.level1n,1),N_a3,1) +N_a1*N_a2*repelem(a3ind,vfoptions.level1n*N_a2,1);
                ...
                for ii=1:(vfoptions.level1n-1)
                    ...
                    if maxgap(ii)>0
                        ...
                        entireRHS_ii_under=reshape(ReturnMatrix_ii_d3+DiscountedEV_under(d2aprimez),[N_d12*(maxgap(ii)+1)*N_a2,level1iidiff(ii)*N_a2*N_a3,N_bothz]);
                        [Vtempii,maxindex]=max(entireRHS_ii,[],1);
                        maxindexfull=maxindex + N_d12*(maxgap(ii)+1)*N_a2*(0:level1iidiff(ii)*N_a2*N_a3-1) + N_d12*(maxgap(ii)+1)*N_a2*level1iidiff(ii)*N_a2*N_a3*shiftdim((0:N_bothz-1),-1);
                        Vtempii_under=entireRHS_ii_under(maxindexfull);
                        V_ford3_hat(curraindex,:,e_c,d3_c)=shiftdim(Vtempii,1);
                        V_ford3_under(curraindex,:,e_c,d3_c)=shiftdim(Vtempii_under,1);
                        dind      =rem(maxindex-1,N_d12)+1;
                        ...
                        entireRHS_ii_under=reshape(ReturnMatrix_ii_d3+DiscountedEV_under(d2aprimez),[N_d12*1*N_a2,level1iidiff(ii)*N_a2*N_a3,N_bothz]);
                        [Vtempii,maxindex]=max(entireRHS_ii,[],1);
                        maxindexfull=maxindex + N_d12*1*N_a2*(0:level1iidiff(ii)*N_a2*N_a3-1) + N_d12*1*N_a2*level1iidiff(ii)*N_a2*N_a3*shiftdim((0:N_bothz-1),-1);
                        Vtempii_under=entireRHS_ii_under(maxindexfull);
                        V_ford3_hat(curraindex,:,e_c,d3_c)=shiftdim(Vtempii,1);
                        V_ford3_under(curraindex,:,e_c,d3_c)=shiftdim(Vtempii_under,1);
                        dind   =rem(maxindex-1,N_d12)+1;
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_ii_d3_under=ReturnMatrix_ii_d3+repelem(DiscountedEV_z_under,N_d1,1,1,1,1,1,1);
                    [~,maxindex1]=max(entireRHS_ii_d3,[],2);
                    [Vtempii,maxindex2]=max(reshape(entireRHS_ii_d3,[N_d12*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,N_semiz]),[],1);
                    entireRHS_ii_d3_under_flat=reshape(entireRHS_ii_d3_under,[N_d12*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,N_semiz]);
                    maxindexfull=maxindex2 + N_d12*N_a1*N_a2*(0:vfoptions.level1n*N_a2*N_a3-1) + N_d12*N_a1*N_a2*vfoptions.level1n*N_a2*N_a3*shiftdim((0:N_semiz-1),-1);
                    Vtempii_under=entireRHS_ii_d3_under_flat(maxindexfull);
                    curraindex=repmat(level1ii',N_a2*N_a3,1) +N_a1*repmat(repelem(a2ind,vfoptions.level1n,1),N_a3,1) +N_a1*N_a2*repelem(a3ind,vfoptions.level1n*N_a2,1);
                    ...
                    for ii=1:(vfoptions.level1n-1)
                        ...
                        if maxgap(ii)>0
                            ...
                            entireRHS_ii_under=reshape(ReturnMatrix_ii_d3+DiscountedEV_z_under(d2aprimez),[N_d12*(maxgap(ii)+1)*N_a2,level1iidiff(ii)*N_a2*N_a3,N_semiz]);
                            [Vtempii,maxindex]=max(entireRHS_ii,[],1);
                            maxindexfull=maxindex + N_d12*(maxgap(ii)+1)*N_a2*(0:level1iidiff(ii)*N_a2*N_a3-1) + N_d12*(maxgap(ii)+1)*N_a2*level1iidiff(ii)*N_a2*N_a3*shiftdim((0:N_semiz-1),-1);
                            Vtempii_under=entireRHS_ii_under(maxindexfull);
                            V_ford3_hat(curraindex,zind,e_c,d3_c)=shiftdim(Vtempii,1);
                            V_ford3_under(curraindex,zind,e_c,d3_c)=shiftdim(Vtempii_under,1);
                            dind      =rem(maxindex-1,N_d12)+1;
                            ...
                            a1prime_rec=a1localind+loweredge(loweredge_idx)-1;
                            Policy_ford3_hat(curraindex,zind,e_c,d3_c)=shiftdim(dind + N_d12*(a1prime_rec-1) + N_d12*N_a1*(a2pind-1),1);
                        else
                            loweredge=maxindex1(:,1,:,ii,:,:,:,:);
                            ...
                            entireRHS_ii_under=reshape(ReturnMatrix_ii_d3+DiscountedEV_z_under(d2aprimez),[N_d12*1*N_a2,level1iidiff(ii)*N_a2*N_a3,N_semiz]);
                            [Vtempii,maxindex]=max(entireRHS_ii,[],1);
                            maxindexfull=maxindex + N_d12*1*N_a2*(0:level1iidiff(ii)*N_a2*N_a3-1) + N_d12*1*N_a2*level1iidiff(ii)*N_a2*N_a3*shiftdim((0:N_semiz-1),-1);
                            Vtempii_under=entireRHS_ii_under(maxindexfull);
                            V_ford3_hat(curraindex,zind,e_c,d3_c)=shiftdim(Vtempii,1);
                            V_ford3_under(curraindex,zind,e_c,d3_c)=shiftdim(Vtempii_under,1);
                            dind   =rem(maxindex-1,N_d12)+1;
                            ...
                            a3ind_flat=repelem((0:N_a3-1),1,level1iidiff(ii)*N_a2);
                            loweredge_idx=dind + N_d12*(a2pind-1) + N_d12*N_a2*a2ind_flat + N_d12*N_a2*N_a2*a3ind_flat + N_d12*N_a2*N_a2*N_a3*semizind;
                            Policy_ford3_hat(curraindex,zind,e_c,d3_c)=shiftdim(dind + N_d12*(loweredge(loweredge_idx)-1) + N_d12*N_a1*(a2pind-1),1);
                        end
                    end
                end
            end
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_bothz
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_ii_d3_under_flat=reshape(entireRHS_ii_d3_under,[N_d12*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3]);
                    maxindexfull=maxindex2 + N_d12*N_a1*N_a2*(0:vfoptions.level1n*N_a2*N_a3-1);
                    Vtempii_under=entireRHS_ii_d3_under_flat(maxindexfull);
                    curraindex=repmat(level1ii',N_a2*N_a3,1) +N_a1*repmat(repelem(a2ind,vfoptions.level1n,1),N_a3,1) +N_a1*N_a2*repelem(a3ind,vfoptions.level1n*N_a2,1);
                    ...
                    for ii=1:(vfoptions.level1n-1)
                        ...
                        if maxgap(ii)>0
                            ...
                            entireRHS_ii_under=reshape(ReturnMatrix_ii_d3+DiscountedEV_z_under(d2aprime),[N_d12*(maxgap(ii)+1)*N_a2,level1iidiff(ii)*N_a2*N_a3]);
                            [Vtempii,maxindex]=max(entireRHS_ii,[],1);
                            maxindexfull=maxindex + N_d12*(maxgap(ii)+1)*N_a2*(0:level1iidiff(ii)*N_a2*N_a3-1);
                            Vtempii_under=entireRHS_ii_under(maxindexfull);
                            V_ford3_hat(curraindex,z_c,e_c,d3_c)=shiftdim(Vtempii,1);
                            V_ford3_under(curraindex,z_c,e_c,d3_c)=shiftdim(Vtempii_under,1);
                            dind      =rem(maxindex-1,N_d12)+1;
                            ...
                            entireRHS_ii_under=reshape(ReturnMatrix_ii_d3+DiscountedEV_z_under(d2aprime),[N_d12*1*N_a2,level1iidiff(ii)*N_a2*N_a3]);
                            [Vtempii,maxindex]=max(entireRHS_ii,[],1);
                            maxindexfull=maxindex + N_d12*1*N_a2*(0:level1iidiff(ii)*N_a2*N_a3-1);
                            Vtempii_under=entireRHS_ii_under(maxindexfull);
                            V_ford3_hat(curraindex,z_c,e_c,d3_c)=shiftdim(Vtempii,1);
                            V_ford3_under(curraindex,z_c,e_c,d3_c)=shiftdim(Vtempii_under,1);
                            dind   =rem(maxindex-1,N_d12)+1;
    ...
    d12aprime_ind=reshape(Policy_ford3_hat((1:1:N_a*N_semiz*N_z*N_e)'+(N_a*N_semiz*N_z*N_e)*(maxindex-1)),[1,N_a,N_semiz*N_z,N_e]);
