...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        ...
        for z_c=1:N_z
            ...
            Policy4(1,curraindex,zind,N_j)=rem(d12_ind-1,N_d1)+1; % d1
            Policy4(2,curraindex,zind,N_j)=ceil(d12_ind/N_d1); % d2
            Policy4(3,curraindex,zind,N_j)=ceil(dind/N_d12); % d3
            Policy4(4,curraindex,zind,N_j)=ceil(maxindex2/N_d); % joint(a1prime,a2prime)
            ...
            for ii=1:(vfoptions.level1n-1)
                ...
                if maxgap(ii)>0
                    ...
                    Policy4(2,curraindex,zind,N_j)=ceil(d12_ind/N_d1); % d2
                    Policy4(3,curraindex,zind,N_j)=ceil(dind/N_d12); % d3
                    Policy4(4,curraindex,zind,N_j)=a1prime_rec+N_a1*(a2pind-1); % joint(a1prime,a2prime)
                else
                    loweredge=maxindex1(:,1,:,ii,:,:,:);
                    ...
                    Policy4(2,curraindex,zind,N_j)=ceil(d12_ind/N_d1); % d2
                    Policy4(3,curraindex,zind,N_j)=ceil(dind/N_d12); % d3
                    Policy4(4,curraindex,zind,N_j)=loweredge(loweredge_idx)+N_a1*(a2pind-1); % joint(a1prime,a2prime)
                end
            end
        end
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_bothz
            ...
            Policy4(1,curraindex,z_c,N_j)=rem(d12_ind-1,N_d1)+1; % d1
            Policy4(2,curraindex,z_c,N_j)=ceil(d12_ind/N_d1); % d2
            Policy4(3,curraindex,z_c,N_j)=ceil(dind/N_d12); % d3
            Policy4(4,curraindex,z_c,N_j)=ceil(maxindex2/N_d); % joint(a1prime,a2prime)
            ...
            for ii=1:(vfoptions.level1n-1)
                ...
                if maxgap(ii)>0
                    ...
                    Policy4(2,curraindex,z_c,N_j)=ceil(d12_ind/N_d1); % d2
                    Policy4(3,curraindex,z_c,N_j)=ceil(dind/N_d12); % d3
                    Policy4(4,curraindex,z_c,N_j)=a1prime_rec+N_a1*(a2pind-1); % joint(a1prime,a2prime)
                else
                    loweredge=maxindex1(:,1,:,ii,:,:);
                    ...
                    Policy4(2,curraindex,z_c,N_j)=ceil(d12_ind/N_d1); % d2
                    Policy4(3,curraindex,z_c,N_j)=ceil(dind/N_d12); % d3
                    Policy4(4,curraindex,z_c,N_j)=loweredge(loweredge_idx)+N_a1*(a2pind-1); % joint(a1prime,a2prime)
                end
            end
        end
    end
