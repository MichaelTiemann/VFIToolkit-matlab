function [V,Policy3]=ValueFnIter_FHorz_ExpAssetsemiz_raw(n_d1,n_d2,n_d3,n_a1,n_a2,n_z,n_semiz,N_j, d12_gridvals, d2_gridvals, d3_grid, a1_gridvals, a2_grid, z_gridvals_J, semiz_gridvals_J, pi_z_J, pi_semiz_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1 % loop over z (markov), vectorize over semiz
        for z_c=1:N_z
            ...
            d_ind=rem(maxindex-1,N_d)+1;
            d12_ind=rem(d_ind-1,N_d12)+1;
            Policy3(1,:,semizblock,N_j)=rem(d12_ind-1,N_d1)+1;
            Policy3(2,:,semizblock,N_j)=ceil(d12_ind/N_d1);
            Policy3(3,:,semizblock,N_j)=ceil(d_ind/N_d12);
            Policy3(4,:,semizblock,N_j)=ceil(maxindex/N_d);
        end
    ...
    elseif vfoptions.lowmemory==1 % loop over z (markov), vectorize over semiz
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                entireRHS_d3z=ReturnMatrix_d3z+DiscountFactorParamsVec*repelem(entireEV_z,N_d1,N_a1,1);
