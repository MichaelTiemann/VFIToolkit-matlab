function [V,Policy]=ValueFnIter_FHorz_RiskyAsset_EpsteinZin_GI1_nod1_noz_raw(n_d2,n_d3,n_a1,n_a2,n_u,N_j, d2_grid, d3_grid, a1_grid, a2_grid, u_grid, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, sj, warmglow, ezc1,ezc2,ezc3,ezc4,ezc5,ezc6,ezc7,ezc8,ezc9)
% d2: aprimeFn but not ReturnFn
% d3: both ReturnFn and aprimeFn
% No d1, no z.
%
% Grid-interpolation-layer version of the Epstein-Zin riskyasset solver.
% Grafts the Epstein-Zin transforms onto ValueFnIter_FHorz_RiskyAsset_GI1_nod1_noz_raw.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if warmglow==1
        Policy(1,:,N_j)=d2index(d3_ind); % d2 comes from refining the warm-glow (no a in WGmatrix)
    else
