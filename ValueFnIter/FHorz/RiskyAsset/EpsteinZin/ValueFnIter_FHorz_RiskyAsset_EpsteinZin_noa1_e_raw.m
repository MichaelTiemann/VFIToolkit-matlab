...
Policy=zeros(3,N_a2,N_z,N_e,N_j,'gpuArray'); % d1,d2,d3
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        ...
        if warmglow==1
            ...
            Policy(1,:,:,:,N_j)=shiftdim(d1index(maxindex+N_d3*aind+N_d3*N_a2*zind+N_d3*N_a2*N_z*eind),1);
            ...
            Policy(2,:,:,:,N_j)=1; % is anyway meaningless
    ...
    elseif vfoptions.lowmemory==1
        ...
        for e_c=1:N_e
            ...
            if warmglow==1
                ...
                Policy(1,:,:,e_c,N_j)=shiftdim(d1index(maxindex+N_d3*aind+N_d3*N_a2*zind),1);
                ...
                Policy(2,:,:,e_c,N_j)=1; % is anyway meaningless
        ...
        for e_c=1:N_e
            ...
            for z_c=1:N_z
                ...
                if warmglow==1
                    ...
                    Policy(2,:,z_c,e_c,N_j)=1; % is anyway meaningless
...
for reverse_j=1:N_j-1
    ...
    if vfoptions.lowmemory==0
        ...
        Policy(1,:,:,:,jj)=shiftdim(d1index(maxindex+N_d3*aind+N_d3*N_a2*zind+N_d3*N_a2*N_z*eind),1);
    ...
    elseif vfoptions.lowmemory==1
        ...
        for e_c=1:N_e
            ...
            Policy(1,:,:,e_c,jj)=shiftdim(d1index(maxindex+N_d3*aind+N_d3*N_a2*zind),1);
