...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    % Discounted warm-glow (the interior's DiscountedEV with the EV term absent; no z nor e in WGmatrix)
    ...
    if vfoptions.lowmemory==0
        ...
        for ii=1:(vfoptions.level1n-1)
            ...
            if maxgap(ii)>0
                ...
                entireRHS_ii=reshape(ezc1*temp2_ii+DiscountedWG(d3aprime),[N_d3*(maxgap(ii)+1),level1iidiff(ii)*N_a2,N_z,N_e]);
                temp5=logical(isfinite(entireRHS_ii).*(entireRHS_ii~=0));
                ...
                entireRHS_ii=reshape(ezc1*temp2_ii+DiscountedWG(d3aprime),[N_d3,level1iidiff(ii)*N_a2,N_z,N_e]);
                temp5=logical(isfinite(entireRHS_ii).*(entireRHS_ii~=0));
                entireRHS_ii(temp5)=entireRHS_ii(temp5).^ezc7(N_j);
                entireRHS_ii(entireRHS_ii==0)=-Inf;
                [Vtempii,maxindex]=max(entireRHS_ii,[],1);
        ...
        for e_c=1:N_e
            ...
            for ii=1:(vfoptions.level1n-1)
                ...
                if maxgap(ii)>0
                    ...
                    temp2_ii(ReturnMatrix_ii==0)=-Inf;
                    d3aprime=d3ind+N_d3*(a1primeindexes-1);
                    entireRHS_ii_e=reshape(ezc1*temp2_ii+DiscountedWG(d3aprime),[N_d3*(maxgap(ii)+1),level1iidiff(ii)*N_a2,N_z]);
                    temp5=logical(isfinite(entireRHS_ii_e).*(entireRHS_ii_e~=0));
                    entireRHS_ii_e(temp5)=entireRHS_ii_e(temp5).^ezc7(N_j);
                    entireRHS_ii_e(entireRHS_ii_e==0)=-Inf;
                    ...
                    temp2_ii(ReturnMatrix_ii==0)=-Inf;
                    d3aprime=d3ind+N_d3*(loweredge-1);
                    entireRHS_ii_e=reshape(ezc1*temp2_ii+DiscountedWG(d3aprime),[N_d3,level1iidiff(ii)*N_a2,N_z]);
                    temp5=logical(isfinite(entireRHS_ii_e).*(entireRHS_ii_e~=0));
                    entireRHS_ii_e(temp5)=entireRHS_ii_e(temp5).^ezc7(N_j);
                    entireRHS_ii_e(entireRHS_ii_e==0)=-Inf;
                    [Vtempii,maxindex]=max(entireRHS_ii_e,[],1);
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                % Compose the warm-glow INSIDE the ^ezc7 root (the V_Jplus1 composition with the EV term absent)
                entireRHS_ii_ze=ezc1*temp2_ii+DiscountedWG; % warm-glow (zero if not using)
                ...
                Policy(1,curraindex,z_c,e_c,N_j)=d2index_resh(d3part+N_d3*(a1primepart-1));
                ...
                for ii=1:(vfoptions.level1n-1)
                    ...
                    if maxgap(ii)>0
                        ...
                        temp2_ii(ReturnMatrix_ii==0)=-Inf;
                        d3aprime=d3ind+N_d3*(a1primeindexes-1);
                        entireRHS_ii_ze=reshape(ezc1*temp2_ii+DiscountedWG(d3aprime),[N_d3*(maxgap(ii)+1),level1iidiff(ii)*N_a2]);
                        temp5=logical(isfinite(entireRHS_ii_ze).*(entireRHS_ii_ze~=0));
                        entireRHS_ii_ze(temp5)=entireRHS_ii_ze(temp5).^ezc7(N_j);
                        entireRHS_ii_ze(entireRHS_ii_ze==0)=-Inf;
                        ...
                        temp2_ii(ReturnMatrix_ii==0)=-Inf;
                        d3aprime=d3ind+N_d3*(loweredge-1);
                        entireRHS_ii_ze=reshape(ezc1*temp2_ii+DiscountedWG(d3aprime),[N_d3,level1iidiff(ii)*N_a2]);
                        temp5=logical(isfinite(entireRHS_ii_ze).*(entireRHS_ii_ze~=0));
                        entireRHS_ii_ze(temp5)=entireRHS_ii_ze(temp5).^ezc7(N_j);
                        entireRHS_ii_ze(entireRHS_ii_ze==0)=-Inf;
                        [Vtempii,maxindex]=max(entireRHS_ii_ze,[],1);
    ...
    if vfoptions.lowmemory==0
        ...
        for ii=1:(vfoptions.level1n-1)
            ...
            if maxgap(ii)>0
                ...
                entireRHS_ii=reshape(ezc1*temp2_ii+DiscountedEV(d3aprimez),[N_d3*(maxgap(ii)+1),level1iidiff(ii)*N_a2,N_z,N_e]);
                temp5=logical(isfinite(entireRHS_ii).*(entireRHS_ii~=0));
                entireRHS_ii(temp5)=entireRHS_ii(temp5).^ezc7(N_j);
                entireRHS_ii(entireRHS_ii==0)=-Inf;
                [Vtempii,maxindex]=max(entireRHS_ii,[],1);
                ...
                entireRHS_ii=reshape(ezc1*temp2_ii+DiscountedEV(d3aprimez),[N_d3,level1iidiff(ii)*N_a2,N_z,N_e]);
                temp5=logical(isfinite(entireRHS_ii).*(entireRHS_ii~=0));
                entireRHS_ii(temp5)=entireRHS_ii(temp5).^ezc7(N_j);
                entireRHS_ii(entireRHS_ii==0)=-Inf;
                [Vtempii,maxindex]=max(entireRHS_ii,[],1);
        ...
        for e_c=1:N_e
            ...
            for ii=1:(vfoptions.level1n-1)
                ...
                if maxgap(ii)>0
                    ...
                    temp2_ii(ReturnMatrix_ii==0)=-Inf;
                    d3aprimez=d3ind+N_d3*(a1primeindexes-1)+N_d3*N_a1*shiftdim(zBind,-2);
                    entireRHS_ii_e=reshape(ezc1*temp2_ii+DiscountedEV(d3aprimez),[N_d3*(maxgap(ii)+1),level1iidiff(ii)*N_a2,N_z]);
                    temp5=logical(isfinite(entireRHS_ii_e).*(entireRHS_ii_e~=0));
                    entireRHS_ii_e(temp5)=entireRHS_ii_e(temp5).^ezc7(N_j);
                    entireRHS_ii_e(entireRHS_ii_e==0)=-Inf;
                    [Vtempii,maxindex]=max(entireRHS_ii_e,[],1);
                    ...
                    temp2_ii(ReturnMatrix_ii==0)=-Inf;
                    d3aprimez=d3ind+N_d3*(loweredge-1)+N_d3*N_a1*shiftdim(zBind,-2);
                    entireRHS_ii_e=reshape(ezc1*temp2_ii+DiscountedEV(d3aprimez),[N_d3,level1iidiff(ii)*N_a2,N_z]);
                    temp5=logical(isfinite(entireRHS_ii_e).*(entireRHS_ii_e~=0));
                    entireRHS_ii_e(temp5)=entireRHS_ii_e(temp5).^ezc7(N_j);
                    entireRHS_ii_e(entireRHS_ii_e==0)=-Inf;
                    [Vtempii,maxindex]=max(entireRHS_ii_e,[],1);
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                entireRHS_ii_ze=ezc1*temp2_ii+DiscountedEV_z;
