function [V,Policy]=ValueFnIter_FHorz_RiskyAsset_EpsteinZin_noa1_noz_raw(n_d1,n_d2,n_d3,n_a,n_u, N_j, d1_grid, d2_grid, d3_grid, a_grid, u_grid, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, sj, warmglow, ezc1,ezc2,ezc3,ezc4,ezc5,ezc6,ezc7,ezc8,ezc9)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    ReturnMatrix=CreateReturnFnMatrix_Case2_Disc_noz(ReturnFn, n_d13, n_a, d13_gridvals, a_gridvals, ReturnFnParamsVec);
    ...
    if warmglow==1
        ...
        Policy(1,:,N_j)=shiftdim(d1index(maxindex+N_d3*aind),1); % d1
