...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if warmglow==1
        ...
        % Rows of ReturnMatrix are (d3,d4,a1prime): spread the refined warm-glow over d4 and a1prime (it is constant in both)
        WGcol=ezc9*repmat(reshape(WGmatrix_onlyd3,[N_d3,1]),N_d4*N_a1,1); % [N_d3*N_d4*N_a1,1]
