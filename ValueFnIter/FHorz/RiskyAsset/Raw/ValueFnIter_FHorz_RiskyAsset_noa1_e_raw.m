function [V,Policy]=ValueFnIter_FHorz_RiskyAsset_noa1_e_raw(n_d1,n_d2,n_d3,n_a,n_z,n_e,n_u,N_j, d1_grid, d2_grid, d3_grid, a_grid, z_gridvals_J, e_gridvals_J, u_grid, pi_z_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
Policy=zeros(3,N_a,N_z,N_e,N_j,vfoptions.indexT,'gpuArray'); % d1,d2,d3
