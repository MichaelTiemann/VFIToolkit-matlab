function [V,Policy]=ValueFnIter_FHorz_RiskyAssetSemiExo_nod1_noa1_e_raw(n_d2,n_d3,n_d4,n_a,n_semiz,n_z,n_e,n_u,N_j, d2_grid, d3_grid, d4_grid, a_grid, semiz_gridvals_J, z_gridvals_J, e_gridvals_J, u_grid, pi_semiz_J, pi_z_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
Policy=zeros(3,N_a,N_semiz*N_z,N_e,N_j,'gpuArray'); % d2, d3, d4
    ...
    elseif vfoptions.lowmemory==2 % outer z (markov), inner e, vectorize semiz
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                Policy(2,:,semizblock,e_c,N_j)=rem(maxindex-1,N_d3)+1;
                Policy(3,:,semizblock,e_c,N_j)=shiftdim(ceil(maxindex/N_d3),-1);
            end
        end
