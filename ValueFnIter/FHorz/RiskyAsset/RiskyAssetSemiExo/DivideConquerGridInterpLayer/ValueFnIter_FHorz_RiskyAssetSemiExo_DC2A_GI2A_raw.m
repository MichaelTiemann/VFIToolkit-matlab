...
Policy3=zeros(3,N_a,N_bothz,N_j,'gpuArray'); % (1)=joint(d1,d3), (2)=joint(a1prime midpoint,a2prime), (3)=L2ind
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    for d4_c=1:N_d4
        ...
        % DiscountedEV: (d3,a1prime,a2prime,-,-,-,bothz), no a3 term (a3prime=aprimeFn(d2,d3,u) ignores current a3)
        ...
        if vfoptions.lowmemory==0
            ...
            ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_bothz, d13_with_d4, a1_grid, a2_gridvals, a1_grid(level1ii), a2_gridvals, a3_grid, bothz_gridvals, ReturnFnParamsVec, 1);
            ...
            for ii=1:(vfoptions.level1n-1)
                ...
                if maxgap(ii)>0
                    ...
                    a1primeindexes=loweredge+(0:1:maxgap(ii));                % [N_d13,maxgap+1,N_a2prime,1,N_a2,N_a3,N_bothz]
                    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_bothz, d13_with_d4, a1_grid(a1primeindexes), a2_gridvals, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, a3_grid, bothz_gridvals, ReturnFnParamsVec, 3);
        ...
        elseif vfoptions.lowmemory==1
            for z_c=1:N_z
                ...
                Policy3_ford4_jj(2,:,semizblock,d4_c)=a1mid+N_a1*(maxindexL2a2-1);
                Policy3_ford4_jj(3,:,semizblock,d4_c)=maxindexL2a1;
                ...
                d2_ford4_jj(:,semizblock,d4_c)=shiftdim(d2index_reshblock(lin),1);
            end
        elseif vfoptions.lowmemory>=2 % lm2 already does the most-looped variant, so it also serves the higher lowmemory values
            for z_c=1:N_bothz
                ...
                ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_bothz, d13_with_d4, a1_grid, a2_gridvals, a1_grid(level1ii), a2_gridvals, a3_grid, z_val, ReturnFnParamsVec, 1);
                ...
                for ii=1:(vfoptions.level1n-1)
                    ...
                    if maxgap(ii)>0
                        loweredge=min(maxindex1(:,1,:,ii,:,:),N_a1-maxgap(ii));
                        a1primeindexes=loweredge+(0:1:maxgap(ii));
                        ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_bothz, d13_with_d4, a1_grid(a1primeindexes), a2_gridvals, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, a3_grid, z_val, ReturnFnParamsVec, 3);
                ...
                midpoint=max(min(midpoint,N_a1-1),2);
                a1primeindexesfine=(midpoint+(midpoint-1)*n2short)+(-n2short-1:1:1+n2short);
                ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_bothz, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, ReturnFnParamsVec, 3);
...
%% Encode Policy (8 rows: d1,d2,d3,d4,a1prime,a2prime,L2,L2flag)
