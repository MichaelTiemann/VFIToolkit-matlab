function [V,Policy]=ValueFnIter_FHorz_RiskyAssetSemiExo_DC2A_GI2A_noz_e_raw(n_d1,n_d2,n_d3,n_d4,n_a1,n_a2,n_a3,n_semiz,n_e,n_u,N_j, d1_grid, d2_grid, d3_grid, d4_grid, a1_grid, a2_grid, a3_grid, semiz_gridvals_J, e_gridvals_J, u_grid, pi_semiz_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
% Two standard endogenous assets version of ValueFnIter_FHorz_RiskyAssetSemiExo_DC1_GI1_noz_e_raw.
...
Policy3=zeros(3,N_a,N_semiz,N_e,N_j,'gpuArray'); % (1)=joint(d1,d3), (2)=joint(a1prime midpoint,a2prime), (3)=L2ind
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    for d4_c=1:N_d4
        ...
        if vfoptions.lowmemory==0
            midpoint=zeros(N_d13,1,N_a2,N_a1,N_a2,N_a3,N_semiz,N_e,'gpuArray');

            ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, n_e, d13_with_d4, a1_grid, a2_gridvals, a1_grid(level1ii), a2_gridvals, a3_grid, semiz_gridvals, e_gridvals, ReturnFnParamsVec, 1);
            ...
            for ii=1:(vfoptions.level1n-1)
                ...
                if maxgap(ii)>0
                    ...
                    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, n_e, d13_with_d4, a1_grid(a1primeindexes), a2_gridvals, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, a3_grid, semiz_gridvals, e_gridvals, ReturnFnParamsVec, 3);
            ...
            ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, n_e, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_gridvals, e_gridvals, ReturnFnParamsVec, 3);
            ...
            entireRHS_ii=reshape(ReturnMatrix_ii+DiscountedEVinterp(aprimez),[N_d13*n2long*N_a2,N_a,N_semiz,N_e]);
            ...
            allind=d_ind + N_d13*(maxindexL2a2-1) + N_d13*N_a2*aind + N_d13*N_a2*N_a*zBind + N_d13*N_a2*N_a*N_semiz*eBind;
            ...
            ReturnMatrix_ii_flat=reshape(ReturnMatrix_ii,[N_d13*n2long*N_a2,N_a,N_semiz,N_e]);
            linidx_lower  = d_ind                   + N_d13*n2long*(maxindexL2a2-1) + N_d13*n2long*N_a2*aind + N_d13*n2long*N_a2*N_a*zBind + N_d13*n2long*N_a2*N_a*N_semiz*eBind;
            linidx_upper  = d_ind + N_d13*(n2long-1) + N_d13*n2long*(maxindexL2a2-1) + N_d13*n2long*N_a2*aind + N_d13*n2long*N_a2*N_a*zBind + N_d13*n2long*N_a2*N_a*N_semiz*eBind;
        ...
        elseif vfoptions.lowmemory==1
            ...
            for e_c=1:N_e
                ...
                ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, special_n_e, d13_with_d4, a1_grid, a2_gridvals, a1_grid(level1ii), a2_gridvals, a3_grid, semiz_gridvals, e_val, ReturnFnParamsVec, 1);
                ...
                for ii=1:(vfoptions.level1n-1)
                    ...
                    if maxgap(ii)>0
                        ...
                        ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, special_n_e, d13_with_d4, a1_grid(a1primeindexes), a2_gridvals, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, a3_grid, semiz_gridvals, e_val, ReturnFnParamsVec, 3);
                ...
                midpoint=max(min(midpoint,N_a1-1),2);
                a1primeindexesfine=(midpoint+(midpoint-1)*n2short)+(-n2short-1:1:1+n2short);
                ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, special_n_e, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_gridvals, e_val, ReturnFnParamsVec, 3);
        ...
        elseif vfoptions.lowmemory>=2 % lm2 already does the most-looped variant, so it also serves the higher lowmemory values
            ...
            for z_c=1:N_semiz
                ...
                for e_c=1:N_e
                    ...
                    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_semiz, special_n_e, d13_with_d4, a1_grid, a2_gridvals, a1_grid(level1ii), a2_gridvals, a3_grid, semiz_val, e_val, ReturnFnParamsVec, 1);
                    ...
                    for ii=1:(vfoptions.level1n-1)
                        ...
                        if maxgap(ii)>0
                            loweredge=min(maxindex1(:,1,:,ii,:,:),N_a1-maxgap(ii));
                            a1primeindexes=loweredge+(0:1:maxgap(ii));
                            ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_semiz, special_n_e, d13_with_d4, a1_grid(a1primeindexes), a2_gridvals, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, a3_grid, semiz_val, e_val, ReturnFnParamsVec, 3);
                    ...
                    midpoint=max(min(midpoint,N_a1-1),2);
                    a1primeindexesfine=(midpoint+(midpoint-1)*n2short)+(-n2short-1:1:1+n2short);
                    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_semiz, special_n_e, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_val, e_val, ReturnFnParamsVec, 3);
...
Policy=zeros(8,N_a,N_semiz,N_e,N_j,'gpuArray'); % rows: (d1,d2,d3,d4,a1prime,a2prime,L2,L2flag)
d13=Policy3(1,:,:,:,:);
