...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    [V(:,:,N_j),Policy3(:,:,:,N_j),PolicyL2flag(:,:,:,N_j),d2Policy(:,:,:,N_j),d4Policy(:,:,:,N_j)]=internal_per_j(EVpre,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d1,n_d3,n_d4,n_a1,n_a2,n_bothz,N_d1,N_d2,N_d3,N_d4,N_d13,N_d23,N_a1,N_a1prime,N_a2,N_a,N_bothz,N_u,...
...
for reverse_j=1:N_j-1
    ...
    [V(:,:,jj),Policy3(:,:,:,jj),PolicyL2flag(:,:,:,jj),d2Policy(:,:,:,jj),d4Policy(:,:,:,jj)]=internal_per_j(EVnext,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d1,n_d3,n_d4,n_a1,n_a2,n_bothz,N_d1,N_d2,N_d3,N_d4,N_d13,N_d23,N_a1,N_a1prime,N_a2,N_a,N_bothz,N_u,...
...
%% Encode single-index Policy (Case2 FHorz) with d2, d4, L2flag included.
...
%% Per-period inner
function [V_jj,Policy3_jj,PolicyL2flag_jj,d2Policy_jj,d4Policy_jj]=internal_per_j(EVnext,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
    n_d1,n_d3,n_d4,n_a1,n_a2,n_bothz,N_d1,N_d2,N_d3,N_d4,N_d13,N_d23,N_a1,N_a1prime,N_a2,N_a,N_bothz_count,N_u,...
...
for d4_c=1:N_d4
    ...
    entireRHS_ii=reshape(ReturnMatrix_ii+reshape(DiscountedEVinterp(da1primez),[N_d13,n2long,N_a1,N_a2,N_bothz_count]),[N_d13*n2long,N_a1*N_a2,N_bothz_count]);
