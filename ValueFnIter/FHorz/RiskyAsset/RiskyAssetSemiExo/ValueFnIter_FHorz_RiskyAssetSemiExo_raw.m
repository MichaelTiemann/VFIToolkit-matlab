...
Policy=zeros(5,N_a,N_semiz*N_z,N_j,vfoptions.indexT,'gpuArray'); % d1, d2, d3, d4 and a1prime
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        ...
        for d4_c=1:N_d4
            ...
            EV=sum((EV1.*pi_u'),2)+sum((EV2.*pi_u'),2); % (d23&a1prime,1,bothz)

            % Time to refine
            % First: ReturnMatrix, we can refine out d1
            [ReturnMatrix_onlyd3,d1index]=max(reshape(ReturnMatrix_d4,[N_d1,N_d3*N_a1,N_a,N_bothz]),[],1);
