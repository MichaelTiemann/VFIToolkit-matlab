function [V,Policy]=ValueFnIter_FHorz_RiskyAssetSemiExo_GI2A_nod1_raw(n_d2,n_d3,n_d4,n_a1,n_a2,n_a3,n_semiz,n_z,n_u,N_j, d2_grid, d3_grid, d4_grid, a1_grid, a2_grid, a3_grid, semiz_gridvals_J, z_gridvals_J, u_grid, pi_semiz_J, pi_z_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
% Two standard endogenous assets version of ValueFnIter_FHorz_RiskyAssetSemiExo_GI1_nod1_raw.
...
Policy=zeros(7,N_a,N_bothz,N_j,'gpuArray'); % (d2, d3, d4, a1prime_low, a2prime, L2, L2flag)
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, n_bothz, d3_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, bothz_gridvals_J(:,:,N_j), ReturnFnParamsVec, 1);
            % [N_d3, N_a1prime, N_a2prime, N_a1, N_a2, N_a3, N_bothz]
            ...
            ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, n_bothz, d3_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, bothz_gridvals_J(:,:,N_j), ReturnFnParamsVec, 2);
        ...
        for d4_c=1:N_d4
            ...
            for z_c=1:N_bothz
                ...
                ReturnMatrix_d4z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, special_n_bothz, d3_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, ReturnFnParamsVec, 1);
                ...
                ReturnMatrix_ii_z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, special_n_bothz, d3_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, ReturnFnParamsVec, 2);
    ...
    Policy(5,:,:,N_j)=reshape(a2part,[1,N_a,N_bothz]);
    ...
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, n_bothz, d3_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, bothz_gridvals, ReturnFnParamsVec, 1);
    ...
    elseif vfoptions.lowmemory==1
        for d4_c=1:N_d4
            ...
            for z_c=1:N_z
                ...
                ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, [n_semiz,ones(1,length(n_z))], d3_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_valblock, ReturnFnParamsVec, 1);

                entireRHS=ReturnMatrix_d4+DiscountedEVblock;
                ...
                Policy_ford4_jj(:,semizblock,d4_c)=shiftdim(d_ind,1)+N_d3*(shiftdim(mid_at,1)-1)+N_d3*N_a1*(shiftdim(maxindexL2a2,1)-1)+N_d3*N_a1*N_a2*(shiftdim(maxindexL2a1,1)-1);
                d3opt=d_ind; % no d1 to strip
                a1opt_mid=midpoint(allind);
    ...
    elseif vfoptions.lowmemory>=2 % lm2 already does the most-looped variant, so it also serves the higher lowmemory values
        ...
        for d4_c=1:N_d4
            ...
            for z_c=1:N_bothz
                ...
                midpoint=max(min(maxindex,N_a1-1),2);
                a1primeindexesfine=(midpoint+(midpoint-1)*n2short)+(-n2short-1:1:1+n2short);
                ReturnMatrix_ii_z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, special_n_bothz, d3_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, ReturnFnParamsVec, 3);
...
for reverse_j=1:N_j-1
    ...
    Policy(5,:,:,jj)=reshape(a2part,[1,N_a,N_bothz]);
