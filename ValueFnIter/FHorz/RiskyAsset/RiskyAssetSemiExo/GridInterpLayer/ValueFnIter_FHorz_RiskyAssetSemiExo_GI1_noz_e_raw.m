...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc_e(ReturnFn, n_d1,n_d3,n_a1,n_a1,n_a2,n_semiz,n_e, d13_with_d4, a1_gridvals, a1_gridvals, a2_gridvals, semiz_gridvals_J(:,:,N_j), e_gridvals_J(:,:,N_j), ReturnFnParamsVec,1,0);
            ...
            ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_e(ReturnFn, n_d1,n_d3,n2long,n_a1,n_a2,n_semiz,n_e, d13_with_d4, a1prime_grid(a1primeindexesfine), a1_gridvals, a2_gridvals, semiz_gridvals_J(:,:,N_j), e_gridvals_J(:,:,N_j), ReturnFnParamsVec,2,0);
    ...
    elseif vfoptions.lowmemory==1
        for d4_c=1:N_d4
            ...
            for e_c=1:N_e
                ...
                ReturnMatrix_d4e=CreateReturnFnMatrix_ExpAsset_Disc_e(ReturnFn, n_d1,n_d3,n_a1,n_a1,n_a2,n_semiz,special_n_e, d13_with_d4, a1_gridvals, a1_gridvals, a2_gridvals, semiz_gridvals_J(:,:,N_j), e_val, ReturnFnParamsVec,1,0);
                ...
                ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_e(ReturnFn, n_d1,n_d3,n2long,n_a1,n_a2,n_semiz,special_n_e, d13_with_d4, a1prime_grid(a1primeindexesfine), a1_gridvals, a2_gridvals, semiz_gridvals_J(:,:,N_j), e_val, ReturnFnParamsVec,2,0);
                [Vtempii,maxindexL2]=max(ReturnMatrix_ii,[],1);
    ...
    elseif vfoptions.lowmemory==2
        for d4_c=1:N_d4
            ...
            for z_c=1:N_semiz
                ...
                for e_c=1:N_e
                    e_val=e_gridvals_J(e_c,:,N_j);
                    ReturnMatrix_ze=CreateReturnFnMatrix_ExpAsset_Disc_e(ReturnFn, n_d1,n_d3,n_a1,n_a1,n_a2,special_n_semiz,special_n_e, d13_with_d4, a1_gridvals, a1_gridvals, a2_gridvals, z_val, e_val, ReturnFnParamsVec,1,0);
                    ...
                    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_e(ReturnFn, n_d1,n_d3,n2long,n_a1,n_a2,special_n_semiz,special_n_e, d13_with_d4, a1prime_grid(a1primeindexesfine), a1_gridvals, a2_gridvals, z_val, e_val, ReturnFnParamsVec,2,0);
                    [Vtempii,maxindexL2]=max(ReturnMatrix_ii,[],1);
    ...
    [V(:,:,:,N_j),Policy(:,:,:,N_j),~]=combine_across_d4_e(V_ford4_jj,Policy_ford4_jj,d2index_ford4_jj,flag_ford4_jj,N_a,N_semiz,N_e,N_d4,N_d1,N_d2,N_d3,N_d13,N_d,N_a1,n2short);
else
    ...
    [V(:,:,:,N_j),Policy(:,:,:,N_j)]=internal_per_j_noz_e(EVpre,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d1,n_d3,n_a1,n_a2,n_semiz,n_e,N_d1,N_d2,N_d3,N_d4,N_d13,N_d23,N_d,N_a1,N_a2,N_a,N_semiz,N_e,N_u,N_a1prime,...
...
for reverse_j=1:N_j-1
    ...
    [V(:,:,:,jj),Policy(:,:,:,jj)]=internal_per_j_noz_e(EVnext,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d1,n_d3,n_a1,n_a2,n_semiz,n_e,N_d1,N_d2,N_d3,N_d4,N_d13,N_d23,N_d,N_a1,N_a2,N_a,N_semiz,N_e,N_u,N_a1prime,...
...
%% Per-period inner (noz, with e)
function [V_jj,Policy_jj]=internal_per_j_noz_e(EVnext,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
    n_d1,n_d3,n_a1,n_a2,n_semiz,n_e,N_d1,N_d2,N_d3,N_d4,N_d13,N_d23,N_d,N_a1,N_a2,N_a,N_semiz_count,N_e_count,N_u,N_a1prime,...
...
if vfoptions.lowmemory==0
    for d4_c=1:N_d4
        ...
        ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc_e(ReturnFn, n_d1,n_d3,n_a1,n_a1,n_a2,n_semiz,n_e, d13_with_d4, a1_gridvals, a1_gridvals, a2_gridvals, semiz_gridvals, e_gridvals, ReturnFnParamsVec,1,0);
        ...
        entireRHS_ii=ReturnMatrix_ii+reshape(DiscountedEVinterp_d13(da1primez(:)),[N_d13*n2long,N_a1*N_a2,N_semiz_count,N_e_count]);
        ...
        zlin=shiftdim(gpuArray(0:N_semiz_count-1),-1);
...
elseif vfoptions.lowmemory>=1
    ...
    for d4_c=1:N_d4
        ...
        for e_c=1:N_e_count
            ...
            ReturnMatrix_e=CreateReturnFnMatrix_ExpAsset_Disc_e(ReturnFn, n_d1,n_d3,n_a1,n_a1,n_a2,n_semiz,special_n_e, d13_with_d4, a1_gridvals, a1_gridvals, a2_gridvals, semiz_gridvals, e_val, ReturnFnParamsVec,1,0);
            ...
            da1primez=(1:1:N_d13)'+N_d13*(a1primeindexesfine-1)+N_d13*N_a1prime*zind;
            entireRHS_ii=ReturnMatrix_ii+reshape(DiscountedEVinterp_d13(da1primez(:)),[N_d13*n2long,N_a1*N_a2,N_semiz_count]);
            [Vtempii,maxindexL2]=max(entireRHS_ii,[],1);
            V_ford4_jj(:,:,e_c,d4_c)=shiftdim(Vtempii,1);
            d_ind=rem(maxindexL2-1,N_d13)+1;
            allind=d_ind+N_d13*aind+N_d13*N_a*zindB;
...
[V_jj,Policy_jj,~]=combine_across_d4_e(V_ford4_jj,Policy_ford4_jj,d2index_ford4_jj,flag_ford4_jj,N_a,N_semiz_count,N_e_count,N_d4,N_d1,N_d2,N_d3,N_d13,N_d,N_a1,n2short);
