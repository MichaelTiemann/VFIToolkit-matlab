...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            DiscountedEV=DiscountFactorParamsVec*reshape(EV_onlyd3,[N_d3,N_a1,1,1,N_bothz]); % [N_d3,N_a1,1,1,N_bothz]
    ...
    elseif vfoptions.lowmemory==1
        for d4_c=1:N_d4
            ...
            for z_c=1:N_z
                ...
                entireRHS=ReturnMatrix_d4+DiscountedEV_d13block; % broadcast a2
                ...
                entireRHS_ii=ReturnMatrix_ii+reshape(DiscountedEVinterp_d13block(da1primez(:)),[N_d13*n2long,N_a1*N_a2,N_semiz]);
                [Vtempii,maxindexL2]=max(entireRHS_ii,[],1);
