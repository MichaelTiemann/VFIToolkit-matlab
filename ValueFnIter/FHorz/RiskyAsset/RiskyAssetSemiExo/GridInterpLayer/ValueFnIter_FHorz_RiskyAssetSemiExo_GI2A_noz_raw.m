...
Policy=zeros(8,N_a,N_semiz,N_j,'gpuArray'); % (d1,d2,d3,d4,a1prime_low,a2prime,L2,L2flag)
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, d13_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_gridvals_J(:,:,N_j), ReturnFnParamsVec, 1);
            % [N_d13, N_a1prime, N_a2prime, N_a1, N_a2, N_a3, N_semiz]
            ...
            ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_gridvals_J(:,:,N_j), ReturnFnParamsVec, 2);
    ...
    elseif vfoptions.lowmemory>=1
        for d4_c=1:N_d4
            ...
            for z_c=1:N_semiz
                ...
                ReturnMatrix_d4z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_semiz, d13_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, ReturnFnParamsVec, 1);
                ...
                ReturnMatrix_ii_z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_semiz, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, ReturnFnParamsVec, 2);
    ...
    Policy(6,:,:,N_j)=reshape(a2part,[1,N_a,N_semiz]);
    Policy(7,:,:,N_j)=reshape(L2ind,[1,N_a,N_semiz]);
    Policy(8,:,:,N_j)=reshape(flagwinner,[1,N_a,N_semiz]);
else
    ...
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            DiscountedEV_d13=repelem(DiscountedEV,N_d1,1);             % [N_d13,N_a1,N_a2,1,1,1,N_semiz]
            DiscountedEVinterp_d13=repelem(DiscountedEVinterp,N_d1,1); % [N_d13,N_a1fine,N_a2,1,1,1,N_semiz]

            ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, d13_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_gridvals, ReturnFnParamsVec, 1);
    ...
    elseif vfoptions.lowmemory>=1
        ...
        for d4_c=1:N_d4
            ...
            for z_c=1:N_semiz
                ...
                midpoint=max(min(maxindex,N_a1-1),2);
                a1primeindexesfine=(midpoint+(midpoint-1)*n2short)+(-n2short-1:1:1+n2short);
                ReturnMatrix_ii_z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_semiz, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, ReturnFnParamsVec, 3);
...
for reverse_j=1:N_j-1
    ...
    Policy(6,:,:,jj)=reshape(a2part,[1,N_a,N_semiz]);
    Policy(7,:,:,jj)=reshape(L2ind,[1,N_a,N_semiz]);
    Policy(8,:,:,jj)=reshape(flagwinner,[1,N_a,N_semiz]);
end
