...
Policy=zeros(8,N_a,N_bothz,N_e,N_j,'gpuArray'); % (d1,d2,d3,d4,a1prime_low,a2prime,L2,L2flag)
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_bothz, n_e, d13_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, bothz_gridvals_J(:,:,N_j), e_gridvals_J(:,:,N_j), ReturnFnParamsVec, 1);
            % [N_d13, N_a1prime, N_a2prime, N_a1, N_a2, N_a3, N_bothz, N_e]
            ...
            ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_bothz, n_e, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, bothz_gridvals_J(:,:,N_j), e_gridvals_J(:,:,N_j), ReturnFnParamsVec, 2);
            % [N_d13*n2long*N_a2, N_a, N_bothz, N_e]
    ...
    elseif vfoptions.lowmemory==1
        for d4_c=1:N_d4
            ...
            for e_c=1:N_e
                ...
                ReturnMatrix_d4e=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_bothz, special_n_e, d13_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, bothz_gridvals_J(:,:,N_j), e_val, ReturnFnParamsVec, 1);
                ...
                ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_bothz, special_n_e, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, bothz_gridvals_J(:,:,N_j), e_val, ReturnFnParamsVec, 2);
    ...
    elseif vfoptions.lowmemory==2
        for d4_c=1:N_d4
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    e_val=e_gridvals_J(e_c,:,N_j);
                    ReturnMatrix_d4e=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, [n_semiz,ones(1,length(n_z))], special_n_e, d13_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_valblock, e_val, ReturnFnParamsVec, 1);
                    [~,maxindex_d4e]=max(ReturnMatrix_d4e,[],2);

                    midpoint_d4e=max(min(maxindex_d4e,N_a1-1),2);
                    a1primeindexesfine=(midpoint_d4e+(midpoint_d4e-1)*n2short)+(-n2short-1:1:1+n2short);
                    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, [n_semiz,ones(1,length(n_z))], special_n_e, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_valblock, e_val, ReturnFnParamsVec, 2);
                    ...
                    Policy_ford4_jj(:,semizblock,e_c,d4_c)=shiftdim(d_ind,1)+N_d13*(shiftdim(mid_at,1)-1)+N_d13*N_a1*(shiftdim(maxindexL2a2,1)-1)+N_d13*N_a1*N_a2*(shiftdim(maxindexL2a1,1)-1);
    ...
    elseif vfoptions.lowmemory==3
        for d4_c=1:N_d4
            ...
            for z_c=1:N_bothz
                ...
                for e_c=1:N_e
                    e_val=e_gridvals_J(e_c,:,N_j);
                    ReturnMatrix_ze=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_bothz, special_n_e, d13_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 1);
                    ...
                    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_bothz, special_n_e, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 2);
    ...
    Policy(6,:,:,:,N_j)=reshape(a2part,[1,N_a,N_bothz,N_e]);
    Policy(7,:,:,:,N_j)=reshape(L2ind,[1,N_a,N_bothz,N_e]);
    Policy(8,:,:,:,N_j)=reshape(flagwinner,[1,N_a,N_bothz,N_e]);
else
    ...
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_bothz, n_e, d13_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, bothz_gridvals, e_gridvals, ReturnFnParamsVec, 1);

            entireRHS=ReturnMatrix_d4+DiscountedEV_d13; % broadcast a3,e
            ...
            entireRHS_ii=reshape(ReturnMatrix_ii+DiscountedEVinterp_d13(aprime),[N_d13*n2long*N_a2,N_a,N_bothz,N_e]);
    ...
    elseif vfoptions.lowmemory==1
        ...
        for d4_c=1:N_d4
            ...
            for e_c=1:N_e
                ...
                ReturnMatrix_e=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, n_bothz, special_n_e, d13_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, bothz_gridvals, e_val, ReturnFnParamsVec, 1);
    ...
    elseif vfoptions.lowmemory==2
        for d4_c=1:N_d4
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    e_val=e_gridvals(e_c,:);
                    ReturnMatrix_e=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, [n_semiz,ones(1,length(n_z))], special_n_e, d13_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_valblock, e_val, ReturnFnParamsVec, 1);
                    entireRHS_e=ReturnMatrix_e+DiscountedEV_d13block;
                    [~,maxindex]=max(entireRHS_e,[],2);
    ...
    elseif vfoptions.lowmemory==3
        for d4_c=1:N_d4
            ...
            for z_c=1:N_bothz
                ...
                DiscountedEV_d13_z=DiscountedEV_d13(:,:,:,:,:,:,z_c);
                DiscountedEVinterp_d13_z=DiscountedEVinterp_d13(:,:,:,:,:,:,z_c);
                d2index_resh_z=d2index_resh(:,:,:,z_c);
                for e_c=1:N_e
                    e_val=e_gridvals(e_c,:);
                    ReturnMatrix_ze=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_bothz, special_n_e, d13_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 1);
                    entireRHS_ze=ReturnMatrix_ze+DiscountedEV_d13_z;
                    [~,maxindex]=max(entireRHS_ze,[],2);

                    midpoint=max(min(maxindex,N_a1-1),2);
                    a1primeindexesfine=(midpoint+(midpoint-1)*n2short)+(-n2short-1:1:1+n2short);
                    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, n_d1,[n_d3,special_n_d4], n_a2, n_a3, special_n_bothz, special_n_e, d13_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 3);
                    aprime=(1:1:N_d13)' + N_d13*(a1primeindexesfine-1) + N_d13*N_a1fine*shiftdim((0:1:N_a2-1),-1);
                    entireRHS_ii=reshape(ReturnMatrix_ii+DiscountedEVinterp_d13_z(aprime),[N_d13*n2long*N_a2,N_a]);
                    [Vtempii,maxindexL2]=max(entireRHS_ii,[],1);
                    V_ford4_jj(:,z_c,e_c,d4_c)=shiftdim(Vtempii,1);
                    d_ind       =rem(maxindexL2-1,N_d13)+1;
                    maxindexL2a1=rem(floor((maxindexL2-1)/N_d13),n2long)+1;
...
for reverse_j=1:N_j-1
    ...
    Policy(6,:,:,:,jj)=reshape(a2part,[1,N_a,N_bothz,N_e]);
    Policy(7,:,:,:,jj)=reshape(L2ind,[1,N_a,N_bothz,N_e]);
    Policy(8,:,:,:,jj)=reshape(flagwinner,[1,N_a,N_bothz,N_e]);
end
