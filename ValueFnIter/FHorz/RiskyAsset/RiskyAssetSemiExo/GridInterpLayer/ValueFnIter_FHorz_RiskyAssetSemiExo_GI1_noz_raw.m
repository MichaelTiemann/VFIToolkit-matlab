...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc(ReturnFn, n_d1,n_d3,n_a1,n_a1,n_a2,n_semiz, d13_with_d4, a1_gridvals, a1_gridvals, a2_gridvals, semiz_gridvals_J(:,:,N_j), ReturnFnParamsVec,1,0);
            ...
            ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc(ReturnFn, n_d1,n_d3,n2long,n_a1,n_a2,n_semiz, d13_with_d4, a1prime_grid(a1primeindexesfine), a1_gridvals, a2_gridvals, semiz_gridvals_J(:,:,N_j), ReturnFnParamsVec,2,0);
    ...
    elseif vfoptions.lowmemory==1
        for d4_c=1:N_d4
            ...
            for z_c=1:N_semiz
                ...
                ReturnMatrix_d4z=CreateReturnFnMatrix_ExpAsset_Disc(ReturnFn, n_d1,n_d3,n_a1,n_a1,n_a2,special_n_semiz, d13_with_d4, a1_gridvals, a1_gridvals, a2_gridvals, z_val, ReturnFnParamsVec,1,0);
                ...
                ReturnMatrix_ii_z=CreateReturnFnMatrix_ExpAsset_Disc(ReturnFn, n_d1,n_d3,n2long,n_a1,n_a2,special_n_semiz, d13_with_d4, a1prime_grid(a1primeindexesfine), a1_gridvals, a2_gridvals, z_val, ReturnFnParamsVec,2,0);
    ...
    [V(:,:,N_j),Policy(:,:,N_j),~]=combine_across_d4(V_ford4_jj,Policy_ford4_jj,d2index_ford4_jj,flag_ford4_jj,N_a,N_semiz,N_d4,N_d1,N_d2,N_d3,N_d13,N_d,N_a1,n2short);
else
    ...
    [V(:,:,N_j),Policy(:,:,N_j)]=internal_per_j(EVpre,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d1,n_d3,n_a1,n_a2,n_semiz,N_d1,N_d2,N_d3,N_d4,N_d13,N_d23,N_d,N_a1,N_a2,N_a,N_semiz,N_u,N_a1prime,...
...
function [V_jj,Policy_jj]=internal_per_j(EVnext,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
    n_d1,n_d3,n_a1,n_a2,n_semiz,N_d1,N_d2,N_d3,N_d4,N_d13,N_d23,N_d,N_a1,N_a2,N_a,N_semiz_count,N_u,N_a1prime,...
...
if vfoptions.lowmemory==0
    for d4_c=1:N_d4
        ...
        ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc(ReturnFn, n_d1,n_d3,n_a1,n_a1,n_a2,n_semiz, d13_with_d4, a1_gridvals, a1_gridvals, a2_gridvals, semiz_gridvals, ReturnFnParamsVec,1,0);
...
[V_jj,Policy_jj,~]=combine_across_d4(V_ford4_jj,Policy_ford4_jj,d2index_ford4_jj,flag_ford4_jj,N_a,N_semiz_count,N_d4,N_d1,N_d2,N_d3,N_d13,N_d,N_a1,n2short);

end


%% Cross-d4 max + final encoding (same as GI1_raw)
