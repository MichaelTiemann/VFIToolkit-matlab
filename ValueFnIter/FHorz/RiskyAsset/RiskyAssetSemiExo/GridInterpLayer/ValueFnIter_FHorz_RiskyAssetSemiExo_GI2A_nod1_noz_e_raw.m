function [V,Policy]=ValueFnIter_FHorz_RiskyAssetSemiExo_GI2A_nod1_noz_e_raw(n_d2,n_d3,n_d4,n_a1,n_a2,n_a3,n_semiz,n_e,n_u,N_j, d2_grid, d3_grid, d4_grid, a1_grid, a2_grid, a3_grid, semiz_gridvals_J, e_gridvals_J, u_grid, pi_semiz_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
% Two standard endogenous assets version of ValueFnIter_FHorz_RiskyAssetSemiExo_GI1_nod1_noz_e_raw.
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, n_e, d3_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_gridvals_J(:,:,N_j), e_gridvals_J(:,:,N_j), ReturnFnParamsVec, 1);
            % [N_d3, N_a1prime, N_a2prime, N_a1, N_a2, N_a3, N_semiz, N_e]
            ...
            ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, n_e, d3_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_gridvals_J(:,:,N_j), e_gridvals_J(:,:,N_j), ReturnFnParamsVec, 2);
            % [N_d3*n2long*N_a2, N_a, N_semiz, N_e]
    ...
    elseif vfoptions.lowmemory==1
        for d4_c=1:N_d4
            ...
            for e_c=1:N_e
                ...
                ReturnMatrix_d4e=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, special_n_e, d3_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_gridvals_J(:,:,N_j), e_val, ReturnFnParamsVec, 1);
                ...
                ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, special_n_e, d3_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_gridvals_J(:,:,N_j), e_val, ReturnFnParamsVec, 2);
    ...
    elseif vfoptions.lowmemory>=2
        for d4_c=1:N_d4
            ...
            for z_c=1:N_semiz
                ...
                for e_c=1:N_e
                    e_val=e_gridvals_J(e_c,:,N_j);
                    ReturnMatrix_ze=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, special_n_semiz, special_n_e, d3_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 1);
                    ...
                    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, special_n_semiz, special_n_e, d3_with_d4, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 2);
    ...
    Policy(5,:,:,:,N_j)=reshape(a2part,[1,N_a,N_semiz,N_e]);
    ...
    %% Inlined per-period inner (no d1, no z, with e)
    EVnext=EVpre;
    ...
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            ReturnMatrix_d4=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, n_e, d3_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_gridvals, e_gridvals, ReturnFnParamsVec, 1);
            ...
            entireRHS_ii=reshape(ReturnMatrix_ii+DiscountedEVinterp(aprime),[N_d3*n2long*N_a2,N_a,N_semiz,N_e]);
    ...
    elseif vfoptions.lowmemory>=1
        ...
        for d4_c=1:N_d4
            ...
            for e_c=1:N_e
                ...
                ReturnMatrix_e=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0,[n_d3,special_n_d4], n_a2, n_a3, n_semiz, special_n_e, d3_with_d4, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, semiz_gridvals, e_val, ReturnFnParamsVec, 1);
...
for reverse_j=1:N_j-1
    ...
    Policy(5,:,:,:,jj)=reshape(a2part,[1,N_a,N_semiz,N_e]);
