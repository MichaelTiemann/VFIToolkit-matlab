function [V,Policy]=ValueFnIter_FHorz_RiskyAssetSemiExo_nod1_e_raw(n_d2,n_d3,n_d4,n_a1,n_a2,n_semiz,n_z,n_e,n_u,N_j, d2_grid, d3_grid, d4_grid, a1_grid, a2_grid, semiz_gridvals_J, z_gridvals_J, e_gridvals_J, u_grid, pi_semiz_J, pi_z_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
        ...
        for d4_c=1:N_d4
            ...
            for z_c=1:N_z % outer loop over z (markov)
                ...
                for e_c=1:N_e % inner loop over e
                    ...
                    entireRHS_ze=ReturnMatrix_d4ze+DiscountedEV_onlyd3(:,:,semizblock);
        ...
        for d4_c=1:N_d4
            ...
            for z_c=1:N_bothz % outer loop over bothz
                ...
                for e_c=1:N_e % inner loop over e
                    ...
                    entireRHS_ze=ReturnMatrix_d4ze+DiscountedEV_onlyd3(:,:,z_c);
                    [Vtemp,maxindex]=max(entireRHS_ze,[],1);
