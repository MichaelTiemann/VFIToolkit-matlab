function [V,Policy]=ValueFnIter_FHorz_RiskyAssetSemiExo_noa1_noz_e_raw(n_d1,n_d2,n_d3,n_d4,n_a,n_semiz,n_e,n_u,N_j, d1_grid, d2_grid, d3_grid, d4_grid, a_grid, semiz_gridvals_J, e_gridvals_J, u_grid, pi_semiz_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
Policy=zeros(4,N_a,N_semiz,N_e,N_j,vfoptions.indexT,'gpuArray'); % (d1,d2,d3,d4)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            [ReturnMatrix_onlyd3,d1index]=max(reshape(ReturnMatrix_d4,[N_d1,N_d3,N_a,N_semiz,N_e]),[],1);
            [EV_onlyd3,d2index]=max(reshape(EV,[N_d2,N_d3,1,N_semiz,1]),[],1);
    ...
    elseif vfoptions.lowmemory==1
        for d4_c=1:N_d4
            ...
            for e_c=1:N_e
                ...
                [ReturnMatrix_onlyd3,d1index]=max(reshape(ReturnMatrix_d4e,[N_d1,N_d3,N_a,N_semiz]),[],1);
