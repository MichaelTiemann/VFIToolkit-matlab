...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d4_c=1:N_d4
            ...
            [ReturnMatrix_onlyd3,d1index]=max(reshape(ReturnMatrix_d4,[N_d1,N_d3*N_a1,N_a,N_semiz,N_e]),[],1);
            [EV_onlyd3,d2index]=max(reshape(EV,[N_d2,N_d3*N_a1,1,N_semiz,1]),[],1);
    ...
    elseif vfoptions.lowmemory>=1 % terminal lm1 already does the most-looped variant, so it also serves the higher lowmemory values
        for d4_c=1:N_d4
            ...
            for e_c=1:N_e
                ...
                [ReturnMatrix_onlyd3,d1index]=max(reshape(ReturnMatrix_d4e,[N_d1,N_d3*N_a1,N_a,N_semiz]),[],1);
        ...
        for d4_c=1:N_d4
            ...
            for z_c=1:N_semiz % outer loop over semiz
                ...
                for e_c=1:N_e % inner loop over e
                    ...
                    [ReturnMatrix_onlyd3,d1index]=max(reshape(ReturnMatrix_d4ze,[N_d1,N_d3*N_a1,N_a]),[],1);
