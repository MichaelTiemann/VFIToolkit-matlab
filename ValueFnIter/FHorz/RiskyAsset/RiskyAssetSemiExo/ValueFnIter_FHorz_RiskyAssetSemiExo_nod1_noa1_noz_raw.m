function [V,Policy]=ValueFnIter_FHorz_RiskyAssetSemiExo_nod1_noa1_noz_raw(n_d2,n_d3,n_d4,n_a,n_semiz,n_u,N_j, d2_grid, d3_grid, d4_grid, a_grid, semiz_gridvals_J, u_grid, pi_semiz_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
Policy=zeros(3,N_a,N_semiz,N_j,vfoptions.indexT,'gpuArray'); % d2, d3, d4
