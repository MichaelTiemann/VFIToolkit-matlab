function [V,Policy]=ValueFnIter_FHorz_RiskyAsset_GI2A_noz_raw(n_d1,n_d2,n_d3,n_a1,n_a2,n_a3,n_u,N_j, d1_grid, d2_grid, d3_grid, a1_grid, a2_grid, a3_grid, u_grid, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
% Two standard endogenous assets version of ValueFnIter_FHorz_RiskyAsset_GI1_noz_raw.
...
Policy=zeros(6,N_a,N_j,'gpuArray'); % (1)=d1, (2)=d2, (3)=d3, (4)=a1prime midpoint, (5)=a2prime, (6)=L2ind
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    ReturnMatrix=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_noz(ReturnFn, n_d1, n_d3, n_a2, n_a3, d13_gridvals, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, ReturnFnParamsVec, 1);
    % [N_d13, N_a1prime, N_a2prime, N_a1, N_a2, N_a3]
    ...
    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_noz(ReturnFn, n_d1, n_d3, n_a2, n_a3, d13_gridvals, a1prime_grid(a1primeindexes), a2_gridvals, a1_grid, a2_gridvals, a3_grid, ReturnFnParamsVec, 2);
    ...
    % DiscountedEV: (d3,a1prime,a2prime), broadcast against the (a1,a2,a3) dims of ReturnMatrix
