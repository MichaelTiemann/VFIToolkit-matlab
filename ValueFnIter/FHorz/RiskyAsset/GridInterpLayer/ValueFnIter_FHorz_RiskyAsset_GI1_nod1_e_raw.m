function [V,Policy]=ValueFnIter_FHorz_RiskyAsset_GI1_nod1_e_raw(n_d2,n_d3,n_a1,n_a2,n_z,n_e,n_u,N_j, d2_grid, d3_grid, a1_grid, a2_grid, z_gridvals_J, e_gridvals_J, u_grid, pi_z_J, pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
Policy=zeros(4,N_a,N_z,N_e,N_j,vfoptions.indexT,'gpuArray'); % (1)=d2, (2)=d3, (3)=midpoint, (4)=L2ind
...
adjust=cast2index(Policy(4,:,:,:,:)<1+n2short+1);                                                  % L2ind strictly < n2short+2
