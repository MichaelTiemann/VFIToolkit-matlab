function [V,Policy]=ValueFnIter_FHorz_RiskyAsset_GI2A_nod1_noz_raw(n_d2,n_d3,n_a1,n_a2,n_a3,n_u,N_j, d2_grid, d3_grid, a1_grid, a2_grid, a3_grid, u_grid, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
% Two standard endogenous assets version of ValueFnIter_FHorz_RiskyAsset_GI1_nod1_noz_raw.
...
Policy=zeros(5,N_a,N_j,'gpuArray'); % (1)=d2, (2)=d3, (3)=a1prime midpoint, (4)=a2prime, (5)=L2ind
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    ReturnMatrix=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_noz(ReturnFn, 0, n_d3, n_a2, n_a3, d3_gridvals, a1_grid, a2_gridvals, a1_grid, a2_gridvals, a3_grid, ReturnFnParamsVec, 1);
    % [N_d3, N_a1prime, N_a2prime, N_a1, N_a2, N_a3]
    ...
    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_noz(ReturnFn, 0, n_d3, n_a2, n_a3, d3_gridvals, a1prime_grid(a1primeindexes), a2_gridvals, a1_grid, a2_gridvals, a3_grid, ReturnFnParamsVec, 2);
    ...
    % Interpolate EV over a1prime_grid (dim 2 after the permute)
