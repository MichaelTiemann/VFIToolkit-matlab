...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==4
        for ea_c=1:N_a2
            ...
            ReturnMatrix_ea=CreateReturnFnMatrix_ExpAsset_Disc(ReturnFn, 0, n_d2, n_a1, n_a1,special_n_ea, n_z, d2_gridvals, a1_gridvals, a1_gridvals, ea_val, z_gridvals_J(:,:,N_j), ReturnFnParamsVec,0,0); % Level=0, Refine=0
    ...
    elseif vfoptions.lowmemory==4
        for ea_c=1:N_a2
            ...
            entireRHS_ea=ReturnMatrix_ea+DiscountFactorParamsVec*repelem(EV(:,ea_c,:),1,N_a1);
...
for reverse_j=1:N_j-1
    ...
    elseif vfoptions.lowmemory==4
        for ea_c=1:N_a2
            ...
            ea_val=a2_gridvals(ea_c);
            ReturnMatrix_ea=CreateReturnFnMatrix_ExpAsset_Disc(ReturnFn, 0,n_d2, n_a1, n_a1,special_n_ea, n_z, d2_gridvals, a1_gridvals, a1_gridvals, ea_val, z_gridvals_J(:,:,jj), ReturnFnParamsVec,0,0); % Level=0, Refine=0
