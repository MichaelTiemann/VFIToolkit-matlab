function [V,Policy]=ValueFnIter_FHorz_ExpAssetz_GI2A_nod1_raw(n_d2, n_a1, n_a2, n_a3, n_z, N_j, d2_gridvals, a1_grid, a2_gridvals, a3_grid, z_gridvals_J, pi_z_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
% _z analog of ValueFnIter_FHorz_ExpAsset_GI2A_nod1_raw: aprimeFn depends on z.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    EV(isnan(EV))=0;
    EV=squeeze(sum(EV,4)); % (d2*a1prime*a2prime, a3, z)
...
adjust=cast2index(Policy(4,:,:,:)<1+n2short+1); % is the L2 index below midpoint?
