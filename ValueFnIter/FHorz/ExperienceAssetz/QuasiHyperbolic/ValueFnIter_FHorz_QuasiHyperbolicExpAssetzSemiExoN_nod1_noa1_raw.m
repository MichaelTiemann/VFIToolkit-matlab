...
Policyalt=zeros(2,N_a,N_bothz,N_j,'gpuArray');
Policy=zeros(2,N_a,N_bothz,N_j,'gpuArray');
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1 % split: loop z (markov), vectorize semiz
        for z_c=1:N_z
            ...
            ReturnMatrix_z=CreateReturnFnMatrix_Case2_Disc(ReturnFn, n_d23, n_a2, [n_semiz,ones(1,length(n_z))], d23_gridvals, a2_grid, z_valblock, ReturnFnParamsVec);
    ...
    elseif vfoptions.lowmemory==1 % split: loop z (markov), vectorize semiz
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                semizblock=(z_c-1)*N_semiz+(1:1:N_semiz);
                z_valblock=bothz_gridvals_J(semizblock,:,N_j);
                ReturnMatrix_d3z=CreateReturnFnMatrix_Case2_Disc(ReturnFn, [n_d2,1], n_a2, [n_semiz,ones(1,length(n_z))], d23_gridvals_val, a2_grid, z_valblock, ReturnFnParamsVec);
