...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            Policy(3,:,:,e_c,N_j)=ceil(d_ind/N_d12);
            Policy(4,:,:,e_c,N_j)=ceil(maxindex/N_d);
        end
    elseif vfoptions.lowmemory==2 % split: vectorize semiz, outer loop z, inner loop e
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                Policy(3,:,semizblock,e_c,N_j)=ceil(d_ind/N_d12);
                Policy(4,:,semizblock,e_c,N_j)=ceil(maxindex/N_d);
            end
        end
    elseif vfoptions.lowmemory==3 % joint loop over bothz (outer), inner loop e
        for z_c=1:N_bothz
            ...
            for e_c=1:N_e
                ...
                Policy(3,:,z_c,e_c,N_j)=ceil(d_ind/N_d12);
                Policy(4,:,z_c,e_c,N_j)=ceil(maxindex/N_d);
            end
        end
    end
