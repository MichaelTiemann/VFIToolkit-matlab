...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        error('lowmem=1 for QH+ExpAssetz N DC2A_GI2A V_Jplus1 init not yet implemented; use lowmem=0 for terminal')
    elseif vfoptions.lowmemory==2
        error('lowmem=2 for QH+ExpAssetz N DC2A_GI2A V_Jplus1 init not yet implemented; use lowmem=0 for terminal')
    end
end
