...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            entireRHS_hat_e_flat=reshape(entireRHS_hat_e,[N_d2*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,N_z,1]);
            [Vtempii_hat,maxindex2]=max(entireRHS_hat_e_flat,[],1);
            entireRHS_under_e=ReturnMatrix_ii_e+DiscountedEV_under;
            entireRHS_under_e_flat=reshape(entireRHS_under_e,[N_d2*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,N_z,1]);
            M=vfoptions.level1n*N_a2*N_a3;
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                entireRHS_hat_ze_flat=reshape(entireRHS_hat_ze,[N_d2*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3]);
                [Vtempii_hat,maxindex2]=max(entireRHS_hat_ze_flat,[],1);
                entireRHS_under_ze=ReturnMatrix_ii_ze+DiscountedEV_under_ze;
                entireRHS_under_ze_flat=reshape(entireRHS_under_ze,[N_d2*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3]);
                M=vfoptions.level1n*N_a2*N_a3;
