...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for z_c=1:N_z
            ...
            entireRHS_hat_z_flat=reshape(entireRHS_hat_z,[N_d2*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,1,N_e]);
            [Vtempii_hat,maxindex2]=max(entireRHS_hat_z_flat,[],1);
            entireRHS_under_z=ReturnMatrix_ii_z+DiscountedEV_under_z;
            entireRHS_under_z_flat=reshape(entireRHS_under_z,[N_d2*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,1,N_e]);
            M=vfoptions.level1n*N_a2*N_a3;
