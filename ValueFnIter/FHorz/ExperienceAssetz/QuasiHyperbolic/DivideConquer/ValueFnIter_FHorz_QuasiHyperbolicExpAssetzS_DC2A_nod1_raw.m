function [Vhat,Policy,Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetzS_DC2A_nod1_raw(n_d2, n_a1, n_a2, n_a3, n_z, N_j, d2_gridvals, a1_grid, a2_gridvals, a3_grid, z_gridvals_J, pi_z_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for z_c=1:N_z
            ...
            entireRHS_hat_z_flat=reshape(entireRHS_hat_z,[N_d2*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3]);
            [Vtempii_hat,maxindex2]=max(entireRHS_hat_z_flat,[],1);
            entireRHS_under_z=ReturnMatrix_ii_z+DiscountedEV_under_z;
            entireRHS_under_z_flat=reshape(entireRHS_under_z,[N_d2*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3]);
            M=vfoptions.level1n*N_a2*N_a3;
