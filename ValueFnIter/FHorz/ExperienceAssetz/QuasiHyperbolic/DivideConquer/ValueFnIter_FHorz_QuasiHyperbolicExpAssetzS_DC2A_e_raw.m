...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for z_c=1:N_z
            ...
            entireRHS_hat_z_flat=reshape(entireRHS_hat_z,[N_d*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,1,N_e]);
            ...
            entireRHS_under_z_flat=reshape(entireRHS_under_z,[N_d*N_a1*N_a2,vfoptions.level1n*N_a2*N_a3,1,N_e]);
            M=vfoptions.level1n*N_a2*N_a3;
            maxindexfull=maxindex2 + (N_d*N_a1*N_a2)*(0:M-1) + (N_d*N_a1*N_a2)*M*shiftdim((0:N_e-1),-2);
