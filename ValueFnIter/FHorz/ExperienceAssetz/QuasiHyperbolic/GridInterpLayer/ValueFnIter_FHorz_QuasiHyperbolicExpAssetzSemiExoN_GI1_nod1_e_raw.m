function [Vtilde,Policy,Valt,Policyalt]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetzSemiExoN_GI1_nod1_e_raw(n_d2,n_d3,n_a1,n_a2,n_z,n_semiz,n_e,N_j, d2_gridvals, d3_grid, a1_gridvals, a2_grid, z_gridvals_J, semiz_gridvals_J, e_gridvals_J, pi_z_J, pi_semiz_J, pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            Policy3_ford3_alt(2,:,:,:,d3_c)=shiftdim(squeeze(midpoint_alt(d_ind+N_d2*aind+N_d2*N_a*bothzBind+N_d2*N_a*N_bothz*eind)),-1);
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            Policy3_ford3_alt(2,:,:,:,d3_c)=shiftdim(squeeze(midpoint_alt(d_ind_alt+N_d2*aind+N_d2*N_a*bothzBind+N_d2*N_a*N_bothz*eind)),-1);
            Policy3_ford3_alt(3,:,:,:,d3_c)=shiftdim(ceil(maxindexL2_alt/N_d2),-1);
            L2offset_alt=ceil(maxindexL2_alt/N_d2);
            linidx_lower_alt=d_ind_alt+N_d2*n2long*aind+N_d2*n2long*N_a*bothzBind+N_d2*n2long*N_a*N_bothz*eind;
            linidx_upper_alt=d_ind_alt+N_d2*(n2long-1)+N_d2*n2long*aind+N_d2*n2long*N_a*bothzBind+N_d2*n2long*N_a*N_bothz*eind;
            ...
            Policy3_ford3_tilde(2,:,:,:,d3_c)=shiftdim(squeeze(midpoint_tilde(d_ind_tilde+N_d2*aind+N_d2*N_a*bothzBind+N_d2*N_a*N_bothz*eind)),-1);
            Policy3_ford3_tilde(3,:,:,:,d3_c)=shiftdim(ceil(maxindexL2_tilde/N_d2),-1);
            L2offset_tilde=ceil(maxindexL2_tilde/N_d2);
            linidx_lower_tilde=d_ind_tilde+N_d2*n2long*aind+N_d2*n2long*N_a*bothzBind+N_d2*n2long*N_a*N_bothz*eind;
            linidx_upper_tilde=d_ind_tilde+N_d2*(n2long-1)+N_d2*n2long*aind+N_d2*n2long*N_a*bothzBind+N_d2*n2long*N_a*N_bothz*eind;
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            % --- alt pass ---
                ...
                d2a1primea2bothz_alt=(1:1:N_d2)'+N_d2*(a1primeindexesfine_alt-1)+N_d2*N_a1prime*a2ind+N_d2*N_a1prime*N_a2*shiftdim((0:N_bothz-1),-3);
            ...
            % --- tilde pass ---
                ...
                d2a1primea2bothz_tilde=(1:1:N_d2)'+N_d2*(a1primeindexesfine_tilde-1)+N_d2*N_a1prime*a2ind+N_d2*N_a1prime*N_a2*shiftdim((0:N_bothz-1),-3);
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                % --- alt pass ---
                    ...
                    entireRHS_d3ze_alt=ReturnMatrix_d3ze+DiscountedEV_alt;
                    ...
                    entireRHS_ii_d3ze_alt=ReturnMatrix_ii_d3ze_alt+reshape(DiscountedEVinterp_alt(d2a1primea2semiz_alt(:)),[N_d2*n2long,N_a1*N_a2,N_semiz]);
                ...
                % --- tilde pass ---
                    ...
                    entireRHS_d3ze_tilde=ReturnMatrix_d3ze+DiscountedEV_tilde;
                    ...
                    entireRHS_ii_d3ze_tilde=ReturnMatrix_ii_d3ze_tilde+reshape(DiscountedEVinterp_tilde(d2a1primea2semiz_tilde(:)),[N_d2*n2long,N_a1*N_a2,N_semiz]);
