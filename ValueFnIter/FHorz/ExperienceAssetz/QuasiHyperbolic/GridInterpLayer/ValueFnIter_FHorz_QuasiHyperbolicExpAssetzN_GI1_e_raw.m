function [Vtilde,Policy,Valt,Policyalt]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetzN_GI1_e_raw(n_d1,n_d2,n_a1,n_a2,n_z,n_e,N_j, d_gridvals, d2_gridvals, a1_gridvals, a2_grid, z_gridvals_J, e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
% Naive quasi-hyperbolic discounting variant of ValueFnIter_FHorz_ExpAssetz_GI1_e_raw.
% ExperienceAssetz with grid interpolation layer on a1. GPU only.
% Note: in this family the experience-asset transition depends on z, aprimeFn(d2,a2,z,...);
% that z dependence sits in a2primeIndex/a2primeProbs and is integrated out together with
% pi_z when EV is formed, upstream of both maximisation passes.
%
