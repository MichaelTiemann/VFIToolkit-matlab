function [Vhat,Policy,Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicExpAssetzS_GI1_nod1_e_raw(n_d2,n_a1,n_a2,n_z,n_e,N_j, d2_gridvals, a1_gridvals, a2_grid, z_gridvals_J, e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
% Sophisticated quasi-hyperbolic discounting variant of ValueFnIter_FHorz_ExpAssetz_GI1_nod1_e_raw.
...
% pi_z when EV is formed, upstream of the maximisation.
%
...
% RHS, so the a2 lottery and the z integration are already baked in and the gather needs
% no lottery handling.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    EV=squeeze(sum(EV,4)); % sum zprime -> (d2*a1prime,a2,z_cur)
