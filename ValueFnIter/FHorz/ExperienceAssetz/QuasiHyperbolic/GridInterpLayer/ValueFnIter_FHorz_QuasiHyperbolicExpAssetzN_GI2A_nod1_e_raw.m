...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            entireRHS_alt_e=ReturnMatrix_e+DiscountedEV_alt;
            ...
            entireRHS_ii_alt_e=reshape(ReturnMatrix_ii_alt_e+DiscountedEVinterp_alt(aprimez_alt_e),[N_d2*n2long*N_a2,N_a,N_z,1]);
            ...
            entireRHS_ii_e=reshape(ReturnMatrix_ii_e+DiscountedEVinterp(aprimez_e),[N_d2*n2long*N_a2,N_a,N_z,1]);
