...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        ...
        for z_c=1:N_z
            ...
            Policy4(1,curraindex,zind,N_j)=d12_ind; % d12 (composite d1,d2)
            Policy4(2,curraindex,zind,N_j)=ceil(dind/N_d12); % d3
            aprimeind=ceil(maxindex2/N_d); % this is the joint (a1prime,a2prime)
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_bothz
            ...
            Policy4(1,curraindex,z_c,N_j)=d12_ind; % d12 (composite d1,d2)
            Policy4(2,curraindex,z_c,N_j)=ceil(dind/N_d12); % d3
            aprimeind=ceil(maxindex2/N_d); % this is the joint (a1prime,a2prime)
