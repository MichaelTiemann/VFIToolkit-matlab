function [V,Policy4]=ValueFnIter_FHorz_ExpAssetzSemiExo_DC2A_nod1_raw(n_d2, n_d3, n_a1, n_a2, n_a3, n_z, n_semiz, N_j, d2_gridvals, d3_grid, a1_grid, a2_gridvals, a3_grid, z_gridvals_J, semiz_gridvals_J, pi_z_J, pi_semiz_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
% Policy4 stores (d2, d3, a1prime, a2prime): a1prime is the divide-conquered standard asset, a2prime the folded standard asset.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        ...
        for z_c=1:N_z
            ...
            Policy4(1,curraindex,zind,N_j)=rem(dind-1,N_d2)+1; % d2
            Policy4(2,curraindex,zind,N_j)=ceil(dind/N_d2); % d3
            aprimeind=ceil(maxindex2/N_d); % this is the joint (a1prime,a2prime)
            Policy4(3,curraindex,zind,N_j)=rem(aprimeind-1,N_a1)+1; % a1prime
            Policy4(4,curraindex,zind,N_j)=ceil(aprimeind/N_a1); % a2prime
            ...
            for ii=1:(vfoptions.level1n-1)
                ...
                if maxgap(ii)>0
                    ...
                    Policy4(1,curraindex,zind,N_j)=rem(dind-1,N_d2)+1; % d2
                    Policy4(2,curraindex,zind,N_j)=ceil(dind/N_d2); % d3
                    Policy4(3,curraindex,zind,N_j)=a1prime_rec; % a1prime
                    Policy4(4,curraindex,zind,N_j)=a2pind; % a2prime
                else
                    loweredge=maxindex1(:,1,:,ii,:,:,:);
                    ...
                    Policy4(1,curraindex,zind,N_j)=rem(dind-1,N_d2)+1; % d2
                    Policy4(2,curraindex,zind,N_j)=ceil(dind/N_d2); % d3
                    Policy4(3,curraindex,zind,N_j)=loweredge(loweredge_idx); % a1prime
                    Policy4(4,curraindex,zind,N_j)=a2pind; % a2prime
                end
            end
        end
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_bothz
            ...
            Policy4(1,curraindex,z_c,N_j)=rem(dind-1,N_d2)+1; % d2
            Policy4(2,curraindex,z_c,N_j)=ceil(dind/N_d2); % d3
            aprimeind=ceil(maxindex2/N_d); % this is the joint (a1prime,a2prime)
            Policy4(3,curraindex,z_c,N_j)=rem(aprimeind-1,N_a1)+1; % a1prime
            Policy4(4,curraindex,z_c,N_j)=ceil(aprimeind/N_a1); % a2prime
            ...
            for ii=1:(vfoptions.level1n-1)
                ...
                if maxgap(ii)>0
                    ...
                    Policy4(1,curraindex,z_c,N_j)=rem(dind-1,N_d2)+1; % d2
                    Policy4(2,curraindex,z_c,N_j)=ceil(dind/N_d2); % d3
                    Policy4(3,curraindex,z_c,N_j)=a1prime_rec; % a1prime
                    Policy4(4,curraindex,z_c,N_j)=a2pind; % a2prime
                else
                    loweredge=maxindex1(:,1,:,ii,:,:);
                    ...
                    Policy4(1,curraindex,z_c,N_j)=rem(dind-1,N_d2)+1; % d2
                    Policy4(2,curraindex,z_c,N_j)=ceil(dind/N_d2); % d3
                    Policy4(3,curraindex,z_c,N_j)=loweredge(loweredge_idx); % a1prime
                    Policy4(4,curraindex,z_c,N_j)=a2pind; % a2prime
                end
            end
        end
