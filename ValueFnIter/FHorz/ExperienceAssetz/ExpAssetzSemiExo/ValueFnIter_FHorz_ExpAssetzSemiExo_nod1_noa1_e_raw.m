function [V,Policy2]=ValueFnIter_FHorz_ExpAssetzSemiExo_nod1_noa1_e_raw(n_d2,n_d3,n_a2,n_z,n_semiz,n_e,N_j, d2_gridvals, d3_grid, a2_grid, z_gridvals_J, semiz_gridvals_J, e_gridvals_J, pi_z_J, pi_semiz_J, pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            entireRHS_d3=ReturnMatrix_d3+DiscountFactorParamsVec*entireEV; % autofills e dimension
    ...
    elseif vfoptions.lowmemory==1 % loop e
        for d3_c=1:N_d3
            ...
            for e_c=1:N_e
                ...
                entireRHS_d3e=ReturnMatrix_d3e+DiscountFactorParamsVec*entireEV;
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_d3ze=ReturnMatrix_d3ze+DiscountFactorParamsVec*entireEV_z;
