function [Vtilde,Policy,Valt,Policyalt]=ValueFnIter_FHorz_QuasiHyperbolicN_GI2A_nod_noz_raw(n_a, N_j, a_grid, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, beta0)
% Naive quasi-hyperbolic discounting variant of ValueFnIter_FHorz_GI2A_nod_noz_raw.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    % aprime possibilities are n2long-by-n_a2-by-n_a1-by-n_a2
    ReturnMatrix_iialt=CreateReturnFnMatrix_Disc_DC2A_nod_noz(ReturnFn,a1prime_grid(a1primeindexesalt),a2_grid, a1_grid, a2_grid,ReturnFnParamsVec,2);
    ...
    linidx_upperalt  = n2long*maxindexL2a2alt                             + n2long*N_a2*a12ind;
    ...
    Valt(:,N_j)=shiftdim(Vtempii,1);
    Policyalt(1,:,N_j)=midpointalt(maxindexL2a2alt+N_a2*a12ind); % a1prime midpoint
...
for reverse_j=1:N_j-1
    ...
    Policyalt(1,:,jj)=midpointalt(maxindexL2a2alt+N_a2*a12ind); % a1prime midpoint
