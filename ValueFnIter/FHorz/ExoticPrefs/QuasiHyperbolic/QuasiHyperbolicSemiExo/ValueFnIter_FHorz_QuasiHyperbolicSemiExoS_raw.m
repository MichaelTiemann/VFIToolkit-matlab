function [Vhat, Policy, Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicSemiExoS_raw(n_d1, n_d2, n_a, n_z, n_semiz, N_j, d1_gridvals, d2_gridvals, a_grid, z_gridvals_J, semiz_gridvals_J, pi_z_J, pi_semiz_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, beta0)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1 % parallel over semiz, loop over z
        for z_c=1:N_z
            ...
            Policy(1,:,semizblock,N_j)=rem(d_ind-1,N_d1)+1;
            Policy(2,:,semizblock,N_j)=ceil(d_ind/N_d1);
            Policy(3,:,semizblock,N_j)=ceil(maxindex/N_d);
        end
    ...
    elseif vfoptions.lowmemory==1 % parallel over semiz, loop over z
        for d2_c=1:N_d2
            ...
            for z_c=1:N_z
                ...
                entireEV_z=repelem(EV_d2z,N_d1,1,1); % [N_d1*N_a,1,N_semiz]
                ...
                entireRHS_alt=ReturnMatrix_d2z+beta*entireEV_z; % [N_d1*N_a,N_a,N_semiz]
