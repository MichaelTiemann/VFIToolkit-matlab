function [Vhat, Policy, Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicSemiExoS_DC1_GI1_nod1_e_raw(n_d2,n_a,n_z,n_semiz, n_e,N_j, d2_gridvals, a_grid, z_gridvals_J, semiz_gridvals_J, e_gridvals_J,pi_z_J, pi_semiz_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, beta0)
% Sophisticated QH + SemiExo + DC + GI raw, no d1, with z, with e. Output: (Vunderbar, Policy, Vhat) -- matches plain QH SemiExo S raw convention.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d2_c=1:N_d2
            ...
            EVfine=reshape(EVinterp_d2(aprimez),[n2long,N_a,N_bothz,N_e]);
            ...
            linidx=reshape(maxindex,[1,N_a*N_bothz*N_e])+n2long*(0:N_a*N_bothz*N_e-1);
    ...
    elseif vfoptions.lowmemory==1
        ...
        for d2_c=1:N_d2
            ...
            for e_c=1:N_e
                ...
                aprimez=aprimeindexes+n2aprime*bothzind;
                EVfine=reshape(EVinterp_d2(aprimez),[n2long,N_a,N_bothz]);
                entireRHS_L2=ReturnMatrix_L2+beta0beta*EVfine;
                [Vtemp,maxindex]=max(entireRHS_L2,[],1);
                ...
                linidx=reshape(maxindex,[1,N_a*N_bothz])+n2long*(0:N_a*N_bothz-1);
        ...
        for d2_c=1:N_d2
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_d2ii=ReturnMatrix_d2ii+beta0beta*EV_d2z;
                    [~,maxindex1]=max(entireRHS_d2ii,[],1);
                    ...
                    EVfine=reshape(EVinterp_d2z(aprimez),[n2long,N_a,N_semiz]);
                    entireRHS_L2=ReturnMatrix_L2+beta0beta*EVfine;
                    [Vtemp,maxindex]=max(entireRHS_L2,[],1);
        ...
        for d2_c=1:N_d2
            ...
            for z_c=1:N_bothz
                ...
                for e_c=1:N_e
                    ...
                    EVfine=reshape(EVinterp_d2z(aprimeindexes),[n2long,N_a]);
                    entireRHS_L2=ReturnMatrix_L2+beta0beta*EVfine;
                    [Vtemp,maxindex]=max(entireRHS_L2,[],1);
                    ...
                    linidx=reshape(maxindex,[1,N_a])+n2long*(0:N_a-1);
