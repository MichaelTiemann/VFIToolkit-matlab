function [Vhat, Policy, Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicSemiExoS_DC1_GI1_nod1_noz_e_raw(n_d2,n_a,n_semiz, n_e,N_j, d2_gridvals, a_grid, semiz_gridvals_J, e_gridvals_J, pi_semiz_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, beta0)
% Sophisticated QH + SemiExo + DC + GI raw, no d1, no z, with e. Output: (Vunderbar, Policy, Vhat) -- matches plain QH SemiExo S raw convention.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d2_c=1:N_d2
            ...
            EVfine=reshape(EVinterp_d2(aprimez),[n2long,N_a,N_semiz,N_e]);
            ...
            linidx=reshape(maxindex,[1,N_a*N_semiz*N_e])+n2long*(0:N_a*N_semiz*N_e-1);
        ...
        for d2_c=1:N_d2
            ...
            for semiz_c=1:N_semiz
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_d2ii=ReturnMatrix_d2ii+beta0beta*EV_d2semiz;
                    [~,maxindex1]=max(entireRHS_d2ii,[],1);
                    ...
                    Vunderbar_ford2_jj(:,semiz_c,e_c,d2_c)=Vhat_ford2_jj(:,semiz_c,e_c,d2_c)+(beta-beta0beta)*EV_at_policy;
                end
            end
        end
    end
