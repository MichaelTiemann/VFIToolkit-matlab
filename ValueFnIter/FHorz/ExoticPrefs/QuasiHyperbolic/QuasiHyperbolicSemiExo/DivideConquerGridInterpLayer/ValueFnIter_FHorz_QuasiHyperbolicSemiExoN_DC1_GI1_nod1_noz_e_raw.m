...
Policy=zeros(3,N_a,N_semiz,N_e,N_j,vfoptions.indexT,'gpuArray');
PolicyL2flag=2*ones(1,N_a,N_semiz,N_e,N_j,vfoptions.indexT,'gpuArray');
Policyalt=zeros(3,N_a,N_semiz,N_e,N_j,vfoptions.indexT,'gpuArray'); % exponential discounter optimal [d2; midpoint; aprimeL2ind]
