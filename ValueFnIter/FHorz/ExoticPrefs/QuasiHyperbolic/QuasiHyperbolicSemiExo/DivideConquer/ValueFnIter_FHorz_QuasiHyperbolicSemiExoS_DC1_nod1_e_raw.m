function [Vhat,Policy,Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicSemiExoS_DC1_nod1_e_raw(n_d2,n_a,n_z,n_semiz, n_e,N_j, d2_gridvals, a_grid, z_gridvals_J, semiz_gridvals_J, e_gridvals_J, pi_z_J, pi_semiz_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, beta0)
% Sophisticated QH + SemiExo + DC, no d1, with z, with e.
                ...
                for e_c=1:N_e
                    ...
                    for ii=1:(vfoptions.level1n-1)
                        ...
                        if maxgap(ii)>0
                            ...
                            Vhat_ford2_jj(curraindex,semizblock,e_c,d2_c)=shiftdim(ReturnMatrix_iize,1);
                            Vunderbar_ford2_jj(curraindex,semizblock,e_c,d2_c)=shiftdim(ReturnMatrix_iize,1);
                ...
                for e_c=1:N_e
                    ...
                    for ii=1:(vfoptions.level1n-1)
                        ...
                        if maxgap(ii)>0
                            ...
                            Vhat_ford2_jj(curraindex,z_c,e_c,d2_c)=shiftdim(ReturnMatrix_iize,1);
                            Vunderbar_ford2_jj(curraindex,z_c,e_c,d2_c)=shiftdim(ReturnMatrix_iize,1);
        ...
        for d2_c=1:N_d2
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_Vh=ReturnMatrix_d2iize+beta0beta*EV_d2z;
                    [Vtempii,maxindex1]=max(entireRHS_Vh,[],1);
                    Vhat_ford2_jj(level1ii,semizblock,e_c,d2_c)=shiftdim(Vtempii,1);
                    Policy_ford2_jj(level1ii,semizblock,e_c,d2_c)=shiftdim(maxindex1,1);
                    maxgap=squeeze(max(maxindex1(1,2:end,:)-maxindex1(1,1:end-1,:),[],3));
                    for ii=1:(vfoptions.level1n-1)
                        ...
                        if maxgap(ii)>0
                            ...
                            Vhat_ford2_jj(curraindex,semizblock,e_c,d2_c)=shiftdim(entireRHS_ii,1);
                            Policy_ford2_jj(curraindex,semizblock,e_c,d2_c)=repelem(shiftdim(loweredge,1),level1iidiff(ii),1);
                        end
                    end
                end
                ...
                for e_c=1:N_e
                    ...
                    for ii=1:(vfoptions.level1n-1)
                        ...
                        if maxgap(ii)>0
                            ...
                            Vhat_ford2_jj(curraindex,z_c,e_c,d2_c)=shiftdim(entireRHS_ii,1);
                            Policy_ford2_jj(curraindex,z_c,e_c,d2_c)=repelem(shiftdim(loweredge,1),level1iidiff(ii),1);
                        end
                    end
                end
