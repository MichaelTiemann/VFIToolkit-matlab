...
Policy=zeros(2,N_a,N_semiz*N_z,N_e,N_j,vfoptions.indexT,'gpuArray');
Policyalt=zeros(2,N_a,N_semiz*N_z,N_e,N_j,vfoptions.indexT,'gpuArray'); % exponential discounter optimal (d2, aprime)
