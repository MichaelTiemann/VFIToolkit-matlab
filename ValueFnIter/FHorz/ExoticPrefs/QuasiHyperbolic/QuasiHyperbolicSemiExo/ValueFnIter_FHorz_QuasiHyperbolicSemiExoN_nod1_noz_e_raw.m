function [Vtilde, Policy, Valt, Policyalt]=ValueFnIter_FHorz_QuasiHyperbolicSemiExoN_nod1_noz_e_raw(n_d2, n_a, n_semiz, n_e, N_j, d2_gridvals, a_grid, semiz_gridvals_J, e_gridvals_J, pi_semiz_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, beta0)
        ...
        for d2_c=1:N_d2
            ...
            for semiz_c=1:N_semiz
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_V=ReturnMatrix_d2semize+beta*EV_d2semiz;
                    [Vtemp,maxindexalt]=max(entireRHS_V,[],1);
                    V_ford2_jj(:,semiz_c,e_c,d2_c)=Vtemp;
                    Policy_V_ford2_jj(:,semiz_c,e_c,d2_c)=maxindexalt;

                    entireRHS_e=ReturnMatrix_d2semize+beta0beta*EV_d2semiz;
                    [Vtemp,maxindex]=max(entireRHS_e,[],1);
                    Vtilde_ford2_jj(:,semiz_c,e_c,d2_c)=Vtemp;
...
for reverse_j=1:N_j-1
    ...
    EV_pre=sum(Valt(:,:,:,jj+1).*pi_e_J(1,1,:,jj+1),3);
