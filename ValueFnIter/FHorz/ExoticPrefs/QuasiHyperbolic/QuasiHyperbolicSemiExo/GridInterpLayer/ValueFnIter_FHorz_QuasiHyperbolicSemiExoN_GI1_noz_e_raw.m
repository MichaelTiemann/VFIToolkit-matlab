...
Policyalt=zeros(4,N_a,N_semiz,N_e,N_j,vfoptions.indexT,'gpuArray'); % exponential discounter optimal [d1; d2; midpoint; aprimeL2ind]
PolicyL2flagalt=2*ones(1,N_a,N_semiz,N_e,N_j,vfoptions.indexT,'gpuArray');
