function [Vhat,Policy,Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicS_DC1_GI1_nod_noz_e_raw(n_a,n_e,N_j, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, beta0)
% Sophisticated quasi-hyperbolic discounting variant of ValueFnIter_FHorz_DC1_GI1_nod_noz_e_raw.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        ...
        linidx=reshape(maxindexL2,[1,N_a*N_e])+n2long*(0:N_a*N_e-1);
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            linidx_e=reshape(maxindexL2,[1,N_a])+n2long*(0:N_a-1);
