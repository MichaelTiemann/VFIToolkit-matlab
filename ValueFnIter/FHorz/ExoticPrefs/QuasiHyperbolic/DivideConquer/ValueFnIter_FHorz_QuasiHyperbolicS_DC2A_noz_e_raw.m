function [Vhat,Policy,Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicS_DC2A_noz_e_raw(n_d,n_a,n_e,N_j, d_gridvals, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, beta0)
% Sophisticated quasi-hyperbolic discounting variant of ValueFnIter_FHorz_DC2A_noz_e_raw.
% divide-and-conquer in the first endo state. Has d. No z. Has e. GPU (parallel==2 only).
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    DiscountedEV=beta0beta*reshape(EV,[1,N_a1,N_a2,1,1]); % will autoexpand d in 1st-dim
...
for reverse_j=1:N_j-1
    ...
    EV=sum(Vunderbar(:,:,jj+1).*pi_e_J(1,:,jj+1),2); % sophisticated continuation
    DiscountedEV=beta0beta*reshape(EV,[1,N_a1,N_a2,1,1]); % will autoexpand d in 1st-dim
