function [Vhat,Policy,Vunderbar]=ValueFnIter_FHorz_QuasiHyperbolicS_DC2A_nod_noz_e_raw(n_a, n_e, N_j, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, beta0)
% Sophisticated quasi-hyperbolic discounting variant of ValueFnIter_FHorz_DC2A_nod_noz_e_raw.
% divide-and-conquer in the first endo state. No d. No z. Has e. GPU (parallel==2 only).
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    DiscountedEV=beta0beta*reshape(EV,[N_a1,N_a2,1,1]);  % autoexpand (a)
