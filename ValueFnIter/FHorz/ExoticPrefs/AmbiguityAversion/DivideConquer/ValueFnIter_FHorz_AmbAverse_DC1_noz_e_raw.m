function [V,Policy]=ValueFnIter_FHorz_AmbAverse_DC1_noz_e_raw(n_ambiguity, n_d,n_a,n_e,N_j, d_gridvals, a_grid, e_gridvals_J, ambiguity_pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
