function [V,Policy]=ValueFnIter_FHorz_AmbAverse_DC2A_noz_e_raw(n_ambiguity, n_d,n_a,n_e,N_j, d_gridvals, a_grid, e_gridvals_J, ambiguity_pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
ambiguity_pi_e_J=shiftdim(ambiguity_pi_e_J,-1);
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    EVpre=reshape(vfoptions.V_Jplus1,[N_a,N_e]); % switch V into Kron form ready for the iid-e expectation
