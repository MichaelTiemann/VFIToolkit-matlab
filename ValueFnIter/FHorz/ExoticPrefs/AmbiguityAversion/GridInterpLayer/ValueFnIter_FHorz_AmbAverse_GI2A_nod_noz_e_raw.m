function [V,Policy]=ValueFnIter_FHorz_AmbAverse_GI2A_nod_noz_e_raw(n_ambiguity, n_a,n_e, N_j, a_grid, e_gridvals_J, ambiguity_pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    EVinterp=min(interp1(a1_grid,reshape(ambEV,[N_a1,N_a2,size(ambEV,2)]),a1prime_grid),[],3); % interpolate each prior's EV over a1prime_grid (conditional on the prior), then take the worst case over the priors
