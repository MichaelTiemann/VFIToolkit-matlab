function [V,Policy]=ValueFnIter_FHorz_AmbAverse_RiskyAsset_DC1_GI1_noz_raw(n_ambiguity, n_d1,n_d2,n_d3,n_a1,n_a2,n_u,N_j, d1_grid, d2_grid, d3_grid, a1_grid, a2_grid, u_grid, ambiguity_pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    entireRHS_ii=ReturnMatrix_ii+DiscountedEV(d3aprime); % [N_d13,N_a1(a1prime),level1n,N_a2]
    ...
    entireRHS_ii=reshape(reshape(ReturnMatrix_ii,[N_d13,n2long,N_a1,N_a2])+reshape(DiscountedEVinterp(da1prime),[N_d13,n2long,N_a1,N_a2]),[N_d13*n2long,N_a1*N_a2]);
