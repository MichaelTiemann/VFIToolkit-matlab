function [V, Policy]=ValueFnIter_FHorz_AmbAverse_nod_raw(n_ambiguity, n_a,n_z,N_j, a_grid, z_gridvals_J,ambiguity_pi_z_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
