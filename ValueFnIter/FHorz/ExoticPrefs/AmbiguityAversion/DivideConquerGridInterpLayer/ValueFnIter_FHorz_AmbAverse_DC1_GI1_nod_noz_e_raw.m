function [V, Policy]=ValueFnIter_FHorz_AmbAverse_DC1_GI1_nod_noz_e_raw(n_ambiguity, n_a,n_e,N_j, a_grid, e_gridvals_J, ambiguity_pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
ambiguity_pi_e_J=shiftdim(ambiguity_pi_e_J,-1); % Move to second dimension
