function [V, Policy]=ValueFnIter_FHorz_AmbAverse_nod_e_raw(n_ambiguity, n_a,n_z,n_e,N_j, a_grid, z_gridvals_J, e_gridvals_J, ambiguity_pi_z_J, ambiguity_pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
