function [V,Policy2]=ValueFnIter_FHorz_Ambiguity_raw(n_ambiguity, n_d,n_a,n_z,N_j, d_gridvals, a_grid, z_gridvals_J, ambiguity_pi_z_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
