function [V,Policy]=ValueFnIter_FHorz_EpsteinZin_GI1_raw(n_d,n_a,n_z,N_j, d_gridvals, a_grid, z_gridvals_J, pi_z_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, sj, warmglow, ezc1,ezc2,ezc3,ezc4,ezc5,ezc6,ezc7, ezc8)
% Grid-interpolation-layer version of ValueFnIter_FHorz_EpsteinZin_raw.
% Grafts the Epstein-Zin transforms onto ValueFnIter_FHorz_GI1_raw. The
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        ...
        for z_c=1:N_z
            ...
            ReturnMatrix_z(temp5)=ReturnMatrix_z(temp5).^ezc7(N_j);
    ...
    elseif vfoptions.lowmemory==1
        ...
        for z_c=1:N_z
            ...
            entireRHS_z=ezc1*temp2+ezc3*DiscountFactorParamsVec*shiftdim(temp4_z,-1);
            ...
            entireRHS_ii_z=ezc1*temp2_ii+ezc3*DiscountFactorParamsVec*reshape(temp4interp_z(aprimeindexes(:)),[N_d*n2long,N_a]);
