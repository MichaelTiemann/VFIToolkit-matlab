function [V, Policy]=ValueFnIter_FHorz_EpsteinZin_GI1_nod_noz_e_raw(n_a,n_e,N_j, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, sj, warmglow, ezc1,ezc2,ezc3,ezc4,ezc5,ezc6,ezc7, ezc8)
% Grid-interpolation-layer version of ValueFnIter_FHorz_EpsteinZin_nod_noz_e_raw.
% Grafts the Epstein-Zin transforms onto ValueFnIter_FHorz_GI1_nod_noz_e_raw. The
