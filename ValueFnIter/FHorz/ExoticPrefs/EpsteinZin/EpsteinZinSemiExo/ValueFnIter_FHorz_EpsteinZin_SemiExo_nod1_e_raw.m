...
% applied before each conditional-on-d2 max. The final max over d2 then
    ...
    elseif vfoptions.lowmemory==2 % outer z / inner e, vectorize semiz
        ...
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                % Compose the warm-glow INSIDE the ^ezc7 root (the main-loop composition with the EV term absent)
                ReturnMatrix_ze=ezc1*ReturnMatrix_ze+ezc3*DiscountFactorParamsVec*WGmatrixkron; % in-place: ReturnMatrix_ze now holds what was entireRHS_ze
        ...
        for d2_c=1:N_d2
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_ze=ezc1*temp2+ezc3*DiscountFactorParamsVec*temp4;
