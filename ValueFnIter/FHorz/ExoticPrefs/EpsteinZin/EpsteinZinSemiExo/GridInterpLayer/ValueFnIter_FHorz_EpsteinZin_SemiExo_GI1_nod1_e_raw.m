function [V,Policy]=ValueFnIter_FHorz_EpsteinZin_SemiExo_GI1_nod1_e_raw(n_d2,n_a,n_z,n_semiz, n_e,N_j, d2_gridvals, a_grid, z_gridvals_J, semiz_gridvals_J, e_gridvals_J,pi_z_J, pi_semiz_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, sj, warmglow, ezc1,ezc2,ezc3,ezc4,ezc5,ezc6,ezc7, ezc8)
% Grid-interpolation-layer version of ValueFnIter_FHorz_EpsteinZin_SemiExo_nod1_e_raw.
% Grafts the Epstein-Zin transforms onto ValueFnIter_FHorz_SemiExo_GI1_nod1_e_raw.
        ...
        for d2_c=1:N_d2
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_d2ze=ezc1*temp2+ezc3*DiscountFactorParamsVec*temp4;
                    temp5=logical(isfinite(entireRHS_d2ze).*(entireRHS_d2ze~=0));
                    entireRHS_d2ze(temp5)=entireRHS_d2ze(temp5).^ezc7(N_j);
                    entireRHS_d2ze(entireRHS_d2ze==0)=-Inf;
                    % Treat standard problem as just being the first layer
        ...
        for d2_c=1:N_d2
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_d2ze=ezc1*temp2+ezc3*DiscountFactorParamsVec*temp4;
                    temp5=logical(isfinite(entireRHS_d2ze).*(entireRHS_d2ze~=0));
                    entireRHS_d2ze(temp5)=entireRHS_d2ze(temp5).^ezc7(jj);
                    entireRHS_d2ze(entireRHS_d2ze==0)=-Inf;
                    % Treat standard problem as just being the first layer
                    [~,maxindex]=max(entireRHS_d2ze,[],1); % no d1, loop over d2
