function [V, Policy]=ValueFnIter_FHorz_EpsteinZin_DC1_GI1_nod_e_raw(n_a,n_z,n_e,N_j, a_grid, z_gridvals_J, e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions, sj, warmglow, ezc1,ezc2,ezc3,ezc4,ezc5,ezc6,ezc7, ezc8)
% Divide-and-conquer plus grid-interpolation-layer version of
% ValueFnIter_FHorz_EpsteinZin_nod_e_raw. Grafts the Epstein-Zin transforms
% onto ValueFnIter_FHorz_DC1_GI1_nod_e_raw. The interpolation acts on
