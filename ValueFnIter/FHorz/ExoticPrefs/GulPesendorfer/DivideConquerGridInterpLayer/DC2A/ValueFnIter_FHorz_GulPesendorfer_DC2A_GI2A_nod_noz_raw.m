function [V,Policy]=ValueFnIter_FHorz_GulPesendorfer_DC2A_GI2A_nod_noz_raw(n_a, N_j, a_grid, ReturnFn, TemptationFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    for ii=1:(vfoptions.level1n-1)
        ...
        TemptationMatrix_full=CreateReturnFnMatrix_Disc_DC2A_nod_noz(TemptationFn, a1_grid, a2_grid, a1_grid(curraindex), a2_grid, TemptationFnParamsVec,1);
        ...
        if maxgap(ii)>0
            ...
            ReturnMatrix_ii=CreateReturnFnMatrix_Disc_DC2A_nod_noz(ReturnFn, a1_grid(aprimeindexes), a2_grid, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_grid, ReturnFnParamsVec,1);
            TemptationMatrix_ii=CreateReturnFnMatrix_Disc_DC2A_nod_noz(TemptationFn, a1_grid(aprimeindexes), a2_grid, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_grid, TemptationFnParamsVec,1);
