function [V,Policy]=ValueFnIter_FHorz_GulPesendorfer_GI2A_nod_noz_raw(n_a, N_j, a_grid, ReturnFn, TemptationFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ReturnMatrix=CreateReturnFnMatrix_Disc_DC2A_nod_noz(ReturnFn, a1_grid, a2_grid, a1_grid, a2_grid, ReturnFnParamsVec,1);
    ...
    ReturnMatrix_ii=CreateReturnFnMatrix_Disc_DC2A_nod_noz(ReturnFn,a1prime_grid(a1primeindexes),a2_grid,a1_grid,a2_grid,ReturnFnParamsVec,2);
    TemptationMatrix_ii=CreateReturnFnMatrix_Disc_DC2A_nod_noz(TemptationFn,a1prime_grid(a1primeindexes),a2_grid,a1_grid,a2_grid,TemptationFnParamsVec,2);
