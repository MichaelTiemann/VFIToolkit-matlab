function [V,Policy]=ValueFnIter_FHorz_GulPesendorfer_SemiExo_nod1_noz_raw(n_d2,n_a,n_semiz,N_j, d2_gridvals, a_grid, semiz_gridvals_J, pi_semiz_J, ReturnFn, TemptationFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        ...
        TemptationMatrix=CreateReturnFnMatrix_Disc(TemptationFn, n_d2, n_a, n_semiz, d2_gridvals, a_grid, semiz_gridvals_J(:,:,N_j), TemptationFnParamsVec,0);
    ...
    elseif vfoptions.lowmemory==1
        ...
        for z_c=1:N_semiz
            ...
            TemptationMatrix_z=CreateReturnFnMatrix_Disc(TemptationFn, n_d2, n_a, special_n_semiz, d2_gridvals, a_grid, z_val, TemptationFnParamsVec,0);
    ...
    if vfoptions.lowmemory==0
        for d2_c=1:N_d2
            ...
            entireRHS=ReturnMatrix_d2+TemptationMatrix_d2+DiscountFactorParamsVec*EV_d2; %repmat(EV,1,N_a,1);
    ...
    elseif vfoptions.lowmemory==1
        for d2_c=1:N_d2
            ...
            for z_c=1:N_semiz
                ...
                entireRHS_z=ReturnMatrix_d2z+TemptationMatrix_d2z+DiscountFactorParamsVec*EV_d2z; % EV_z*ones(1,N_a,1);
