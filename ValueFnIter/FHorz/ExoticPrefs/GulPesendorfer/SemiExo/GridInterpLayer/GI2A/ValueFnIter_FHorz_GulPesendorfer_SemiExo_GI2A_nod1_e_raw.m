function [V,Policy]=ValueFnIter_FHorz_GulPesendorfer_SemiExo_GI2A_nod1_e_raw(n_d2, n_a, n_z, n_semiz, n_e, N_j, d2_gridvals, a_grid, z_gridvals_J, semiz_gridvals_J, e_gridvals_J, pi_z_J, pi_semiz_J, pi_e_J, ReturnFn, TemptationFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, vfoptions)
% SemiExo + GI2A (two-endo grid interpolation), no d1, with z, with e.
% Combines SemiExo d2/pi_semiz iteration with the 2-endo GI2A machinery, with bothz=[semiz,z] and iid e.
...
MostTempting_ford2=zeros(N_a,N_bothz,N_e,N_d2,'gpuArray'); % per-d2 fine (a1prime,a2prime) max of the temptation
...
if ~isfield(vfoptions,'V_Jplus1')
  ...
  if vfoptions.lowmemory==0
    for d2_c=1:N_d2
        ...
        TemptationMatrix=CreateReturnFnMatrix_Disc_DC2A_e(TemptationFn, special_n_d2, n_bothz, n_e, d2_val, a1_grid, a2_grid, a1_grid, a2_grid, bothz_gridvals_J(:,:,N_j), e_gridvals_J(:,:,N_j), TemptationFnParamsVec, 1, 0);
        ...
        MostTempting_ford2(:,:,:,d2_c)=shiftdim(max(TemptationMatrix_Tii,[],1),1); % fine (a1prime,a2prime) max for this d2
  ...
  elseif vfoptions.lowmemory==1 % loop e, vectorise bothz
    for d2_c=1:N_d2
        ...
        for e_c=1:N_e
            ...
            TemptationMatrix=CreateReturnFnMatrix_Disc_DC2A_e(TemptationFn, special_n_d2, n_bothz, special_n_e, d2_val, a1_grid, a2_grid, a1_grid, a2_grid, bothz_gridvals_J(:,:,N_j), e_val, TemptationFnParamsVec, 1, 0);
            [~,maxindex]=max(ReturnMatrix+TemptationMatrix,[],2);
            ...
            MostTempting_ford2(:,:,e_c,d2_c)=shiftdim(max(TemptationMatrix_Tii,[],1),1); % fine (a1prime,a2prime) max for this d2
    ...
    for d2_c=1:N_d2
        ...
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                TemptationMatrix=CreateReturnFnMatrix_Disc_DC2A_e(TemptationFn, special_n_d2, [n_semiz,special_n_z], special_n_e, d2_val, a1_grid, a2_grid, a1_grid, a2_grid, z_valblock, e_val, TemptationFnParamsVec, 1, 0);
                [~,maxindex]=max(ReturnMatrix+TemptationMatrix,[],2);
                ...
                MostTempting_ford2(:,semizblock,e_c,d2_c)=shiftdim(max(TemptationMatrix_Tii,[],1),1); % fine (a1prime,a2prime) max for this d2
  ...
  elseif vfoptions.lowmemory==3 % joint bothz / inner e
    for d2_c=1:N_d2
        ...
        for z_c=1:N_bothz
            ...
            for e_c=1:N_e
                ...
                TemptationMatrix=CreateReturnFnMatrix_Disc_DC2A_e(TemptationFn, special_n_d2, special_n_bothz, special_n_e, d2_val, a1_grid, a2_grid, a1_grid, a2_grid, z_val, e_val, TemptationFnParamsVec, 1, 0);
                [~,maxindex]=max(ReturnMatrix+TemptationMatrix,[],2);
                ...
                MostTempting_ford2(:,z_c,e_c,d2_c)=shiftdim(max(TemptationMatrix_Tii,[],1),1); % fine (a1prime,a2prime) max for this d2
    ...
    for d2_c=1:N_d2
      ...
      if vfoptions.lowmemory==0
        ...
        entireRHS_ii=Ftemp_ii+DiscountFactorParamsVec*reshape(EVinterp(aprime),[n2long*N_a2,N_a,N_bothz,N_e]);
      ...
      elseif vfoptions.lowmemory==1 % loop e, vectorise bothz
        ...
        for e_c=1:N_e
            ...
            Ftemp_ii=ReturnMatrix_ii+TemptationMatrix_ii;
            aprime=a1primeindexes+N_a1fine*a2ind+N_a1fine*N_a2*zBind;
            entireRHS_ii=Ftemp_ii+DiscountFactorParamsVec*reshape(EVinterp(aprime),[n2long*N_a2,N_a,N_bothz]);
            [Vtempii,maxindexL2]=max(entireRHS_ii,[],1);
            maxindexL2a1=rem(maxindexL2-1,n2long)+1;
            maxindexL2a2=ceil(maxindexL2/n2long);
      ...
      elseif vfoptions.lowmemory==2 % outer z / inner e, vectorise semiz
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                entireRHS_ii=Ftemp_ii+DiscountFactorParamsVec*reshape(EVinterp(aprime),[n2long*N_a2,N_a,N_semiz]);
                [Vtempii,maxindexL2]=max(entireRHS_ii,[],1);
                maxindexL2a1=rem(maxindexL2-1,n2long)+1;
                maxindexL2a2=ceil(maxindexL2/n2long);
      ...
      elseif vfoptions.lowmemory==3 % joint bothz / inner e
        for z_c=1:N_bothz
            ...
            for e_c=1:N_e
                ...
                entireRHS_ii=Ftemp_ii+DiscountFactorParamsVec*reshape(EVinterp(aprime),[n2long*N_a2,N_a]);
                [Vtempii,maxindexL2]=max(entireRHS_ii,[],1);
                maxindexL2a1=rem(maxindexL2-1,n2long)+1;
                maxindexL2a2=ceil(maxindexL2/n2long);
...
for reverse_j=1:N_j-1
    ...
    for d2_c=1:N_d2
      ...
      if vfoptions.lowmemory==0
        ...
        TemptationMatrix=CreateReturnFnMatrix_Disc_DC2A_e(TemptationFn, special_n_d2, n_bothz, n_e, d2_val, a1_grid, a2_grid, a1_grid, a2_grid, bothz_gridvals_J(:,:,jj), e_gridvals_J(:,:,jj), TemptationFnParamsVec, 1, 0);
        entireRHS=ReturnMatrix+TemptationMatrix+DiscountFactorParamsVec*shiftdim(EV,-1);
        [~,maxindex]=max(entireRHS,[],2);
      ...
      elseif vfoptions.lowmemory==1 % loop e, vectorise bothz
        ...
        for e_c=1:N_e
            ...
            TemptationMatrix=CreateReturnFnMatrix_Disc_DC2A_e(TemptationFn, special_n_d2, n_bothz, special_n_e, d2_val, a1_grid, a2_grid, a1_grid, a2_grid, bothz_gridvals_J(:,:,jj), e_val, TemptationFnParamsVec, 1, 0);
            entireRHS=ReturnMatrix+TemptationMatrix+DiscountFactorParamsVec*shiftdim(EV,-1);
            [~,maxindex]=max(entireRHS,[],2);
