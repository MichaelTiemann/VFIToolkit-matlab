function [V,Policy3]=ValueFnIter_FHorz_GulPesendorfer_SemiExo_raw(n_d1,n_d2,n_a,n_z,n_semiz,N_j, d1_gridvals, d2_gridvals, a_grid, z_gridvals_J, semiz_gridvals_J, pi_z_J, pi_semiz_J, ReturnFn, TemptationFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        ...
        TemptationMatrix=CreateReturnFnMatrix_Disc(TemptationFn, n_d, n_a, n_bothz, d_gridvals, a_grid, bothz_gridvals_J(:,:,N_j), TemptationFnParamsVec,0);
    ...
    elseif vfoptions.lowmemory==1 % parallel over semiz, loop over z
        ...
        for z_c=1:N_z
            ...
            TemptationMatrix_z=CreateReturnFnMatrix_Disc(TemptationFn, n_d, n_a, [n_semiz,special_n_z], d_gridvals, a_grid, z_valblock, TemptationFnParamsVec,0);
    ...
    elseif vfoptions.lowmemory==2 % joint loop over bothz
        ...
        for z_c=1:N_bothz
            ...
            TemptationMatrix_z=CreateReturnFnMatrix_Disc(TemptationFn, n_d, n_a, special_n_bothz, d_gridvals, a_grid, z_val, TemptationFnParamsVec,0);
            MostTempting_z=max(TemptationMatrix_z,[],1); % full (d1,d2,aprime) choice set
            % Calc the max and it's index
            [Vtemp,maxindex]=max(ReturnMatrix_z+TemptationMatrix_z,[],1);
    ...
    if vfoptions.lowmemory==0
        for d2_c=1:N_d2
            ...
            % (d,aprime,a,z)
            TemptationMatrix_d2=CreateReturnFnMatrix_Disc(TemptationFn, special_n_d, n_a, n_bothz, d12c_gridvals, a_grid, bothz_gridvals_J(:,:,N_j), TemptationFnParamsVec,0);
            ...
            entireRHS=ReturnMatrix_d2+TemptationMatrix_d2+DiscountFactorParamsVec*repelem(EV_d2,N_d1,1);
    ...
    elseif vfoptions.lowmemory==1 % parallel over semiz, loop over z
        for d2_c=1:N_d2
            ...
            for z_c=1:N_z
                ...
                TemptationMatrix_d2z=CreateReturnFnMatrix_Disc(TemptationFn, special_n_d, n_a, [n_semiz,special_n_z], d12c_gridvals, a_grid, z_valblock, TemptationFnParamsVec,0);
                MostTempting_ford2_jj(:,semizblock,d2_c)=shiftdim(max(TemptationMatrix_d2z,[],1),1); % full (d1,aprime) for this d2
                ...
                entireRHS_z=ReturnMatrix_d2z+TemptationMatrix_d2z+DiscountFactorParamsVec*repelem(EV_d2z,N_d1,1);
    ...
    elseif vfoptions.lowmemory==2 % joint loop over bothz
        for d2_c=1:N_d2
            ...
            for z_c=1:N_bothz
                ...
                TemptationMatrix_d2z=CreateReturnFnMatrix_Disc(TemptationFn, special_n_d, n_a, special_n_bothz, d12c_gridvals, a_grid, z_val, TemptationFnParamsVec,0);
                ...
                entireRHS_z=ReturnMatrix_d2z+TemptationMatrix_d2z+DiscountFactorParamsVec*entireEV_z; %*ones(1,N_a,1);
...
for reverse_j=1:N_j-1
    ...
    if vfoptions.lowmemory==0
        for d2_c=1:N_d2
            ...
            TemptationMatrix_d2=CreateReturnFnMatrix_Disc(TemptationFn, special_n_d, n_a, n_bothz, d12c_gridvals, a_grid, bothz_gridvals_J(:,:,jj), TemptationFnParamsVec,0);
            MostTempting_ford2_jj(:,:,d2_c)=shiftdim(max(TemptationMatrix_d2,[],1),1); % full (d1,aprime) for this d2
            ...
            entireRHS=ReturnMatrix_d2+TemptationMatrix_d2+DiscountFactorParamsVec*repelem(EV_d2,N_d1,1,1); %repelem(EV,N_d1,N_a,1); but the N_a autofills
    ...
    elseif vfoptions.lowmemory==2 % joint loop over bothz
        for d2_c=1:N_d2
            ...
            for z_c=1:N_bothz
                ...
                entireRHS_z=ReturnMatrix_d2z+TemptationMatrix_d2z+DiscountFactorParamsVec*repelem(EV_d2z,N_d1,1); %*ones(1,N_a,1);
