...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            Policy4_ford3_jj(3,:,:,:,d3_c)=shiftdim(squeeze(midpoint(d_ind+N_d12*aind+N_d12*N_a*bothzBind+N_d12*N_a*N_bothz*eBind)),-1);
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    Policy4_ford3_jj(1,:,zind,e_c,d3_c)=rem(d_ind-1,N_d1)+1;
                    Policy4_ford3_jj(2,:,zind,e_c,d3_c)=ceil(d_ind/N_d1);
                    Policy4_ford3_jj(3,:,zind,e_c,d3_c)=shiftdim(squeeze(midpoint(allind)),-1);
                    Policy4_ford3_jj(4,:,zind,e_c,d3_c)=shiftdim(ceil(maxindexL2/N_d12),-1);
                    L2offset=ceil(maxindexL2/N_d12);
    ...
    % a2primeIndex, a2primeProbs are [N_d2,N_a2,N_e]
    ...
    aprimeProbs_d2a1a2e=repmat(a2primeProbs,N_a1,1,1); % [N_d2*N_a1,N_a2,N_e]
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            lin_lower=aprimeIndex+bothz_offset; % [N_d2*N_a1,N_a2,N_bothz,N_e]
            ...
            DiscountedEVinterp=permute(interp1(a1_gridvals,permute(DiscountedEV,[2,1,3,4,5,6]),a1prime_grid),[2,1,3,4,5,6]); % [N_d2,N_a1prime,1,N_a2,N_bothz,N_e]
            ...
            entireRHS_ii_d3=ReturnMatrix_ii_d3+reshape(DiscountedEVinterp(d12a1primea2bothze(:)),[N_d12*n2long,N_a1*N_a2,N_bothz,N_e]);
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            for e_c=1:N_e
                ...
                entireRHS_ii_d3e=ReturnMatrix_ii_d3e+reshape(DiscountedEVinterp_e(d12a1primea2bothz(:)),[N_d12*n2long,N_a1*N_a2,N_bothz]);
        ...
        for d3_c=1:N_d3
            ...
            for z_c=1:N_z
                ...
                for e_c=1:N_e
                    ...
                    entireRHS_ii_d3ze=ReturnMatrix_ii_d3ze+reshape(DiscountedEVinterp_ze(d12a1primea2semiz(:)),[N_d12*n2long,N_a1*N_a2,N_semiz]);
