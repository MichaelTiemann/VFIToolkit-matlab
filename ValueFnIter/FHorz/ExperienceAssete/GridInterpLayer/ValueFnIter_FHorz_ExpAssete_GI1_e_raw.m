function [V,Policy]=ValueFnIter_FHorz_ExpAssete_GI1_e_raw(n_d1,n_d2,n_a1,n_a2,n_z,n_e,N_j, d_gridvals, d2_gridvals, a1_gridvals, a2_grid, z_gridvals_J, e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
Policy=zeros(3,N_a,N_z,N_e,N_j,vfoptions.indexT,'gpuArray'); %first dim indexes the optimal choice for d and a1prime rest of dimensions a,z
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    DiscountedEV=repelem(DiscountedEV,N_d1,1);% [N_d1*N_d2,N_a1,1,N_a2,N_z,N_e]
    DiscountedEVinterp=repelem(DiscountedEVinterp,N_d1,1); % [N_d1*N_d2,N_a1prime,1,N_a2,N_z,N_e]
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                entireRHS_ze=ReturnMatrix_ze+DiscountedEV_ze; % autofill 3rd dim to N_a1
