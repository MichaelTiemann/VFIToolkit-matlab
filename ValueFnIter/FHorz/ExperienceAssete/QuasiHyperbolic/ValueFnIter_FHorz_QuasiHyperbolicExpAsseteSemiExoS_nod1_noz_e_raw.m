...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    d2a1prime_ind=reshape(Policy_ford3_hat((1:1:N_a*N_semiz*N_e)'+(N_a*N_semiz*N_e)*(d3maxindex_lin-1)),[1,N_a,N_semiz,N_e]);
