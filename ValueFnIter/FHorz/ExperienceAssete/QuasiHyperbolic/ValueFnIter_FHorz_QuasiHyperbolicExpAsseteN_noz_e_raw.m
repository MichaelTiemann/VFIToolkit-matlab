function [Vtilde,Policy,Valt,Policyalt]=ValueFnIter_FHorz_QuasiHyperbolicExpAsseteN_noz_e_raw(n_d1, n_d2,n_a1,n_a2,n_e,N_j, d_gridvals, d2_gridvals, a1_gridvals, a2_grid, e_gridvals_J, pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
% Naive QH + ExpAssete (e dep aprimeFn), baseline (no DC, no GI), with a1, no z.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    entireEV=repelem(EV,N_d1,N_a1,1); % undiscounted; beta/beta0beta applied below
