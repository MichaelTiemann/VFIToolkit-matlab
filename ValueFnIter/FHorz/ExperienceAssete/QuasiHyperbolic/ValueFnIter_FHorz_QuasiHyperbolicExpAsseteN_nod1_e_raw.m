function [Vtilde,Policy,Valt,Policyalt]=ValueFnIter_FHorz_QuasiHyperbolicExpAsseteN_nod1_e_raw(n_d2,n_a1,n_a2,n_z,n_e,N_j, d2_gridvals, a1_gridvals, a2_grid, z_gridvals_J, e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
% Naive QH + ExpAssete (e dep aprimeFn), baseline (no DC, no GI), with a1, with z, no d1.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    entireEV=repelem(EV,1,N_a1,1,1); % undiscounted; beta/beta0beta applied below
