...
%
% Naive QH dual pass over the same argmax axis the exponential SemiExo ze (no d1) raw maxes over:
...
for reverse_j=1:N_j-1
    ...
    EVpre=sum(Valt(:,:,:,jj+1).*shiftdim(pi_e_J(:,jj+1),-2),3); % [N_a, N_semiz]
