...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        ...
        EVfine=reshape(entireEVinterp(aprimeze),[N_d*n2long*N_a2,N_a,N_z,N_e]);
    ...
    elseif vfoptions.lowmemory==1
        for z_c=1:N_z
            ...
            EVfine_z=reshape(entireEVinterp_z(aprimee),[N_d*n2long*N_a2,N_a,1,N_e]);
