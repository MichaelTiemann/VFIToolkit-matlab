    ...
    if vfoptions.lowmemory==0
        ...
        for ii=1:(vfoptions.level1n-1)
            ...
            if maxgap(ii)>0
                ...
                entireRHS_ii=ReturnMatrix_ii+beta0beta*entireEV(d2aprimeze);
        ...
        EVfine=reshape(entireEVinterp(aprimeze),[N_d2*n2long*N_a2,N_a,N_z,N_e]);
        ...
        for z_c=1:N_z
            ...
            for ii=1:(vfoptions.level1n-1)
                ...
                if maxgap(ii)>0
                    ...
                    entireRHS_ii_z=ReturnMatrix_ii_z+beta0beta*entireEV_z(d2aprimee);
            ...
            EVfine_z=reshape(entireEVinterp_z(aprimee),[N_d2*n2long*N_a2,N_a,1,N_e]);
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                EVfine_ze=reshape(entireEVinterp_ze(aprime),[N_d2*n2long*N_a2,N_a]);
                ReturnMatrix_ii_flat=reshape(ReturnMatrix_ii_ze,[N_d2*n2long*N_a2,N_a]);
                entireRHS_ii_ze=ReturnMatrix_ii_flat+beta0beta*EVfine_ze;
