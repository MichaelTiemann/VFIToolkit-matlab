function [Vtilde,Policy,Valt,Policyalt]=ValueFnIter_FHorz_QuasiHyperbolicExpAsseteSemiExoN_noa1_noz_e_raw(n_d1,n_d2,n_d3,n_a2,n_semiz,n_e,N_j, d12_gridvals, d2_gridvals, d3_grid, a2_grid, semiz_gridvals_J, e_gridvals_J, pi_semiz_J, pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
% noa1 version of ValueFnIter_FHorz_QuasiHyperbolicExpAsseteSemiExoN_e_raw (d1, noz, e).
...
Policyalt=zeros(3,N_a,N_semiz,N_e,N_j,'gpuArray');
