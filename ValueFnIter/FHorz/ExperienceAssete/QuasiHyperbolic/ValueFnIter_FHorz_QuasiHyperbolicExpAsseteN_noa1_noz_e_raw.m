function [Vtilde,Policy,Valt,Policyalt]=ValueFnIter_FHorz_QuasiHyperbolicExpAsseteN_noa1_noz_e_raw(n_d1,n_d2,n_a2,n_e,N_j, d_gridvals, d2_gridvals, a2_grid,e_gridvals_J,pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions, beta0)
% Naive QH + ExpAssete (e dep aprimeFn), baseline (no DC, no GI), no a1, no z.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            entireRHS_e=ReturnMatrix_e+beta*entireEV_e;
            %Calc the max and it's index
