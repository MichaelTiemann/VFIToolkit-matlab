function [VKron, Policy, ExitPolicy]=ValueFnIter_InfHorz_EndogExit_Par2_raw(VKron, n_d,n_a,n_z, pi_z, beta, ReturnMatrix,ReturnToExitMatrix, Howards,Howards2, Tolerance,keeppolicyonexit) %Verbose,
