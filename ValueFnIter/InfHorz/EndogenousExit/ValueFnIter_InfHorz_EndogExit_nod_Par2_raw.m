function [VKron, Policy, ExitPolicy]=ValueFnIter_InfHorz_EndogExit_nod_Par2_raw(VKron, n_a, n_z, pi_z, beta, ReturnMatrix,ReturnToExitMatrix, Howards,Howards2,Tolerance, keeppolicyonexit) % Verbose, a_grid, z_grid,
