function [VKron, Policy, ExitPolicy]=ValueFnIter_InfHorz_EndogExit_raw(VKron, N_d,N_a,N_z,pi_z, beta, ReturnMatrix,ReturnToExitMatrix,Howards,Howards2,Tolerance,keeppolicyonexit)
