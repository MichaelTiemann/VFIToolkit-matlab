function [VKron, Policy]=ValueFnIter_InfHorz_preGI2A_HowardGreedy_nod_raw(VKron, n_a, n_z, a_grid, z_gridvals, pi_z, DiscountFactorParamsVec, ReturnFn, ReturnFnParams, vfoptions)
...
ReturnMatrixfine=CreateReturnFnMatrix_Case2_Disc(ReturnFn,n_aprime, n_a, n_z, aprime_gridvals, a_gridvals, z_gridvals, ReturnFnParams);
