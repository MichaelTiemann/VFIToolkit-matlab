function [VKron, Policy]=ValueFnIter_InfHorz_LowMem_sparse_nod_raw(VKron, n_a, n_z, a_grid, z_gridvals, pi_z, beta, ReturnFn, ReturnFnParams, Howards,MaxHowards,Tolerance,maxiter)
...
while currdist>Tolerance && tempcounter<=maxiter
    ...
    for z_c=1:N_z
        ...
        ReturnMatrix_z=CreateReturnFnMatrix_Disc(ReturnFn, 0, n_a, special_n_z, [], a_grid, zvals,ReturnFnParams,0);
