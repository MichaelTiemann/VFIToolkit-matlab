function [VKron, Policy]=ValueFnIter_InfHorz_LowMem_raw(VKron, n_d,n_a,n_z, d_gridvals,a_grid,z_gridvals, pi_z, beta, ReturnFn, ReturnFnParams, Howards,Howards2,Tolerance, maxiter)
...
special_n_z=ones(l_z,1,vfoptions.precision,'gpuArray');
...
while currdist>Tolerance && tempcounter<=maxiter
    ...
    for z_c=1:N_z
        ...
        ReturnMatrix_z=CreateReturnFnMatrix_Disc(ReturnFn,n_d, n_a, special_n_z,d_gridvals, a_grid, zvals,ReturnFnParams,0);
