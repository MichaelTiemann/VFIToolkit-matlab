function [V,Policy]=ValueFnIter_InfHorz_SeparableReturnFn(V0,n_d,n_a,n_z,d_gridvals,a_grid,z_gridvals,pi_z,ReturnFn,Params,DiscountFactorParamNames,ReturnFnParamNames,vfoptions)
