function [VKron, Policy]=ValueFnIter_InfHorz_EpsteinZin_nod_raw(VKron, n_a, n_z, pi_z, DiscountFactorParamsVec, ReturnMatrix, Howards,Howards2,Tolerance, ezc1,ezc2,ezc3,ezc4,ezc5,ezc6,ezc7)
% Does pretty much exactly the same as ValueFnIter_InfHorz_EpsteinZin_raw, only without any decision variable (n_d=0)
