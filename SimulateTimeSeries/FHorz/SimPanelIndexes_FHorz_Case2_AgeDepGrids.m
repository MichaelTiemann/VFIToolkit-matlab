function SimPanel=SimPanelIndexes_FHorz_Case2_AgeDepGrids(InitialDist,PolicyIndexesKron,daz_gridstructure,N_j,Phi_aprimeFn,Case2_Type,Parameters,PhiaprimeParamNames, simoptions)
