function [V, Policy]=ValueFnIter_FHorz_TPath_SingleStep_fastOLG_ExpAssetz_GI1_nod1_raw(V,n_d2,n_a1,n_a2,n_z,N_j, d2_gridvals,a1_gridvals,a2_grid, z_gridvals_J,pi_z_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
if vfoptions.lowmemory==0
    ReturnMatrix=CreateReturnFnMatrix_fastOLG_ExpAsset_Disc(ReturnFn, 0, n_d2, n_a1, n_a1,n_a2, n_z,N_j, d2_gridvals, a1_gridvals, a1_gridvals, a2_grid, z_gridvals_J, ReturnFnParamsAgeMatrix,1,0); % Level=1, Refine=0
    % fastOLG: ReturnMatrix is [N_d2,N_a1prime,N_a1,N_a2,N_j,N_z]
...
elseif vfoptions.lowmemory==1
    ...
    for z_c=1:N_z
        ...
        ReturnMatrix_z=CreateReturnFnMatrix_fastOLG_ExpAsset_Disc(ReturnFn, 0, n_d2, n_a1, n_a1,n_a2, special_n_z,N_j, d2_gridvals, a1_gridvals, a1_gridvals, a2_grid, z_val, ReturnFnParamsAgeMatrix,1,0); % Level=1, Refine=0
        % fastOLG: ReturnMatrix_z is [N_d2,N_a1prime,N_a1,N_a2,N_j]
