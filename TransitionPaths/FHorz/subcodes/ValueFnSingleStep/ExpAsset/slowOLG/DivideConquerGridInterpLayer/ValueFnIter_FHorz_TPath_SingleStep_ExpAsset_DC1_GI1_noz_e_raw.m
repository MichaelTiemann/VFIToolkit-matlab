function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_ExpAsset_DC1_GI1_noz_e_raw(V,n_d1, n_d2,n_a1,n_a2,n_e,N_j, d_gridvals, d2_gridvals, a1_gridvals, a2_grid,e_gridvals_J, pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
for reverse_j=1:N_j-1
    ...
    EV=sum(pi_e_J(:,jj+1)'.*VKronNext_j,2);    % Expectations over e
