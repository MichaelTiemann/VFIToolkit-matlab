function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_ExpAsset_DC1_nod1_raw(V,n_d2,n_a1,n_a2,n_z,N_j, d2_gridvals, a1_gridvals, a2_grid, z_gridvals_J, pi_z_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
for reverse_j=1:N_j-1
    ...
    Vupper=reshape(VKronNext_j(aprimeplus1Index(:),:),[N_d2*N_a1,N_a2,N_z]);
