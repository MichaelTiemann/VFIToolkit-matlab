...
if vfoptions.EVpre==0
    ...
    [a2primeIndex,a2primeProbs]=CreateExperienceAssetFnMatrix_J(aprimeFn, n_d2, n_a2, N_j, d2_gridvals, a2_gridvals, aprimeFnParamsVec,2); % Note, is actually aprime_grid (but a_grid is anyway same for all ages)
    ...
    EVpre=[sum(V(N_a+1:end,:,:).*pi_e_J(1:end-N_a,:,:),3); zeros(N_a,N_z,vfoptions.precision,'gpuArray')]; % pi_e_J already kron-expanded to (a-j,1,e) upstream; j=N_j zero-padded
