function [V, Policy]=ValueFnIter_FHorz_TPath_SingleStep_fastOLG_ExpAsset_GI1_nod1_noz_e_raw(V,n_d2,n_a1,n_a2,n_e,N_j, d2_gridvals,a1_gridvals,a2_grid, e_gridvals_J,pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
Policy3=zeros(4,N_a,N_j,N_e,vfoptions.indexT,'gpuArray'); % first dim indexes the optimal choice for d and a1prime rest of dimensions a,e (d2, midpoint, a1primeL2ind, L2flag)
...
if vfoptions.lowmemory==0
    ReturnMatrix=CreateReturnFnMatrix_fastOLG_ExpAsset_Disc(ReturnFn, 0, n_d2, n_a1, n_a1,n_a2, n_e,N_j, d2_gridvals, a1_gridvals, a1_gridvals, a2_grid, e_gridvals_J, ReturnFnParamsAgeMatrix,1,0); % Level=1, Refine=0
    % fastOLG: ReturnMatrix is [N_d2,N_a1prime,N_a1,N_a2,N_j,N_e]
    ...
    % midpoint is N_d2-by-1-by-N_a1-by-N_a2-by-N_j-by-N_e
    ...
    linidx_lower=reshape(dind,[1,N_a1*N_a2,N_j,N_e])                   +N_d2*n2long*gpuArray(0:1:N_a-1)+N_d2*n2long*N_a*shiftdim(gpuArray(0:1:N_j-1),-1)+N_d2*n2long*N_a*N_j*shiftdim(gpuArray(0:1:N_e-1),-2);
    linidx_upper=reshape(dind,[1,N_a1*N_a2,N_j,N_e])+N_d2*(n2long-1)   +N_d2*n2long*gpuArray(0:1:N_a-1)+N_d2*n2long*N_a*shiftdim(gpuArray(0:1:N_j-1),-1)+N_d2*n2long*N_a*N_j*shiftdim(gpuArray(0:1:N_e-1),-2);
...
elseif vfoptions.lowmemory==1
    ...
    for e_c=1:N_e
        ...
        ReturnMatrix_e=CreateReturnFnMatrix_fastOLG_ExpAsset_Disc(ReturnFn, 0, n_d2, n_a1, n_a1,n_a2, special_n_e,N_j, d2_gridvals, a1_gridvals, a1_gridvals, a2_grid, e_val, ReturnFnParamsAgeMatrix,1,0); % Level=1, Refine=0
        % fastOLG: ReturnMatrix_e is [N_d2,N_a1prime,N_a1,N_a2,N_j]
