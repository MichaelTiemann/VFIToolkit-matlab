function [V,Policy,Policyalt,Vtilde]=ValueFnIter_FHorz_TPath_SingleStep_QHN_GI1_nod_noz_raw(V,n_a,N_j, a_grid, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
Policyalt=zeros(2,N_a,N_j,'gpuArray');
...
for reverse_j=1:N_j-1
    ...
    ReturnMatrix_L2alt=CreateReturnFnMatrix_Disc_DC1_nod_noz(ReturnFn,aprime_grid(aprimeindexesalt),a_grid,ReturnFnParamsVec);
    entireRHS_L2alt=ReturnMatrix_L2alt+beta*reshape(EVinterp(aprimeindexesalt(:)),[n2long,N_a]);
