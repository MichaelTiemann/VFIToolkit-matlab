function [V, Policy, Vhat]=ValueFnIter_FHorz_TPath_SingleStep_QHS_fastOLG_DC1_nod_e_raw(V,n_a,n_z,n_e,N_j, a_grid, z_gridvals_J,e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
% fastOLG, so a-j-z
Policy=zeros(N_a,N_j,N_z,N_e,vfoptions.indexT,'gpuArray'); % first dim indexes the optimal choice for aprime
...
if vfoptions.lowmemory==0
    ...
    entireRHS_ii=ReturnMatrix_ii+Beta0DiscountedEV; % (aprime,a and j,z,e), autofills a and e for expectation term
