function [V,Policy,Vhat]=ValueFnIter_FHorz_TPath_SingleStep_QHS_fastOLG_DC1_GI1_noz_raw(V,n_d,n_a,N_j, d_gridvals, a_grid, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames,vfoptions)
...
DiffDiscountedEVinterp=reshape(betaminusbeta0beta_J,[1,1,N_j]).*EVinterp; % [n2aprime,1,N_j]
...
EVfine=reshape(DiffDiscountedEVinterp(aprimej(:)),[N_d*n2long,N_a,N_j]);
