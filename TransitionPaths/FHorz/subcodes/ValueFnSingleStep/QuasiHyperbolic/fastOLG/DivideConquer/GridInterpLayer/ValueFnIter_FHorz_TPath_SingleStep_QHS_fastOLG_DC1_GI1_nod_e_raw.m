function [V, Policy, Vhat]=ValueFnIter_FHorz_TPath_SingleStep_QHS_fastOLG_DC1_GI1_nod_e_raw(V,n_a,n_z,n_e,N_j, a_grid, z_gridvals_J,e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
% fastOLG just means parallelize over "age" (j)
% fastOLG is done as (a,j,z,e), rather than standard (a,z,e,j)
% V is (a,j)-by-z-by-e (carries Vunderbar for Sophisticated QH)
...
if vfoptions.lowmemory==0
    ...
    EVfine=reshape(DiffDiscountedEVinterp(aprimejz(:)),[n2long,N_a,N_j,N_z,N_e]);
...
elseif vfoptions.lowmemory==2
    ...
    for z_c=1:N_z
        ...
        DiffDiscountedEVinterp_z=DiffDiscountedEVinterp(:,:,:,z_c);
