function [V, Policy, Vhat]=ValueFnIter_FHorz_TPath_SingleStep_QHS_fastOLG_GI1_nod_raw(V,n_a,n_z,N_j, a_grid, z_gridvals_J,pi_z_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
if vfoptions.lowmemory==0
    ...
    EVfine=reshape(EVinterp(aprimejz(:)),[n2long,N_a,N_j,N_z]);
...
elseif vfoptions.lowmemory==1
    ...
    for z_c=1:N_z
        ...
        EVfine_z=reshape(EVinterp_z(aprimej(:)),[n2long,N_a,N_j]);
