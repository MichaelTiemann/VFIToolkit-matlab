function [V, Policy, Vhat]=ValueFnIter_FHorz_TPath_SingleStep_QHS_fastOLG_GI1_nod_e_raw(V,n_a,n_z,n_e,N_j, a_grid, z_gridvals_J,e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
if vfoptions.lowmemory==0
    ...
    EVfine=reshape(EVinterp(aprimejz(:)),[n2long,N_a,N_j,N_z,N_e]);
...
elseif vfoptions.lowmemory==1
    ...
    for e_c=1:N_e
        ...
        aprimejz=aprimeindexes+n2aprime*jind+n2aprime*N_j*zind;
        EVfine_e=reshape(EVinterp(aprimejz(:)),[n2long,N_a,N_j,N_z]);
...
elseif vfoptions.lowmemory==2
    ...
    for z_c=1:N_z
        ...
        for e_c=1:N_e
            ...
            EVfine_ze=reshape(EVinterp_z(aprimej(:)),[n2long,N_a,N_j]);
