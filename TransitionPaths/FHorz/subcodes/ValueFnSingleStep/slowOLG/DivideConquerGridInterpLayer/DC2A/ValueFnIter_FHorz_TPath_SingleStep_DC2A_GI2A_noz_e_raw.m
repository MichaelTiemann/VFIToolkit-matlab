function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_DC2A_GI2A_noz_e_raw(V,n_d,n_a,n_e, N_j, d_gridvals, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
Policy=zeros(4,N_a,N_e,N_j,vfoptions.indexT,'gpuArray'); % first dim is (d,a1prime midpoint,a2prime,a1prime L2)
