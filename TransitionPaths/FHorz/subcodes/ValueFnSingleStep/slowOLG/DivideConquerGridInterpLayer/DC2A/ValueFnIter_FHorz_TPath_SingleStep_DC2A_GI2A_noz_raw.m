function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_DC2A_GI2A_noz_raw(V,n_d,n_a, N_j, d_gridvals, a_grid, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
Policy=zeros(4,N_a,N_j,vfoptions.indexT,'gpuArray'); % first dim is (d,a1prime midpoint,a2prime,a1prime L2)
...
for reverse_j=1:N_j-1
    ...
    DiscountedEV=DiscountFactorParamsVec*reshape(VKronNext_j,[N_a1,N_a2]); % will autoexand d in 1st-dim
