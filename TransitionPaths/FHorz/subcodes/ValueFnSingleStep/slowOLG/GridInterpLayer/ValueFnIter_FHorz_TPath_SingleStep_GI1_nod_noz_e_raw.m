function  [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_GI1_nod_noz_e_raw(V,n_a, n_e, N_j, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
Policy=zeros(2,N_a,N_e,N_j,vfoptions.indexT,'gpuArray'); % first dim indexes the optimal choice for aprime and aprime2 (in GI layer)
...
elseif vfoptions.lowmemory>=2
    error('vfoptions.lowmemory>=2 not supported for ValueFnIter_FHorz_TPath_SingleStep_GI1_nod_noz_e_raw')
end
