function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_GI2A_nod_e_raw(V,n_a,n_z,n_e, N_j, a_grid, z_gridvals_J, e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
Policy=zeros(3,N_a,N_z,N_e,N_j,vfoptions.indexT,'gpuArray'); % first dim is (a1prime midpoint,a2prime,a1prime L2)
PolicyL2flag=2*ones(1,N_a,N_z,N_e,N_j,vfoptions.indexT,'gpuArray'); % 1=all weight to lower coarse a1, 2=usual linear weights, 3=all weight to upper coarse a1
...
elseif vfoptions.lowmemory==1
    for e_c=1:N_e
        ...
        ReturnMatrix_e=CreateReturnFnMatrix_Disc_DC2A_nod_e(ReturnFn, n_z,special_n_e, a1_grid, a2_grid, a1_grid, a2_grid, z_gridvals_J(:,:,N_j), e_val, ReturnFnParamsVec,1);
        ...
        ReturnMatrix_ii_e=CreateReturnFnMatrix_Disc_DC2A_nod_e(ReturnFn,n_z,special_n_e,a1prime_grid(a1primeindexes),a2_grid,a1_grid,a2_grid,z_gridvals_J(:,:,N_j), e_val, ReturnFnParamsVec,2);
        ...
        Policy(1,:,:,e_c,N_j)=midpoint(maxindexL2a2+N_a2*a12ind+N_a2*N_a*zind); % a1prime midpoint
...
elseif vfoptions.lowmemory==2
    for e_c=1:N_e
        ...
        for z_c=1:N_z
            ...
            ReturnMatrix_ze=CreateReturnFnMatrix_Disc_DC2A_nod_e(ReturnFn, special_n_z,special_n_e, a1_grid, a2_grid, a1_grid, a2_grid, z_val, e_val, ReturnFnParamsVec,1);
            ...
            ReturnMatrix_ii_ze=CreateReturnFnMatrix_Disc_DC2A_nod_e(ReturnFn,special_n_z,special_n_e,a1prime_grid(a1primeindexes),a2_grid,a1_grid,a2_grid,z_val, e_val, ReturnFnParamsVec,2);
            ...
            Policy(1,:,z_c,e_c,N_j)=midpoint(maxindexL2a2+N_a2*a12ind); % a1prime midpoint
...
for reverse_j=1:N_j-1
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            ReturnMatrix_e=CreateReturnFnMatrix_Disc_DC2A_nod_e(ReturnFn, n_z,special_n_e, a1_grid, a2_grid, a1_grid, a2_grid, z_gridvals_J(:,:,jj),e_val, ReturnFnParamsVec,1);
            ...
            a1primeindexes=(midpoint+(midpoint-1)*n2short)+(-n2short-1:1:1+n2short)';
            % aprime possibilities are n2long-by-n_a2-by-n_a1-by-n_a2-by-n_z
            ReturnMatrix_ii_e=CreateReturnFnMatrix_Disc_DC2A_nod_e(ReturnFn,n_z,special_n_e,a1prime_grid(a1primeindexes),a2_grid, a1_grid, a2_grid,z_gridvals_J(:,:,jj),e_val, ReturnFnParamsVec,2);
            aprimez=a1primeindexes+N_a1fine*a2ind+N_a1fine*N_a2*zBind;
            entireRHS_ii_e=ReturnMatrix_ii_e+DiscountFactorParamsVec*reshape(EVinterp(aprimez),[n2long*N_a2,N_a,N_z]);
            ...
            Policy(1,:,:,e_c,jj)=midpoint(maxindexL2a2+N_a2*a12ind+N_a2*N_a*zind); % a1prime midpoint
    ...
    elseif vfoptions.lowmemory==2
        for e_c=1:N_e
            ...
            for z_c=1:N_z
                ...
                entireRHS_ii_ze=ReturnMatrix_ii_ze+DiscountFactorParamsVec*reshape(EVinterp_z(aprimez),[n2long*N_a2,N_a]);
                ...
                Policy(1,:,z_c,e_c,jj)=midpoint(maxindexL2a2+N_a2*a12ind); % a1prime midpoint
