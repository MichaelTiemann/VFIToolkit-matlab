function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_GI2A_nod_noz_e_raw(V,n_a,n_e, N_j, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
Policy=zeros(3,N_a,N_e,N_j,vfoptions.indexT,'gpuArray'); % first dim is (a1prime midpoint,a2prime,a1prime L2)
...
elseif vfoptions.lowmemory==1
    for e_c=1:N_e
        ...
        ReturnMatrix_e=CreateReturnFnMatrix_Disc_DC2A_nod(ReturnFn,special_n_e, a1_grid, a2_grid, a1_grid, a2_grid, e_val, ReturnFnParamsVec,1);
        ...
        ReturnMatrix_ii_e=CreateReturnFnMatrix_Disc_DC2A_nod(ReturnFn,special_n_e,a1prime_grid(a1primeindexes),a2_grid,a1_grid,a2_grid, e_val, ReturnFnParamsVec,2);
        ...
        Policy(1,:,e_c,N_j)=midpoint(maxindexL2a2+N_a2*a12ind); % a1prime midpoint
...
for reverse_j=1:N_j-1
    ...
    EV=sum(VKronNext_j.*pi_e_J(:,:,jj),2);
    ...
    if vfoptions.lowmemory==0
        ...
        entireRHS_ii=ReturnMatrix_ii+DiscountFactorParamsVec*reshape(EVinterp(aprime),[n2long*N_a2,N_a,N_e]);
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            ReturnMatrix_ii_e=CreateReturnFnMatrix_Disc_DC2A_nod(ReturnFn,special_n_e,a1prime_grid(a1primeindexes),a2_grid, a1_grid, a2_grid,e_val, ReturnFnParamsVec,2);
            aprime=a1primeindexes+N_a1fine*a2ind;
            entireRHS_ii_e=ReturnMatrix_ii_e+DiscountFactorParamsVec*reshape(EVinterp(aprime),[n2long*N_a2,N_a]);
            ...
            Policy(1,:,e_c,jj)=midpoint(maxindexL2a2+N_a2*a12ind); % a1prime midpoint
