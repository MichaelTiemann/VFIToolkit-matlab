function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_DC1_GI1_noz_e_raw(V,n_d,n_a,n_e,N_j, d_gridvals, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
Policy=zeros(4,N_a,N_e,N_j,vfoptions.indexT,'gpuArray'); % first dim indexes the optimal choice for d, midpoint, L2, L2flag
...
if vfoptions.lowmemory>=2
    error('vfoptions.lowmemory=K not supported for ValueFnIter_FHorz_TPath_SingleStep_DC1_GI1_noz_e_raw')
end
