function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_DC2A_nod_noz_raw(V,n_a, N_j, a_grid, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
for reverse_j=1:N_j-1
    ...
    DiscountedEV=DiscountFactorParamsVec*reshape(VKronNext_j,[N_a1,N_a2,1,1]);  % autoexpand (a)
