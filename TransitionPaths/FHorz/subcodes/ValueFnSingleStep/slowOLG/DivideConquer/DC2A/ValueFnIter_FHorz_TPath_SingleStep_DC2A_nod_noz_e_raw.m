function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_DC2A_nod_noz_e_raw(V,n_a, n_e, N_j, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
Policy=zeros(N_a,N_e,N_j,vfoptions.indexT,'gpuArray'); % joint (a1prime,a2prime) index at each (a,e,j) cell
