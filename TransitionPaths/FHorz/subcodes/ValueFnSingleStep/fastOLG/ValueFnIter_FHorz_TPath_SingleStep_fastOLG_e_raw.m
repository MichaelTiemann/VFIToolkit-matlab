function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_fastOLG_e_raw(V,n_d,n_a,n_z,n_e,N_j, d_gridvals, a_grid, z_gridvals_J, e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
DiscountedEV=repelem(reshape(DiscountFactor_J,[1,1,N_j]).*EV,N_d,1,1,1); % [N_d*N_aprime,1,N_j,N_z]
