function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_fastOLG_GI1_e_raw(V,n_d,n_a,n_z,n_e,N_j, d_gridvals, a_grid, z_gridvals_J, e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
Policy=zeros(4,N_a,N_j,N_z,N_e,vfoptions.indexT,'gpuArray'); %first dim indexes the optimal choice for d and aprime rest of dimensions a,z (d, midpoint, aprimeL2ind, L2flag)
...
elseif vfoptions.lowmemory==1
    ...
    V=zeros(N_a*N_j,N_z,N_e,vfoptions.precision,'gpuArray'); %first dim indexes the optimal choice for d and aprime rest of dimensions a,z
