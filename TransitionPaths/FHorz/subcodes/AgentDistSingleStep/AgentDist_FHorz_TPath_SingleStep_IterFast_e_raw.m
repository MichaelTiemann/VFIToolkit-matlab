function AgentDist=AgentDist_FHorz_TPath_SingleStep_IterFast_e_raw(AgentDist,Policy_aprimejz,N_a,N_z,N_e,N_j,pi_z_J_sim,pi_e_J_sim,II1,II2,exceptlastj,exceptfirstj,justfirstj,jequalOneDist)
...
% Policy_aprimejz is [N_a*(N_j-1)*N_z*N_e,1], already except last j
...
Gammatranspose=sparse(gather(Policy_aprimejz),II1,II2,N_a*(N_j-1)*N_z,N_a*(N_j-1)*N_z*N_e);
% Note: N_j-1, not N_j
