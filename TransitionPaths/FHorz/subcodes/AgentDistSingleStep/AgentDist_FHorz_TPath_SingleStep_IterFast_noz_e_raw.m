function AgentDist=AgentDist_FHorz_TPath_SingleStep_IterFast_noz_e_raw(AgentDist,Policy_aprimej,N_a,N_e,N_j,pi_e_J_sim,II1,II2,exceptlastj,exceptfirstj,justfirstj,jequalOneDist)
...
% Policy_aprimej is [N_a*(N_j-1)*N_e,1], already except last j
...
Gammatranspose=sparse(gather(Policy_aprimej),II1,II2,N_a*(N_j-1),N_a*(N_j-1)*N_e);
% Note: N_j-1, not N_j
