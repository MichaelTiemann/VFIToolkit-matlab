function [V,Policy]=ValueFnIter_InfHorz_TPath_SingleStep_ExpAsset_nod1_raw(Vnext,n_d2,n_a1, n_a2,n_z, d2_gridvals, a1_gridvals, a2_grid, z_gridvals, pi_z, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames,aprimeFnParamNames, vfoptions)
...
if vfoptions.lowmemory==0
    ...
    ReturnMatrix=CreateReturnFnMatrix_ExpAsset_Disc(ReturnFn, 0, n_d2, n_a1, n_a1,n_a2, n_z, d2_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, z_gridvals, ReturnFnParamsVec,0,0); % Level=0, Refine=0
