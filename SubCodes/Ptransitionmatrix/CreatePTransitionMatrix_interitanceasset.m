function P=CreatePTransitionMatrix_interitanceasset(Policy,l_d,l_a,n_d,n_a,n_z,N_a,N_semiz,N_z,N_e,pi_semiz,pi_z,pi_e,Parameters,simoptions)
%% Inheritance asset
...
if N_z==0 || N_e>0 || N_semiz>0
    error('Not yet implemented, ask on forum if you want this')
end
