...
if vfoptions.gridinterplayer==1
    Policy=[str2func(vfoptions.precision)(mod(floor(double(PolicyKron(1,:)-1)./divisors1),n_daprime1(:)))+1;
            str2func(vfoptions.precision)(mod(floor(double(PolicyKron(2,:)-1)./divisors2),n_daprime2(:)))+1;
            PolicyKron(3,:);
            PolicyKron(4,:)];
