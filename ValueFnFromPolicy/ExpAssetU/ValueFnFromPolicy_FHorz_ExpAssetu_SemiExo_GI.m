...
if N_d==0
    error('ValueFnFromPolicy_FHorz_ExpAssetu_SemiExo_GI: experienceassetu+semiz requires at least one decision variable')
end
l_d=length(n_d);
l_a=length(n_a);
        ...
        if N_e==0
            ...
            if N_z==0
                ...
                for e_c=1:N_e
                    ...
                    a2l_e=reshape(a2primeIndex(:,block,:),[N_a, N_semiz, N_u]);
                    a2u_e=a2l_e+1;
                    wa2l_e=reshape(a2primeProbs(:,block,:),[N_a, N_semiz, N_u]);
                    wa2u_e=1-wa2l_e;
                ...
                for e_c=1:N_e
                    ...
                    a2l_e=reshape(a2primeIndex(:,block,:),[N_a, N_semiz, N_z, N_u]);
                    a2u_e=a2l_e+1;
                    wa2l_e=reshape(a2primeProbs(:,block,:),[N_a, N_semiz, N_z, N_u]);
                    wa2u_e=1-wa2l_e;
