function StationaryDist = StationaryDist_VFHorz_ExpAsset(jequaloneDist, AgeWeightParamNames, Policy, n_d, n_a, n_semiz, n_z, N_j, pi_semiz_J, z_gridvals_J, pi_z_J, Parameters, simoptions)
