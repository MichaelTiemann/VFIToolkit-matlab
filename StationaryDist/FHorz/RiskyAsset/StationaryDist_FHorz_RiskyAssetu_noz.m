...
for jj=1:N_j
    ...
    [aprimeIndexes,aprimeProbs]=CreateaprimePolicyRiskyAsset(Policy(1:l_d,:,jj),simoptions.aprimeFn, whichisdforriskyasset, n_d, n_a1,n_a2, 0, simoptions.n_u, simoptions.d_grid, a2_grid, u_grid, aprimeFnParamsVec);
