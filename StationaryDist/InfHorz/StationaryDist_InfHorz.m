function StationaryDist=StationaryDist_InfHorz(Policy,n_d,n_a,n_z,pi_z,simoptions,Parameters,EntryExitParamNames)
...
if simoptions.inheritanceasset==1
    if ~exist('Parameters','var')
        error('When using simoptions.inheritanceasset=1 you must include Parameter structure as input to StationaryDist_InfHorz (input just after simoptions)')
    end
    % Iterate using Tan improvement
